/**
 * *****************************************************************************
 *  @file       Projects/HAL_examples/GPIO/GPIO_InputIT/main.h
 *  @author     Baikal electronics SDK team
 *  @brief      GPIO input interrupt mode example header file
 *  @version    2.3.0
 *  @date       20260703
 * *****************************************************************************
...
#define BTN_CLIC_IRQN  (CLIC_GPIO2_IRQn)
#define BTN_ISR        (GPIO2_IRQHandler)
...
// #define BTN_IT_POL
    ...
    !defined(BTN_IT_TYPE)   || !defined(BTN_IT_MODE)    || \
    !defined(BTN_IT_POL)
