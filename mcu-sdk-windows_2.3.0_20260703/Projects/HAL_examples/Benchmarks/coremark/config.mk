...
# Coremark parameter
CDEFS += -DITERATIONS=$(PARAM_ITERATIONS)
CDEFS += -DHAS_STDIO
CDEFS += -DHAS_FLOAT
...
CFLAGS += -fno-reg-struct-return
CFLAGS += -fno-rename-registers
CFLAGS += -fno-crossjumping
CFLAGS += -freorder-blocks-and-partition
CFLAGS += -fno-tree-loop-if-convert
...
CSRC += $(SOURCE_COMMON_DIR)/core_list_join.c
CSRC += $(SOURCE_COMMON_DIR)/core_main.c
CSRC += $(SOURCE_COMMON_DIR)/core_matrix.c
CSRC += $(SOURCE_COMMON_DIR)/core_portme.c
CSRC += $(SOURCE_COMMON_DIR)/core_state.c
CSRC += $(SOURCE_COMMON_DIR)/core_util.c
