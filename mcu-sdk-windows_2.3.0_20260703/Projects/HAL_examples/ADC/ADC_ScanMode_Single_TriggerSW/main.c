/**
 * *****************************************************************************
 *  @file       Projects/HAL_examples/ADC/ADC_ScanMode_Single_TriggerSW/main.c
...
int main(void)
{
    ...
    for(;;)
    {
        ...
        /***********************************************************************
         * NOTE: No delay or interrupts allowed here, otherwise the EOC flag may
         *       be missed for some ranks.
         **********************************************************************/
