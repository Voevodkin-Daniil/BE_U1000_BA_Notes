/**
 * *****************************************************************************
 *  @file       Projects/HAL_examples/QSPI/QSPI_Flash/qspi.h
 ...
 *          "tx" - transmit only (standard mode) or write (enhanced mode)
 *          "rx" - receive only (standard mode) or read (enhanced mode)
...
/**
 * @brief   Set the clock polarity value of QSPI interface
 * @param   str ASCII string defines the clock polarity value:
...
/*  Transmit/receive 8-bit data in standard mode; polling
...
/*  Transmit/receive 8-bit data in standard EEPROM mode; polling
