# 0 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/BSP/Components/serial/serial.c"
...
#define __ELF__ 1
# 0 "<command-line>"
#define BUILD_TIMESTAMP "2026-09-04, 09:22:05"
# 0 "<command-line>"
...
# 0 "<command-line>" 2
# 1 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/BSP/Components/serial/serial.c"
# 18 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/BSP/Components/serial/serial.c"
# 1 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/BSP/Components/serial/serial.h" 1
# 19 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/BSP/Components/serial/serial.c" 2
...
# 21 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/BSP/Components/serial/serial.c" 2
# 31 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/BSP/Components/serial/serial.c"
# 1 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/BSP/EVU_BA_2_5/bsp.h" 1
# 32 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/BSP/Components/serial/serial.c" 2
# 46 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/BSP/Components/serial/serial.c"
void
bsp_serial_init(void) {





    CRU_SetPinAF((0U), (0x0040U), (CRU_PIN_AF_1));
    CRU_SetPinAF((0U), (0x0080U), (CRU_PIN_AF_1));

    UART_DeInit((((UART_TypeDef*)(0x11000000UL + 0x00001000UL))));
    ...
    UART_Init((((UART_TypeDef*)(0x11000000UL + 0x00001000UL))), &UART_InitStruct);
}


void
bsp_serial_deinit(void) {
    CRU_SetPinAF((0U), (0x0040U), CRU_PIN_AF_0);
    CRU_SetPinAF((0U), (0x0080U), CRU_PIN_AF_0);
...
int
bsp_serial_putchar(int ch) {
    while ((UART_GetLineStatus((((UART_TypeDef*)(0x11000000UL + 0x00001000UL)))) & (0x1UL << (5U))) == 0UL);
    UART_TransmitData8b((((UART_TypeDef*)(0x11000000UL + 0x00001000UL))), (uint8_t)ch);
...
int
bsp_serial_getchar(void) {
    int ch;

    while ((UART_GetLineStatus((((UART_TypeDef*)(0x11000000UL + 0x00001000UL)))) & (0x1UL << (0U))) == 0UL);
    ch = (int)UART_ReceiveData8b((((UART_TypeDef*)(0x11000000UL + 0x00001000UL))));
