# 0 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_cru.c"
...
# 0 "<command-line>" 2
# 1 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_cru.c"
# 19 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_cru.c"
#define IS_CRU_PORT(__VALUE__) (((__VALUE__) == CRU_PORT_A) || ((__VALUE__) == CRU_PORT_B) || ((__VALUE__) == CRU_PORT_C))



#define IS_CRU_PIN(__VALUE__) ((__VALUE__) != 0U)

#define IS_CRU_PIN_PULL(__VALUE__) (((__VALUE__) == CRU_PIN_PULL_NO) || ((__VALUE__) == CRU_PIN_PULL_UP) || ((__VALUE__) == CRU_PIN_PULL_DOWN) || ((__VALUE__) == CRU_PIN_PULL_UP_DOWN))




#define IS_CRU_PIN_DRIVE_STRENGTH(__VALUE__) (((__VALUE__) == CRU_PIN_DRIVE_STRENGTH_0) || ((__VALUE__) == CRU_PIN_DRIVE_STRENGTH_1) || ((__VALUE__) == CRU_PIN_DRIVE_STRENGTH_2) || ((__VALUE__) == CRU_PIN_DRIVE_STRENGTH_3))




#define IS_CRU_PIN_AF(__VALUE__) (((__VALUE__) == CRU_PIN_AF_0) || ((__VALUE__) == CRU_PIN_AF_1) || ((__VALUE__) == CRU_PIN_AF_2) || ((__VALUE__) == CRU_PIN_AF_3) || ((__VALUE__) == CRU_PIN_AF_4) || ((__VALUE__) == CRU_PIN_AF_5))
...
# 60 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_cru.c"
ErrorStatus CRU_DeInit(void)
{
...
# 114 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_cru.c"
void CRU_GetSystemClocksFreq(CRU_Clocks_TypeDef * CRU_Clocks)
{
...
uint32_t CRU_GetCCLKClockFreq(void)
{
    ...
    switch (CRU_GetCCLKSource())
    {
        case CRU_CLK_SRC_C0:
        {
            ...
            frequency = (CRU_GetC0Source() == CRU_MCU_CLK_CLKI) ? (25000000UL) : (20000000UL);
        }
        break;
        ...
        case CRU_CLK_SRC_PLL:
        {
            ...
            if (CRU_CCLKPrescaler_IsEnabled())
            {
                ...
                if (CRU_PLL_GetSource() == CRU_PLL_SRC_C0)
                {
                    ...
                    f_pll_in = (CRU_GetC0Source() == CRU_MCU_CLK_CLKI) ? (25000000UL) : (20000000UL);
                }
                else
                {

                    f_pll_in = (CRU_GetC1Source() == CRU_MCU_CLK_CLKI) ? (25000000UL) : (20000000UL);
                }
        ...
        case CRU_CLK_SRC_C1:
        {
            ...
            frequency = (CRU_GetC1Source() == CRU_MCU_CLK_CLKI) ? (25000000UL) : (20000000UL);
        }
        break;
...
{
    uint32_t pll_cfg = ((CRU_TypeDef*)((0x11000000UL + 0x03000000UL) + 0x00000000UL))->PLLSET;

    return (FRef * (((pll_cfg & (0x3FUL << (4U))) >> (4U)) + 1U) /
            (((pll_cfg & (0xFUL << (0U))) >> (0U)) + 1U) /
            (((pll_cfg & (0xFUL << (10U))) >> (10U)) + 1U));
}
# 669 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_cru.c"
ErrorStatus CRU_PIN_Init(CRU_PIN_InitStruct_TypeDef *CRU_PIN_InitStruct)
{
...
# 674 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_cru.c" 3 4
   ((
# 674 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_cru.c"
   (((CRU_PIN_InitStruct->Port) == 0U) || ((CRU_PIN_InitStruct->Port) == 1U) || ((CRU_PIN_InitStruct->Port) == 2U))
# 674 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_cru.c" 3 4
   ) ? (void)0 : __assert_func ("C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_cru.c", 674, __func__, 
# 674 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_cru.c"
   "IS_CRU_PORT(CRU_PIN_InitStruct->Port)"
# 674 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_cru.c" 3 4
   ))
# 674 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_cru.c"
                                                ;
    
# 675 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_cru.c" 3 4
   ((
# 675 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_cru.c"
   ((CRU_PIN_InitStruct->Pin) != 0U)
# 675 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_cru.c" 3 4
   ) ? (void)0 : __assert_func ("C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_cru.c", 675, __func__, 
# 675 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_cru.c"
   "IS_CRU_PIN(CRU_PIN_InitStruct->Pin)"
# 675 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_cru.c" 3 4
   ))
# 675 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_cru.c"
                                              ;
    
# 676 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_cru.c" 3 4
   ((
# 676 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_cru.c"
   (((CRU_PIN_InitStruct->Pull) == CRU_PIN_PULL_NO) || ((CRU_PIN_InitStruct->Pull) == CRU_PIN_PULL_UP) || ((CRU_PIN_InitStruct->Pull) == CRU_PIN_PULL_DOWN) || ((CRU_PIN_InitStruct->Pull) == CRU_PIN_PULL_UP_DOWN))
# 676 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_cru.c" 3 4
   ) ? (void)0 : __assert_func ("C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_cru.c", 676, __func__, 
# 676 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_cru.c"
   "IS_CRU_PIN_PULL(CRU_PIN_InitStruct->Pull)"
# 676 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_cru.c" 3 4
   ))
# 676 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_cru.c"
                                                    ;
    
# 677 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_cru.c" 3 4
   ((
# 677 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_cru.c"
   (((CRU_PIN_InitStruct->InputCtrl) == DISABLE) || ((CRU_PIN_InitStruct->InputCtrl) == ENABLE))
# 677 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_cru.c" 3 4
   ) ? (void)0 : __assert_func ("C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_cru.c", 677, __func__, 
# 677 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_cru.c"
   "IS_FUNCTIONAL_STATE(CRU_PIN_InitStruct->InputCtrl)"
# 677 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_cru.c" 3 4
   ))
# 677 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_cru.c"
                                                             ;
    
# 678 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_cru.c" 3 4
   ((
# 678 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_cru.c"
   (((CRU_PIN_InitStruct->DriveStrength) == CRU_PIN_DRIVE_STRENGTH_0) || ((CRU_PIN_InitStruct->DriveStrength) == CRU_PIN_DRIVE_STRENGTH_1) || ((CRU_PIN_InitStruct->DriveStrength) == CRU_PIN_DRIVE_STRENGTH_2) || ((CRU_PIN_InitStruct->DriveStrength) == CRU_PIN_DRIVE_STRENGTH_3))
# 678 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_cru.c" 3 4
   ) ? (void)0 : __assert_func ("C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_cru.c", 678, __func__, 
# 678 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_cru.c"
   "IS_CRU_PIN_DRIVE_STRENGTH(CRU_PIN_InitStruct->DriveStrength)"
# 678 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_cru.c" 3 4
   ))
# 678 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_cru.c"
                                                                       ;
    
# 679 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_cru.c" 3 4
   ((
# 679 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_cru.c"
   (((CRU_PIN_InitStruct->Alternate) == CRU_PIN_AF_0) || ((CRU_PIN_InitStruct->Alternate) == CRU_PIN_AF_1) || ((CRU_PIN_InitStruct->Alternate) == CRU_PIN_AF_2) || ((CRU_PIN_InitStruct->Alternate) == CRU_PIN_AF_3) || ((CRU_PIN_InitStruct->Alternate) == CRU_PIN_AF_4) || ((CRU_PIN_InitStruct->Alternate) == CRU_PIN_AF_5))
# 679 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_cru.c" 3 4
   ) ? (void)0 : __assert_func ("C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_cru.c", 679, __func__, 
# 679 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_cru.c"
   "IS_CRU_PIN_AF(CRU_PIN_InitStruct->Alternate)"
# 679 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_cru.c" 3 4
   ))
# 679 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_cru.c"
                                                       ;

    if (CRU_PIN_InitStruct->Pin == (1U << (((uint8_t)__builtin_ctz(CRU_PIN_InitStruct->Pin)))))
    {

        CRU_SetPinPull(CRU_PIN_InitStruct->Port, CRU_PIN_InitStruct->Pin, CRU_PIN_InitStruct->Pull);


        if (CRU_PIN_InitStruct->InputCtrl == ENABLE)
        {
            CRU_EnablePinInput(CRU_PIN_InitStruct->Port, CRU_PIN_InitStruct->Pin);
        }
        else
        {
            CRU_DisablePinInput(CRU_PIN_InitStruct->Port, CRU_PIN_InitStruct->Pin);
        }


        CRU_SetPinDriveStrength(CRU_PIN_InitStruct->Port, CRU_PIN_InitStruct->Pin, CRU_PIN_InitStruct->DriveStrength);


        CRU_SetPinAF(CRU_PIN_InitStruct->Port, CRU_PIN_InitStruct->Pin, CRU_PIN_InitStruct->Alternate);
...
void CRU_PIN_StructInit(CRU_PIN_InitStruct_TypeDef *CRU_PIN_InitStruct)
{
    ...
    CRU_PIN_InitStruct->Port = 0U;
    CRU_PIN_InitStruct->Pin = 0x0001U;
