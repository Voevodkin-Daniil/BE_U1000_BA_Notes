# 0 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/BSP/Components/tusb320/i2c2.c"
...
# 0 "<command-line>" 2
# 1 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/BSP/Components/tusb320/i2c2.c"
# 17 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/BSP/Components/tusb320/i2c2.c"
# 1 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/BSP/Components/tusb320/i2c2.h" 1
# 18 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/BSP/Components/tusb320/i2c2.h"
#define __I2C2_H 
...
# 18 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/BSP/Components/tusb320/i2c2.c" 2
...
# 20 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/BSP/Components/tusb320/i2c2.c" 2


# 1 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/BSP/EVU_BA_2_5/bsp.h" 1
# 23 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/BSP/Components/tusb320/i2c2.c" 2
...
bsp_i2c2_init (uint8_t saddr) {
    ...
    CRU_PIN_InitStruct.Port = (1U);
    CRU_PIN_InitStruct.Pin = (0x0100U);
    CRU_PIN_InitStruct.Pull = CRU_PIN_PULL_NO;
    CRU_PIN_InitStruct.Alternate = (CRU_PIN_AF_2);
    CRU_PIN_Init(&CRU_PIN_InitStruct);


    CRU_PIN_InitStruct.Port = (1U);
    CRU_PIN_InitStruct.Pin = (0x0200U);
    CRU_PIN_Init(&CRU_PIN_InitStruct);


    while (I2C_DeInit((((I2C_TypeDef*)((0x11000000UL + 0x02000000UL) + 0x00004000UL)))) != SUCCESS) {
        __delay_ms(100UL);
    }
    ...
    I2C_Init((((I2C_TypeDef*)((0x11000000UL + 0x02000000UL) + 0x00004000UL))), &I2C_InitStruct);


    I2C_Enable((((I2C_TypeDef*)((0x11000000UL + 0x02000000UL) + 0x00004000UL))));
}
...
uint32_t bsp_i2c2_write(uint8_t *buf, uint32_t len) {
    ...
    while ((i < len) && (timeout > 0UL)) {
        ...
        if (I2C_IsActiveFlag((((I2C_TypeDef*)((0x11000000UL + 0x02000000UL) + 0x00004000UL))), I2C_FLAG_TFNF) == 1UL) {
            I2C_TransmitData((((I2C_TypeDef*)((0x11000000UL + 0x02000000UL) + 0x00004000UL))), buf[i], (0x0UL << (8U)));
            i++;
        }
    ...
    while (I2C_IsActiveFlag((((I2C_TypeDef*)((0x11000000UL + 0x02000000UL) + 0x00004000UL))), I2C_FLAG_TFE) != 1UL);
...
uint32_t
bsp_i2c2_read (uint8_t *buf, uint32_t len) {
    uint32_t timeout = (1000UL);
    uint32_t i = 0UL;
    ...
    while ((i < len) && (timeout > 0UL)) {
        if (I2C_IsActiveFlag((((I2C_TypeDef*)((0x11000000UL + 0x02000000UL) + 0x00004000UL))), I2C_FLAG_TFNF) == 1UL) {
            I2C_TransmitData((((I2C_TypeDef*)((0x11000000UL + 0x02000000UL) + 0x00004000UL))), 0x0U, (0x1UL << (8U)));
            i++;
        }
    ...
    if (timeout > 0UL) {
        timeout = (1000UL);
        while ((i < len) && (timeout > 0UL)) {
            if (I2C_IsActiveFlag((((I2C_TypeDef*)((0x11000000UL + 0x02000000UL) + 0x00004000UL))), I2C_FLAG_RFNE) == 1UL) {
                buf[i] = I2C_ReceiveData((((I2C_TypeDef*)((0x11000000UL + 0x02000000UL) + 0x00004000UL))));
                i++;
            }
...
bsp_i2c2_flush (void) {
    ...
    while (I2C_IsActiveFlag((((I2C_TypeDef*)((0x11000000UL + 0x02000000UL) + 0x00004000UL))), I2C_FLAG_RFNE) == 1UL) {
        tmp = I2C_ReceiveData((((I2C_TypeDef*)((0x11000000UL + 0x02000000UL) + 0x00004000UL))));
    }
