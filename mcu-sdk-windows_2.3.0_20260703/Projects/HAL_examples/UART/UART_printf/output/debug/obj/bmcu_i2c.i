# 0 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_i2c.c"
...
# 0 "<command-line>" 2
# 1 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_i2c.c"
# 17 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_i2c.c"
# 1 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Inc/bmcu_i2c.h" 1
# 18 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Inc/bmcu_i2c.h"
#define __BMCU_I2C_H 
# 27 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Inc/bmcu_i2c.h"
#define I2C_FLAG_CMD_WRITE I2C_DATA_CMD_DIR_WRITE
#define I2C_FLAG_CMD_READ I2C_DATA_CMD_DIR_READ
...
typedef enum {
    I2C_SPEED_STANDARD = (0x1UL << (1U)),
    I2C_SPEED_FAST = (0x2UL << (1U)),
    I2C_SPEED_HIGH = (0x3UL << (1U))
} I2C_Speed_TypeDef;
...
typedef enum {
    ...
    I2C_FLAG_RFNE = 3,
    I2C_FLAG_RFF = 4,
    I2C_FLAG_MST_ACTIVITY = 5,
    I2C_FLAG_SLV_ACTIVITY = 6,
    I2C_FLAG_MST_HOLD_TX_FIFO_EMPTY = 7,
    I2C_FLAG_MST_HOLD_RX_FIFO_FULL = 8,
    I2C_FLAG_SLV_HOLD_TX_FIFO_EMPTY = 9,
    I2C_FLAG_SLV_HOLD_RX_FIFO_FULL = 10,
    I2C_FLAG_SDA_STUCK_NOT_RECOVERED = 11
} I2C_Flag_TypeDef;
...
typedef enum {
    ...
    I2C_IT_START_DET = 10,
    I2C_IT_GEN_CALL = 11,
    I2C_IT_SCL_STUCK_AT_LOW = 14
} I2C_IT_TypeDef;


typedef struct
{
    I2C_PeriphMode_TypeDef PeripheralMode;
    I2C_Speed_TypeDef Speed;
    uint16_t OwnAddress1;
    I2C_AddrSize_TypeDef OwnAddrSize;
    uint8_t MasterCode;
...
static inline uint32_t I2C_IsEnabled(I2C_TypeDef *I2Cx)
{
    return ((((I2Cx->ENABLE_STATUS) & ((0x1UL << (0U)))) == (0x1UL << (0U))) ? 1UL : 0UL);
}
...
static inline void I2C_Master_Enable(I2C_TypeDef *I2Cx)
{
    ((I2Cx->CON) |= (((0x1UL << (6U)) | (0x1UL << (0U)))));
}
...
static inline void I2C_Master_Disable(I2C_TypeDef *I2Cx)
{
    ((I2Cx->CON) &= ~((0x1UL << (0U))));
}
...
static inline uint32_t I2C_Master_IsEnabled(I2C_TypeDef *I2Cx)
{
    return ((((I2Cx->CON) & ((0x1UL << (0U)))) == (0x1UL << (0U))) ? 1UL : 0UL);
}
...
static inline void I2C_Slave_Enable(I2C_TypeDef *I2Cx)
{
    ((I2Cx->CON) &= ~(((0x1UL << (6U)) | (0x1UL << (0U)))));
}
...
static inline void I2C_Slave_Disable(I2C_TypeDef *I2Cx)
{
    ((I2Cx->CON) |= ((0x1UL << (6U))));
}
...
static inline uint32_t I2C_Slave_IsEnabled(I2C_TypeDef *I2Cx)
{
    return ((((I2Cx->CON) & ((0x1UL << (6U)))) == (0x1UL << (6U))) ? 0UL : 1UL);
}
...
static inline void I2C_EnableDMAReq_TX(I2C_TypeDef *I2Cx)
{
    ((I2Cx->DMA_CR) |= ((0x1UL << (1U))));
}
...
static inline void I2C_DisableDMAReq_TX(I2C_TypeDef *I2Cx)
{
    ((I2Cx->DMA_CR) &= ~((0x1UL << (1U))));
}
...
static inline uint32_t I2C_IsEnabledDMAReq_TX(I2C_TypeDef *I2Cx)
{
    return ((((I2Cx->DMA_CR) & ((0x1UL << (1U)))) == (0x1UL << (1U))) ? 1UL : 0UL);
}
...
static inline void I2C_EnableDMAReq_RX(I2C_TypeDef *I2Cx)
{
    ((I2Cx->DMA_CR) |= ((0x1UL << (0U))));
}
...
static inline void I2C_DisableDMAReq_RX(I2C_TypeDef *I2Cx)
{
    ((I2Cx->DMA_CR) &= ~((0x1UL << (0U))));
}
...
static inline uint32_t I2C_IsEnabledDMAReq_RX(I2C_TypeDef *I2Cx)
{
    return ((((I2Cx->DMA_CR) & ((0x1UL << (0U)))) == (0x1UL << (0U))) ? 1UL : 0UL);
}
...
static inline void I2C_SetDMADataLevel_TX(I2C_TypeDef *I2Cx, uint32_t Level)
{
    (((I2Cx->DMA_TDLR)) = ((((((I2Cx->DMA_TDLR))) & (~((0x7UL << (0U))))) | (Level & (0x7UL << (0U))))));
}
...
static inline uint32_t I2C_GetDMADataLevel_TX(I2C_TypeDef *I2Cx)
{
    return ((uint32_t)((I2Cx->DMA_TDLR) & ((0x7UL << (0U)))));
}
...
static inline void I2C_SetDMADataLevel_RX(I2C_TypeDef *I2Cx, uint32_t Level)
{
    (((I2Cx->DMA_RDLR)) = ((((((I2Cx->DMA_RDLR))) & (~((0x7UL << (0U))))) | (Level & (0x7UL << (0U))))));
}
...
static inline uint32_t I2C_GetDMADataLevel_RX(I2C_TypeDef *I2Cx)
{
    return ((uint32_t)((I2Cx->DMA_RDLR) & ((0x7UL << (0U)))));
}
...
static inline void I2C_EnableGeneralCall(I2C_TypeDef *I2Cx)
{
    ((I2Cx->ACK_GENERAL_CALL) |= ((0x1UL << (0U))));
}
...
static inline void I2C_DisableGeneralCall(I2C_TypeDef *I2Cx)
{
    ((I2Cx->ACK_GENERAL_CALL) &= ~((0x1UL << (0U))));
}
...
static inline uint32_t I2C_IsEnabledGeneralCall(I2C_TypeDef *I2Cx)
{
    return ((((I2Cx->ACK_GENERAL_CALL) & ((0x1UL << (0U)))) == (0x1UL << (0U))) ? 1UL : 0UL);
}
...
static inline void I2C_SetOwnAddress1(I2C_TypeDef *I2Cx, uint16_t OwnAddress1, I2C_AddrSize_TypeDef OwnAddrSize)
{
    (((I2Cx->SAR)) = ((((((I2Cx->SAR))) & (~((0x3FFUL << (0U))))) | ((OwnAddress1 & (0x3FFUL << (0U)))))))
...
static inline void I2C_SetClockSpeedMode(I2C_TypeDef *I2Cx, I2C_Speed_TypeDef ClockSpeedMode)
{
    (((I2Cx->CON)) = ((((((I2Cx->CON))) & (~((0x3UL << (1U))))) | ((uint32_t)ClockSpeedMode))));
}
...
static inline I2C_Speed_TypeDef I2C_GetClockSpeedMode(I2C_TypeDef *I2Cx)
{
    return (I2C_Speed_TypeDef)((I2Cx->CON) & ((0x3UL << (1U))));
}
# 372 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Inc/bmcu_i2c.h"
static inline void I2C_SetSCLPeriods(I2C_TypeDef *I2Cx, I2C_Speed_TypeDef ClockSpeedMode, uint16_t HCNT, uint16_t LCNT)
{
...
static inline uint32_t I2C_IsActiveFlag(I2C_TypeDef *I2Cx, I2C_Flag_TypeDef Flag)
{
    uint32_t Mask = (1UL << Flag);

    return ((((I2Cx->STATUS) & (Mask)) == Mask) ? 1UL : 0UL);
}
...
static inline void I2C_EnableIT(I2C_TypeDef *I2Cx, I2C_IT_TypeDef IT)
{
    ((I2Cx->INTR_MASK) |= ((1UL << IT)));
}
...
static inline void I2C_DisableIT(I2C_TypeDef *I2Cx, I2C_IT_TypeDef IT)
{
    ((I2Cx->INTR_MASK) &= ~((1UL << IT)));
}
...
static inline uint32_t I2C_IsEnabledIT(I2C_TypeDef *I2Cx, I2C_IT_TypeDef IT)
{
    uint32_t Mask = (1UL << IT);

    return ((((I2Cx->INTR_MASK) & (Mask)) == Mask) ? 1UL : 0UL);
}
...
static inline uint32_t I2C_IsActiveIT(I2C_TypeDef *I2Cx, I2C_IT_TypeDef IT)
{
    uint32_t Mask = (1UL << IT);

    return ((((I2Cx->RAW_INTR_STAT) & (Mask)) == Mask) ? 1UL : 0UL);
}
...
static inline void I2C_ClearIT(I2C_TypeDef *I2Cx, I2C_IT_TypeDef IT)
{
...
# 512 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Inc/bmcu_i2c.h"
static inline void I2C_ClearIT_All(I2C_TypeDef *I2Cx)
{
    volatile uint32_t tmpreg;
...
static inline void I2C_EnableTxCmdBlock(I2C_TypeDef *I2Cx)
{
    ((I2Cx->ENABLE) |= ((0x1UL << (2U))));
}
...
static inline void I2C_DisableTxCmdBlock(I2C_TypeDef *I2Cx)
{
    ((I2Cx->ENABLE) &= ~((0x1UL << (2U))));
}
...
static inline uint32_t I2C_IsEnabledTxCmdBlock(I2C_TypeDef *I2Cx)
{
    return ((((I2Cx->ENABLE) & ((0x1UL << (2U)))) == (0x1UL << (2U))) ? 1UL : 0UL);
}
...
static inline void I2C_Abort(I2C_TypeDef *I2Cx)
{
    ((I2Cx->ENABLE) |= ((0x1UL << (1U))));
}
...
static inline uint8_t I2C_ReceiveData(I2C_TypeDef *I2Cx)
{
    return (uint8_t)(((I2Cx->DATA_CMD) & ((0xFFUL << (0U)))));
}
# 575 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Inc/bmcu_i2c.h"
static inline void I2C_TransmitData(I2C_TypeDef *I2Cx, uint8_t Data, uint32_t Flags)
{
    ((I2Cx->DATA_CMD) = ((Flags & (0x1UL << (8U))) | ((uint32_t)Data << (0U))))
                                                                                    ;
}
...
# 18 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_i2c.c" 2


#define I2C_DEFAULT_FS_SPKLEN 5U
#define I2C_DEFAULT_HS_SPKLEN 1U

#define I2C_DEFAULT_TAR_ADDR 0x55U
#define I2C_DEFAULT_SLAVE_ADDR 0x55U

#define I2C_DEFAULT_MASTER_CODE 0x01U

#define I2C_DEFAULT_TX_TL 8U
#define I2C_DEFAULT_RX_TL 8U

#define I2C_DEFAULT_SS_SCL_HCNT 0x0190U
#define I2C_DEFAULT_SS_SCL_LCNT 0x01D6U
#define I2C_DEFAULT_FS_SCL_HCNT 0x003CU
#define I2C_DEFAULT_FS_SCL_LCNT 0x0082U
#define I2C_DEFAULT_HS_SCL_HCNT 0x0006U
#define I2C_DEFAULT_HS_SCL_LCNT 0x0010U

#define IS_I2C_PERIPHERAL_MODE(__VALUE__) (((__VALUE__) == I2C_MODE_MASTER) || ((__VALUE__) == I2C_MODE_SLAVE))


#define IS_I2C_SPEED(__VALUE__) (((__VALUE__) == I2C_SPEED_STANDARD) || ((__VALUE__) == I2C_SPEED_FAST) || ((__VALUE__) == I2C_SPEED_HIGH))



#define IS_I2C_OWN_ADDRESS1(__VALUE__) ((__VALUE__) <= 0x3FFU)

#define IS_I2C_OWN_ADDRSIZE(__VALUE__) (((__VALUE__) == I2C_ADDR_7BITS) || ((__VALUE__) == I2C_ADDR_10BITS))
...
# 65 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_i2c.c"
ErrorStatus I2C_DeInit(I2C_TypeDef *I2Cx)
{
...
# 72 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_i2c.c" 3 4
   ((
# 72 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_i2c.c"
   (((I2Cx) == ((I2C_TypeDef*)(0x11000000UL + 0x00004000UL))) || ((I2Cx) == ((I2C_TypeDef*)(0x11000000UL + 0x00005000UL))) || ((I2Cx) == ((I2C_TypeDef*)((0x11000000UL + 0x02000000UL) + 0x00004000UL))) || ((I2Cx) == ((I2C_TypeDef*)((0x11000000UL + 0x02000000UL) + 0x00005000UL))))
# 72 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_i2c.c" 3 4
   ) ? (void)0 : __assert_func ("C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_i2c.c", 72, __func__, 
# 72 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_i2c.c"
   "IS_I2C_ALL_INSTANCE(I2Cx)"
# 72 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_i2c.c" 3 4
   ))
# 72 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_i2c.c"
                                    ;
    ...
    if (((I2Cx->ENABLE_STATUS) & ((0x1UL << (0U)))) == (0x1UL << (0U)))
    {


        if ((((I2Cx->CON) & ((0x1UL << (0U)))) == (0x1UL << (0U))) &&
            (((I2Cx->STATUS) & ((0x1UL << (2U)))) == 0UL))
        {
            ...
            ((I2Cx->INTR_MASK) &= ~((0x1UL << (6U))));


            ((I2Cx->ENABLE) |= ((0x1UL << (1U))));

            timeout = 1000UL;
            while ((((I2Cx->TX_ABRT_SOURCE) & ((0x1UL << (16U)))) == 0UL) && (timeout > 0UL))
            {
                timeout--;
            }
        ...
        if (status == SUCCESS)
        {
            ...
            timeout = 1000UL;
            while ((((I2Cx->ENABLE_STATUS) & ((0x1UL << (0U)))) != 0UL) && (timeout > 0UL))
            {
                timeout--;
            }
    ...
    if (status == SUCCESS)
    {
        ...
        (((I2Cx->ENABLE)) = ((((((I2Cx->ENABLE))) & (~((0x1UL << (3U))))) | ((0x1UL << (2U))))))

                                           ;
        ((I2Cx->CON) = (((0x1UL << (6U)) | (0x1UL << (5U)) | (0x3UL << (1U)) | (0x1UL << (0U)))))

                                                                                     ;
        ((I2Cx->TAR) = (((uint32_t)0x55U << (0U))));
        ((I2Cx->SAR) = (((uint32_t)0x55U << (0U))));
        ((I2Cx->HS_MADDR) = (((uint32_t)0x01U << (0U))));
        ((I2Cx->INTR_MASK) = (((0x1UL << (14U)) | (0x1UL << (11U)) | (0x1UL << (7U)) | (0x1UL << (6U)) | (0x1UL << (5U)) | (0x1UL << (4U)) | (0x1UL << (3U)) | (0x1UL << (2U)) | (0x1UL << (1U)) | (0x1UL << (0U)))))




                                                                  ;
        ((I2Cx->DMA_CR) &= ~((0x1UL << (1U)) | (0x1UL << (0U))));
        ((I2Cx->TX_TL) = ((uint32_t)8U << (0U)));
        ((I2Cx->RX_TL) = ((uint32_t)8U << (0U)));
        ((I2Cx->SS_SCL_HCNT) = ((uint32_t)0x0190U));
        ((I2Cx->SS_SCL_LCNT) = ((uint32_t)0x01D6U));
        ((I2Cx->FS_SCL_HCNT) = ((uint32_t)0x003CU));
        ((I2Cx->FS_SCL_LCNT) = ((uint32_t)0x0082U));
        ((I2Cx->HS_SCL_HCNT) = ((uint32_t)0x0006U));
        ((I2Cx->HS_SCL_LCNT) = ((uint32_t)0x0010U));
    }

    return status;
}
# 164 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_i2c.c"
ErrorStatus I2C_Init(I2C_TypeDef *I2Cx, I2C_InitStruct_TypeDef *I2C_InitStruct)
{
...
# 169 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_i2c.c" 3 4
   ((
# 169 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_i2c.c"
   (((I2Cx) == ((I2C_TypeDef*)(0x11000000UL + 0x00004000UL))) || ((I2Cx) == ((I2C_TypeDef*)(0x11000000UL + 0x00005000UL))) || ((I2Cx) == ((I2C_TypeDef*)((0x11000000UL + 0x02000000UL) + 0x00004000UL))) || ((I2Cx) == ((I2C_TypeDef*)((0x11000000UL + 0x02000000UL) + 0x00005000UL))))
# 169 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_i2c.c" 3 4
   ) ? (void)0 : __assert_func ("C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_i2c.c", 169, __func__, 
# 169 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_i2c.c"
   "IS_I2C_ALL_INSTANCE(I2Cx)"
# 169 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_i2c.c" 3 4
   ))
...
# 170 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_i2c.c" 3 4
   ((
# 170 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_i2c.c"
   (((I2C_InitStruct->PeripheralMode) == I2C_MODE_MASTER) || ((I2C_InitStruct->PeripheralMode) == I2C_MODE_SLAVE))
# 170 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_i2c.c" 3 4
   ) ? (void)0 : __assert_func ("C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_i2c.c", 170, __func__, 
# 170 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_i2c.c"
   "IS_I2C_PERIPHERAL_MODE(I2C_InitStruct->PeripheralMode)"
# 170 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_i2c.c" 3 4
   ))
# 170 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_i2c.c"
                                                                 ;
    
# 171 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_i2c.c" 3 4
   ((
# 171 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_i2c.c"
   (((I2C_InitStruct->Speed) == I2C_SPEED_STANDARD) || ((I2C_InitStruct->Speed) == I2C_SPEED_FAST) || ((I2C_InitStruct->Speed) == I2C_SPEED_HIGH))
# 171 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_i2c.c" 3 4
   ) ? (void)0 : __assert_func ("C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_i2c.c", 171, __func__, 
# 171 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_i2c.c"
   "IS_I2C_SPEED(I2C_InitStruct->Speed)"
# 171 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_i2c.c" 3 4
   ))
# 171 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_i2c.c"
                                              ;
    
# 172 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_i2c.c" 3 4
   ((
# 172 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_i2c.c"
   ((I2C_InitStruct->OwnAddress1) <= 0x3FFU)
# 172 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_i2c.c" 3 4
   ) ? (void)0 : __assert_func ("C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_i2c.c", 172, __func__, 
# 172 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_i2c.c"
   "IS_I2C_OWN_ADDRESS1(I2C_InitStruct->OwnAddress1)"
# 172 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_i2c.c" 3 4
   ))
# 172 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_i2c.c"
                                                           ;
    
# 173 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_i2c.c" 3 4
   ((
# 173 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_i2c.c"
   (((I2C_InitStruct->OwnAddrSize) == I2C_ADDR_7BITS) || ((I2C_InitStruct->OwnAddrSize) == I2C_ADDR_10BITS))
# 173 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_i2c.c" 3 4
   ) ? (void)0 : __assert_func ("C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_i2c.c", 173, __func__, 
# 173 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_i2c.c"
   "IS_I2C_OWN_ADDRSIZE(I2C_InitStruct->OwnAddrSize)"
# 173 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_i2c.c" 3 4
   ))
# 173 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_i2c.c"
                                                           ;
    
# 174 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_i2c.c" 3 4
   ((
# 174 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_i2c.c"
   ((I2C_InitStruct->MasterCode) <= 0x7U)
# 174 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_i2c.c" 3 4
   ) ? (void)0 : __assert_func ("C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_i2c.c", 174, __func__, 
# 174 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_i2c.c"
   "IS_I2C_MASTER_CODE(I2C_InitStruct->MasterCode)"
# 174 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_i2c.c" 3 4
   ))
# 174 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_i2c.c"
                                                         ;
    
# 175 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_i2c.c" 3 4
   ((
# 175 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_i2c.c"
   ((I2C_InitStruct->TargetAddress) <= 0x3FFU)
# 175 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_i2c.c" 3 4
   ) ? (void)0 : __assert_func ("C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_i2c.c", 175, __func__, 
# 175 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_i2c.c"
   "IS_I2C_TARGET_ADDRESS(I2C_InitStruct->TargetAddress)"
# 175 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_i2c.c" 3 4
   ))
# 175 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_i2c.c"
                                                               ;
    
# 176 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_i2c.c" 3 4
   ((
# 176 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_i2c.c"
   ((I2C_InitStruct->TxFIFOThreshold) <= 8U)
# 176 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_i2c.c" 3 4
   ) ? (void)0 : __assert_func ("C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_i2c.c", 176, __func__, 
# 176 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_i2c.c"
   "IS_I2C_TX_FIFO_THRESHOLD(I2C_InitStruct->TxFIFOThreshold)"
# 176 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_i2c.c" 3 4
   ))
# 176 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_i2c.c"
                                                                    ;
    
# 177 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_i2c.c" 3 4
   ((
# 177 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_i2c.c"
   ((I2C_InitStruct->RxFIFOThreshold) <= 8U)
# 177 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_i2c.c" 3 4
   ) ? (void)0 : __assert_func ("C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_i2c.c", 177, __func__, 
# 177 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_i2c.c"
   "IS_I2C_RX_FIFO_THRESHOLD(I2C_InitStruct->RxFIFOThreshold)"
# 177 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_i2c.c" 3 4
   ))
# 177 "C:/MCU/U1000/mcu-sdk-windows_2.3.0_20260703/Drivers/HAL/Src/bmcu_i2c.c"
                                                                    ;

    if (((I2Cx->ENABLE_STATUS) & ((0x1UL << (0U)))) == 0x0UL)
    {
        if (I2C_InitStruct->PeripheralMode == I2C_MODE_MASTER)
        {
            ...
            (((I2Cx->CON)) = ((((((I2Cx->CON))) & (~((0x3UL << (1U))))) | (((0x1UL << (6U)) | (0x1UL << (5U)) | I2C_InitStruct->Speed | (0x1UL << (0U)))))))
            ...
            (((I2Cx->TAR)) = ((((((I2Cx->TAR))) & (~((0x3FFUL << (0U))))) | ((I2C_InitStruct->TargetAddress & (0x3FFUL << (0U)))))))
            ...
            if (I2C_InitStruct->Speed == I2C_SPEED_STANDARD)
            {
                ...
                ((I2Cx->SS_SCL_HCNT) = (I2C_InitStruct->SCL_HCNT));
                ((I2Cx->SS_SCL_LCNT) = (I2C_InitStruct->SCL_LCNT));
            }
            else if (I2C_InitStruct->Speed == I2C_SPEED_FAST)
            {
                ...
                ((I2Cx->FS_SCL_HCNT) = (I2C_InitStruct->SCL_HCNT));
                ((I2Cx->FS_SCL_LCNT) = (I2C_InitStruct->SCL_LCNT));
            }
            else
            {
                ...
                ((I2Cx->HS_MADDR) = (I2C_InitStruct->MasterCode));


                ((I2Cx->HS_SCL_HCNT) = (I2C_InitStruct->SCL_HCNT));
                ((I2Cx->HS_SCL_LCNT) = (I2C_InitStruct->SCL_LCNT));
            }
        }
        else
        {
            ...
            (((I2Cx->SAR)) = ((((((I2Cx->SAR))) & (~((0x3FFUL << (0U))))) | ((I2C_InitStruct->OwnAddress1 & (0x3FFUL << (0U)))))))

                                                                       ;


            (((I2Cx->CON)) = ((((((I2Cx->CON))) & (~(((0x1UL << (6U)) | (0x3UL << (1U)) | (0x1UL << (0U)))))) | (I2C_InitStruct->Speed))))
        ...
        ((I2Cx->TX_TL) = (I2C_InitStruct->TxFIFOThreshold));
        ((I2Cx->RX_TL) = (I2C_InitStruct->RxFIFOThreshold));
...
void I2C_StructInit(I2C_InitStruct_TypeDef *I2C_InitStruct)
{
    ...
    I2C_InitStruct->OwnAddress1 = 0x55U;
    I2C_InitStruct->OwnAddrSize = I2C_ADDR_7BITS;
    I2C_InitStruct->MasterCode = 0x01U;
    I2C_InitStruct->TargetAddress = 0x55U;
    I2C_InitStruct->SCL_LCNT = 5U + 8;
    I2C_InitStruct->SCL_HCNT = 5U + 6;
    I2C_InitStruct->TxFIFOThreshold = 8U;
    I2C_InitStruct->RxFIFOThreshold = 8U;
}
