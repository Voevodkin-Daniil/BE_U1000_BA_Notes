...
OUTPUT_ARCH(riscv)
ENTRY(_start)
SEARCH_DIR("=/toolchain/bin/x-tools/HOST-x86_64-w64-mingw32/riscv32-none-elf/riscv32-none-elf/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
