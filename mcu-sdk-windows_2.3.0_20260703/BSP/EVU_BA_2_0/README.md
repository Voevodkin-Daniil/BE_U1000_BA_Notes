# Description
EVU-BA-2.0 development board (EValUation BAse board, version 2.0) is designed to simplify the development and debugging of user projects.  
This BSP is intended to support the EVU-BA-2.0 board and assist in developing new software projects based on it.
