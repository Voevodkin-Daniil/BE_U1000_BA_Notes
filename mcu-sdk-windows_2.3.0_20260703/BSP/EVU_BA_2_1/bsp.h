/**
 * *****************************************************************************
 *  @file       BSP/EVU_BA_2_1/bsp.h
 *  @author     Baikal electronics SDK team
 *  @brief      EVU_BA_2_1 BSP header file
 *  @version    2.3.0
 *  @date       20260703
 *  @details
 *  Board Support Package is intended to support the EVU-BA-2.1 board and assist
 *  in developing new software projects based on it.
 *  It contains board-specific definitions, constants and functions.
 * 
 *  File content:
 *      - EVU-BA-2.1 board related constants and definitions
 * *****************************************************************************
