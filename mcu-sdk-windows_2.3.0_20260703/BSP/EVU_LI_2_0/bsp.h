/**
 * *****************************************************************************
 *  @file       BSP/EVU_LI_2_0/bsp.h
 *  @author     Baikal electronics SDK team
 *  @brief      EVU_LI_2_0 BSP header file
 *  @version    2.3.0
 *  @date       20260703
 *  @details
 *  Board Support Package is intended to support the EVU-LI-2.0 board and assist
 *  in developing new software projects based on it.
 *  It contains board-specific definitions, constants and functions.
 * 
 *  File content:
 *      - EVU-LI-2.0 board related constants and definitions
 * *****************************************************************************
