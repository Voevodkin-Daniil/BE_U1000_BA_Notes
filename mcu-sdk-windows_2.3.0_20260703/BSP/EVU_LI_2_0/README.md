# Description
EVU-LI-2.0 development board (EValUation LIte board, version 2.0) is designed to simplify the development and debugging of user projects.  
This BSP is intended to support the EVU-LI-2.0 board and assist in developing new software projects based on it.
