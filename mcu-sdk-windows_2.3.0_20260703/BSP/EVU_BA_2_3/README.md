# Description
EVU-BA-2.3 development board (EValUation BAse board, version 2.3) is designed to simplify the development and debugging of user projects.  
This BSP is intended to support the EVU-BA-2.3 board and assist in developing new software projects based on it.
