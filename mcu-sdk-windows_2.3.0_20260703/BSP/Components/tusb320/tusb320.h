...
typedef enum {
    TUSB320_CURRENT_MODE_ADVERTISE_DEFAULT = TUSB320_CSR08_CURRENT_MODE_ADVERTISE_DEFAULT,  /*!< Default (500mA / 900mA) initial value at startup */
...
typedef enum {
    TUSB320_MODE_SELECT_PORT = TUSB320_CSR0A_MODE_SELECT_PORT,  /*!< Maintain mode according to PORT pin selection (default) */
