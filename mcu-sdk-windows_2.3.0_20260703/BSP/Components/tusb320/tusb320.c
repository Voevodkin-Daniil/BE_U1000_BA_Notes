 ...
 */
ErrorStatus
TUSB320_WriteReg (uint8_t RegAddr, uint8_t RegVal) {
 ...
 */
ErrorStatus
TUSB320_ReadReg (uint8_t RegAddr, uint8_t* RegVal) {
    ErrorStatus Status = SUCCESS;
 ...
 */
ErrorStatus
TUSB320_GetDeviceID (uint8_t* ID) {
    ErrorStatus Status = SUCCESS;
 ...
 */
ErrorStatus
TUSB320_CheckDeviceID (uint8_t* ID) {
 ...
 */
ErrorStatus
TUSB320_GetActiveCableDetectionState (TUSB320_ActiveCable_TypeDef* State) {
    uint8_t RegVal;
 ...
 */
ErrorStatus
TUSB320_GetAccessoryConnectionState (TUSB320_AccessoryConnected_TypeDef* State) {
    uint8_t RegVal;
    uint32_t Status = TUSB320_ReadReg(TUSB320_CSR08, &RegVal);
 ...
 */
ErrorStatus
TUSB320_GetDetectedCurrentMode (TUSB320_CurrentModeDetect_TypeDef* Mode) {
    uint8_t RegVal;
    uint32_t Status = TUSB320_ReadReg(TUSB320_CSR08, &RegVal);
 ...
 */
ErrorStatus
TUSB320_SetAdvertisedCurrentMode (TUSB320_CurrentModeAdvertise_TypeDef Mode) {
    uint8_t RegVal;
    uint32_t Status = TUSB320_ReadReg(TUSB320_CSR08, &RegVal);

    if (Status == SUCCESS) {
        MODIFY_REG(RegVal,
                   TUSB320_CSR08_CURRENT_MODE_ADVERTISE,
                   (uint8_t)Mode & TUSB320_CSR08_CURRENT_MODE_ADVERTISE);
 ...
 */
ErrorStatus
TUSB320_GetAdvertisedCurrentMode (TUSB320_CurrentModeAdvertise_TypeDef* Mode) {
    uint8_t RegVal;
    uint32_t Status = TUSB320_ReadReg(TUSB320_CSR08, &RegVal);
 ...
 */
ErrorStatus
TUSB320_SetDRPDutyCycle (TUSB320_DRPDutyCycle_TypeDef DutyCycle) {
    uint8_t RegVal;
    uint32_t Status = TUSB320_ReadReg(TUSB320_CSR09, &RegVal);

    if (Status == SUCCESS) {
        MODIFY_REG(RegVal,
                   TUSB320_CSR09_INTERRUPT_STATUS | TUSB320_CSR09_DRP_DUTY_CYCLE,
 ...
 */
ErrorStatus
TUSB320_GetDRPDutyCycle (TUSB320_DRPDutyCycle_TypeDef* DutyCycle) {
    uint8_t RegVal;
    uint32_t Status = TUSB320_ReadReg(TUSB320_CSR09, &RegVal);
 ...
 */
ErrorStatus
TUSB320_GetCableDirection (TUSB320_CableDir_TypeDef* Direction) {
    uint8_t RegVal;
    uint32_t Status = TUSB320_ReadReg(TUSB320_CSR09, &RegVal);
 ...
 */
ErrorStatus
TUSB320_GetAttachmentState (TUSB320_AttachedState_TypeDef* State) {
    uint8_t RegVal;
    uint32_t Status = TUSB320_ReadReg(TUSB320_CSR09, &RegVal);
 ...
 */
ErrorStatus
TUSB320_SetMode (TUSB320_ModeSelect_TypeDef Mode) {
    uint8_t RegVal;
    uint32_t Status = TUSB320_ReadReg(TUSB320_CSR0A, &RegVal);

    if (Status == SUCCESS) {
        MODIFY_REG(RegVal,
                   TUSB320_CSR0A_MODE_SELECT | TUSB320_CSR0A_I2C_SOFT_RESET,
 ...
 */
ErrorStatus
TUSB320_GetMode (TUSB320_ModeSelect_TypeDef* Mode) {
    uint8_t RegVal;
    uint32_t Status = TUSB320_ReadReg(TUSB320_CSR0A, &RegVal);
 ...
 */
ErrorStatus
TUSB320_SetDebounceTime (TUSB320_Debounce_TypeDef Debounce) {
    uint8_t RegVal;
    uint32_t Status = TUSB320_ReadReg(TUSB320_CSR0A, &RegVal);

    if (Status == SUCCESS) {
        MODIFY_REG(RegVal,
                   TUSB320_CSR0A_DEBOUNCE | TUSB320_CSR0A_I2C_SOFT_RESET,
 ...
 */
ErrorStatus
TUSB320_GetDebounceTime (TUSB320_Debounce_TypeDef* Debounce) {
    uint8_t RegVal;
    uint32_t Status = TUSB320_ReadReg(TUSB320_CSR0A, &RegVal);
 ...
 */
ErrorStatus
TUSB320_SetRdRpMode (TUSB320_RdRp_TypeDef Mode) {
    uint8_t RegVal;
    uint32_t Status = TUSB320_ReadReg(TUSB320_CSR45, &RegVal);

    if (Status == SUCCESS) {
        MODIFY_REG(RegVal,
                   TUSB320_CSR45_DISABLE_RD_RP,
                   (uint8_t)Mode & TUSB320_CSR45_DISABLE_RD_RP);
 ...
 */
ErrorStatus
TUSB320_GetRdRpMode (TUSB320_RdRp_TypeDef* Mode) {
    uint8_t RegVal;
    uint32_t Status = TUSB320_ReadReg(TUSB320_CSR45, &RegVal);
 ...
 */
ErrorStatus
TUSB320_GetITState (ITStatus* IT) {
    uint8_t RegVal;
    uint32_t Status = TUSB320_ReadReg(TUSB320_CSR09, &RegVal);
