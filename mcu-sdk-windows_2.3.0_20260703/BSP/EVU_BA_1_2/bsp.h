...
/*                                    USB                                     */
/******************************************************************************/
#define BSP_USB_DRVVBUS_CLK_EN_FN   (CRU_APB2_EnableClock)
#define BSP_USB_DRVVBUS_CLK_PERIPH  (CRU_APB2_PERIPH_GPIO2)
...
#define BSP_USB_VBUS_FLG_CLK_EN_FN  (CRU_APB1_EnableClock)
#define BSP_USB_VBUS_FLG_CLK_PERIPH (CRU_APB1_PERIPH_GPIO1)
