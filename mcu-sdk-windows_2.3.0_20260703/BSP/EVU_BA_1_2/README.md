# Description
EVU-BA-1.2 development board (EValUation BAse board, version 1.2) is designed to simplify the development and debugging of user projects.  
This BSP is intended to support the EVU-BA-1.2 board and assist in developing new software projects based on it.
