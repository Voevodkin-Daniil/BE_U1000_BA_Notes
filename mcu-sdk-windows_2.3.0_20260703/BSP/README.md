...
See **BOARD** variable description and available values in the building script template file (*Tools/build/Makefile_template*)
...
Please refer to the desired development board BSP for more information (*<BSP_directory/README.md*)
