 ...
 *  @brief      BASIS Baikal-UM registers and their fields definitions
 *  @version    2.3.0
 *  @date       20260703
 * *****************************************************************************
...
typedef enum
{
    ...
    CLINT_MB0_IRQn              = 16,   /*!< Mailbox 0 Interrupt */
    CLINT_MB1_IRQn              = 17,   /*!< Mailbox 1 Interrupt */
    CLINT_EXTI_PA_IRQn          = 18,   /*!< EXTI PA Interrupt */
    CLINT_EXTI_PB_IRQn          = 19,   /*!< EXTI PB Interrupt */
    CLINT_EXTI_PC_IRQn          = 20,   /*!< EXTI PC Interrupt */
    CLINT_USB_IRQn              = 21,   /*!< USB Interrupt */
    CLINT_USB_DMA_IRQn          = 22    /*!< USB DMA Interrupt */
} CLINT_IRQn_TypeDef;
...
typedef enum
{
    ...
    CLIC_USB_DMA_IRQn           = 67,   /*!< USB DMA Interrupt */
    CLIC_CORE2_IRQn             = 68,   /*!< CORE2 Interrupt */
    CLIC_CORE2_MB0_IRQn         = 69,   /*!< CORE2 Mailbox 0 Interrupt */
    CLIC_CORE2_MB1_IRQn         = 70,   /*!< CORE2 Mailbox 1 Interrupt */
    CLIC_EXTI_PA_IRQn           = 71,   /*!< EXTI PA Interrupt */
    CLIC_EXTI_PB_IRQn           = 72,   /*!< EXTI PB Interrupt */
    CLIC_EXTI_PC_IRQn           = 73,   /*!< EXTI PC Interrupt */
    CLIC_CLKI_Mon_IRQn          = 74,   /*!< CLKI Monitor Interrupt */
    CLIC_CORE0_BusError_IRQn    = 75,   /*!< CORE0 Bus Access Error Interrupt */
    CLIC_CORE1_BusError_IRQn    = 76,   /*!< CORE1 Bus Access Error Interrupt */
    CLIC_PLL_Unlock_IRQn        = 77    /*!< PLL Unlock Interrupt */
} CLIC_IRQn_TypeDef;
...
typedef struct
{
    ...
    __IO uint32_t CLKCR0;           /*!< Clock domains select control 0,        Address offset: 0x08 */
    ...
    __IO uint32_t SYSCR0;           /*!< System resource control 0,             Address offset: 0x18 */
    __IO uint32_t SYSCR1;           /*!< System resource control 1,             Address offset: 0x1C */
    __IO uint32_t SYSCR2;           /*!< System resource control 2,             Address offset: 0x20 */
    ...
    __IO uint32_t IOPUCR0;          /*!< PullUp control 0,                      Address offset: 0x2C */
    __IO uint32_t IOPUCR1;          /*!< PullUp control 1,                      Address offset: 0x30 */
    __IO uint32_t IOPDCR0;          /*!< PullDown control 0,                    Address offset: 0x34 */
    __IO uint32_t IOPDCR1;          /*!< PullDown control 1,                    Address offset: 0x38 */
    __IO uint32_t IOAFCR0;          /*!< I/O alternate function control 0,      Address offset: 0x3C */
    __IO uint32_t IOAFCR1;          /*!< I/O alternate function control 1,      Address offset: 0x40 */
    __IO uint32_t IOAFCR2;          /*!< I/O alternate function control 2,      Address offset: 0x44 */
    __IO uint32_t IOAFCR3;          /*!< I/O alternate function control 3,      Address offset: 0x48 */
    __IO uint32_t IOAFCR4;          /*!< I/O alternate function control 4,      Address offset: 0x4C */
    __IO uint32_t IOAFCR5;          /*!< I/O alternate function control 5,      Address offset: 0x50 */
    __IO uint32_t IODSCR0;          /*!< PA outputs drive strength,             Address offset: 0x54 */
    __IO uint32_t IODSCR1;          /*!< PB outputs drive strength,             Address offset: 0x58 */
    __IO uint32_t IODSCR2;          /*!< PC outputs drive strength,             Address offset: 0x5C */
    __IO uint32_t LDOCR;            /*!< LDO control register,                  Address offset: 0x60 */
    __IO uint32_t USBCR;            /*!< USB PHY control and status register,   Address offset: 0x64 */
    uint32_t      RESERVED0[2];     /*!< Reserved,                              Address offset: 0x68 */
    __IO uint32_t SYSSR0;           /*!< System resource status,                Address offset: 0x70 */
    __IO uint32_t WDTCLRKEY;        /*!< Secure key for WDTx reset              Address offset: 0x74 */
    uint32_t      RESERVED1[2];     /*!< Reserved,                              Address offset: 0x78 */
    __IO uint32_t INTCR0;           /*!< Interrupt route control,               Address offset: 0x80 */
    __IO uint32_t CLKCR1;           /*!< Clock domains select control 1,        Address offset: 0x84 */
    ...
    __IO uint32_t FLASHNVRCR;       /*!< NVR1 disable register,                 Address offset: 0x90 */
    __IO uint32_t CORE1CR;          /*!< CORE1 presence register,               Address offset: 0x94 */
} CRU_TypeDef;
...
typedef struct
{
    ...
    __IO uint32_t MANUAL_ADDR;      /*!< Address register in manual mode,       Address offset: 0x34 */
    __IO uint32_t BAD_ADDR0;        /*!< Flash 0 bad sectors address register,  Address offset: 0x38 */
    __IO uint32_t BAD_ADDR1;        /*!< Flash 1 bad sectors address register,  Address offset: 0x3C */
    __IO uint32_t CFG_FLAGS;        /*!< Flash configuration flags register,    Address offset: 0x40 */
    __IO uint32_t NVR_DIS0;         /*!< NVR register 0,                        Address offset: 0x44 */
    __IO uint32_t NVR_DIS1;         /*!< NVR register 1,                        Address offset: 0x48 */
    __IO uint32_t NVR_DIS2;         /*!< NVR register 2,                        Address offset: 0x4C */
    __IO uint32_t NVR_DIS3;         /*!< NVR register 3,                        Address offset: 0x50 */
    __IO uint32_t NVR_DIS4;         /*!< NVR register 4,                        Address offset: 0x54 */
    __IO uint32_t NVR_DIS5;         /*!< NVR register 5,                        Address offset: 0x58 */
    __IO uint32_t NVR_DIS6;         /*!< NVR register 6,                        Address offset: 0x5C */
    __IO uint32_t NVR_DIS7;         /*!< NVR register 7,                        Address offset: 0x60 */
    __IO uint32_t NVR_DIS8;         /*!< NVR register 8,                        Address offset: 0x64 */
    __IO uint32_t NVR_DIS9;         /*!< NVR register 9,                        Address offset: 0x68 */
    __IO uint32_t NVR_DIS10;        /*!< NVR register 10,                       Address offset: 0x6C */
    __IO uint32_t NVR_DIS11;        /*!< NVR register 11,                       Address offset: 0x70 */
    __IO uint32_t NVR_DIS12;        /*!< NVR register 12,                       Address offset: 0x74 */
    __IO uint32_t NVR_DIS13;        /*!< NVR register 13,                       Address offset: 0x78 */
    __IO uint32_t NVR_DIS14;        /*!< NVR register 14,                       Address offset: 0x7C */
    __IO uint32_t NVR_DIS15;        /*!< NVR register 15,                       Address offset: 0x80 */
} EFLASH_TypeDef;
...
typedef struct
{
    ...
    uint32_t RESERVED0[10];         /*!< Reserved,                              Address offset: 0x08 */
    ...
    uint32_t RESERVED1[3];          /*!< Reserved,                              Address offset: 0x54 */
    __IO uint32_t SYNC;             /*!< Synchronization level                  Address offset: 0x60 */
    uint32_t RESERVED2[1];          /*!< Reserved,                              Address offset: 0x64 */
...
typedef struct
{
    ...
    uint32_t RESERVED0;                     /*!< Reserved,                                          Address offset: 0x84 */
    ...
    uint32_t RESERVED1;                     /*!< Reserved,                                          Address offset: 0xA8 */
    __IO uint32_t SCL_STUCK_AT_LOW_TIMEOUT; /*!< SLC Stuck at Low Timeout Register,                 Address offset: 0xAC */
    ...
    uint32_t RESERVED2[14];                 /*!< Reserved,                                          Address offset: 0xB8 */
...
typedef struct
{
    ...
    uint32_t RESERVED0[2];                  /*!< Reserved,                                          Address offset: 0x0C */
    ...
    uint32_t RESERVED2[90];                 /*!< Reserved,                                          Address offset: 0x58 */
    __IO uint32_t RXDMA;                    /*!< Receiver Block DMA Register,                       Address offset: 0x1C0 */
    uint32_t RESERVED3;                     /*!< Reserved,                                          Address offset: 0x1C4 */
    __IO uint32_t TXDMA;                    /*!< Transmitter Block DMA Register,                    Address offset: 0x1C8 */
    uint32_t RESERVED4[9];                  /*!< Reserved,                                          Address offset: 0x1CC */
...
typedef struct
{
    __IO uint32_t DATA0;                    /*!< Data 0 register,               Address offset: 0x00 */
    __IO uint32_t FULL0;                    /*!< Data 0 ready register,         Address offset: 0x04 */
    __IO uint32_t EMPTY0;                   /*!< Data 0 empty register,         Address offset: 0x08 */
    uint32_t RESERVED0;                     /*!< Reserved                       Address offset: 0x0C */
    __IO uint32_t DATA1;                    /*!< Data 1 register,               Address offset: 0x10 */
    __IO uint32_t FULL1;                    /*!< Data 1 ready register,         Address offset: 0x14 */
    __IO uint32_t EMPTY1;                   /*!< Data 1 empty register,         Address offset: 0x18 */
} MB_TypeDef;

/**
 * @brief Advanced-control Timer
 */
typedef struct
{
    __IO uint32_t CR1;                      /*!< Control register 1,                                Address offset: 0x00 */
    ...
    union {
        ...
        __IO uint32_t CCMR1_OC;             /*!< Capture/Compare mode register 1, Output Compare    Address offset: 0x18 */
        __IO uint32_t CCMR1_IC;             /*!< Capture/Compare mode register 1, Input Capture     Address offset: 0x18 */
    };
    union{
        __IO uint32_t CCMR2;                /*!< Capture/Compare mode register 2,                   Address offset: 0x1C */
        __IO uint32_t CCMR2_OC;             /*!< Capture/Compare mode register 2, Output Compare    Address offset: 0x1C */
        __IO uint32_t CCMR2_IC;             /*!< Capture/Compare mode register 2, Input Capture     Address offset: 0x1C */
    };
    ...
    __IO uint32_t PSC;                      /*!< Prescaler register,                                Address offset: 0x28 */
...
typedef struct
{
    __IO uint32_t QESET;            /*!< Control register,                      Address offset: 0x00 */
    __IO uint32_t FILTSET;          /*!< Filters setting register,              Address offset: 0x04 */
...
typedef struct
{
    ...
    __IO uint32_t XIP_CMD;         /* XIP addition control                     Address offset: 0xfC */    
} QSPI_TypeDef;
...
typedef struct
{
    ...
    __IO uint32_t DR[36];          /* Data x                                   Address offset: 0x60 */
    __IO uint32_t RX_SAMPLE_DLY;   /* RX Sample Delay                          Address offset: 0xf0 */
    uint32_t RESERVED0;            /* Reserved,                                Address offset: 0xf4 */
    __IO uint32_t TXD_DRIVE_EDGE;  /* Transmit Drive Edge                      Address offset: 0xf8 */
} SPI_TypeDef;
...
typedef struct
{
    __IO uint32_t LOADCOUNT1;       /*!< Channel n Load Count Register,         Address offset: 0x00 + n * 0x14 */
    __IO uint32_t CURRENTVAL;       /*!< Channel n Current Value Register,      Address offset: 0x04 + n * 0x14 */
    __IO uint32_t CONTROL;          /*!< Channel n Control Register,            Address offset: 0x08 + n * 0x14 */
    __IO uint32_t EOI;              /*!< Channel n End-of-Interrupt Register,   Address offset: 0x0C + n * 0x14 */
    __IO uint32_t INTSTAT;          /*!< Channel n Interrupt Status Register,   Address offset: 0x10 + n * 0x14 */
} TIM_Channel_TypeDef;
...
typedef struct
{
    TIM_Channel_TypeDef CH[4];      /*!< Timer Channel Registers,               Address offset: 0x00 */
    uint32_t RESERVED0[20];         /*!< Reserved,                              Address offset: 0x50 */
    __IO uint32_t INTSTAT;          /*!< Interrupt Status Register,             Address offset: 0xA0 */
    __IO uint32_t EOI;              /*!< End-of-Interrupt Register,             Address offset: 0xA4 */
    __IO uint32_t RAWINTSTAT;       /*!< Raw Interrupt Status Register,         Address offset: 0xA8 */
    __IO uint32_t COMPVERSION;      /*!< Component Version Register,            Address offset: 0xAC */
    __IO uint32_t LOADCOUNT2[4];    /*!< Channel n Load Count2 Register,        Address offset: 0xB0 + n * 0x04 */
} TIM_TypeDef;
...
typedef struct
{
    ...
    uint32_t RESERVED0[4];          /*!< Reserved,                              Address offset: 0x20 */
    union
    {
    ...
    uint32_t RESERVED1[7];          /*!< Reserved,                              Address offset: 0xD8 */
...
/**
 * @brief CORE2 subsystem, DEBUG
 */
typedef struct
{
    __IO uint32_t JTAG_EM;                  /*!< JTAG emulation register,       Address offset: 0x00 */
} CORE2_DEBUG_TypeDef;

/**
 * @brief CORE2 subsystem, TRACE
 */
typedef struct
{
    __IO uint32_t TRACE_SEL;             /*!< Trace select register,         Address offset: 0x00 */
} CORE2_TRACE_TypeDef;
...
#define MB0_BASE                (AHBPERIPH_BASE + 0x00103000UL)     /*!< MB0 peripheral base address (System side) */
#define MB1_BASE                (AHBPERIPH_BASE + 0x00103020UL)     /*!< MB1 peripheral base address (System side) */
...
/* CORE2 periphery */
#define CORE2PERIPH_BASE        0x4000A000UL                        /*!< CORE2 peripheral base address */
#define CORE2_INT_BASE          (CORE2PERIPH_BASE + 0x00000000UL)   /*!< CORE2 INT peripheral base address */
#define CORE2_PIO_BASE          (CORE2PERIPH_BASE + 0x00000004UL)   /*!< CORE2 PIO peripheral base address */
#define CORE2_DEBUG_BASE        (CORE2PERIPH_BASE + 0x00000010UL)   /*!< CORE2 DEBUG peripheral base address */
#define CORE2_TRACE_BASE        (CORE2PERIPH_BASE + 0x00000014UL)   /*!< CORE2 TRACE peripheral base address */
#define CORE2_MB0_BASE          (CORE2PERIPH_BASE + 0x00000400UL)   /*!< CORE2 MB0 peripheral base address (CORE2 side) */
#define CORE2_MB1_BASE          (CORE2PERIPH_BASE + 0x00000420UL)   /*!< CORE2 MB1 peripheral base address (CORE2 side) */
...
/* Processor Core 0 and Core 1 access ROM0, ROM1, TCMA and TCMB memories directly */
/* at ROM0_BASE, ROM1_BASE, TCMA_BASE, TCMB_BASE addresses through the dedicated  */
/* TCM ports. External peripherals can access ROM and TCM memories through        */
/* the slave port (Front Port) of processor Core 0 only. Peripheral domains       */
/* are commutated to processor core interfaces through AXI interconnect block.    */
/* When the peripheral (AXI master) accesses ROM and TCM through the              */
/* Front Port (AXI slave), the memory addresses are mapped to FP_CORE0_ROM0_BASE, */
/* FP_CORE0_TCMA_BASE and FP_CORE0_TCMB_BASE.                                     */
...
#define CORE2_TCMA_SYS_BASE     0x7000F800UL                        /*!< CORE2 TCMA base address (System side) */
#define CORE2_TCMB_SYS_BASE     0x70010000UL                        /*!< CORE2 TCMB base address (System side) */
...
#define ROM_BASE                0xA0800000UL                        /*!< ROM base address */
#define EFLASH_REG_BASE         0xA1000000UL                        /*!< EFLASH registers space base address */

/* CORE2 memory (CORE2 side) */
#define CORE2_ROM_BASE          0x40000000UL                        /*!< CORE2 ROM base address (CORE2 side) */
#define CORE2_TCMA_BASE         0x40007800UL                        /*!< CORE2 TCMA base address (CORE2 side) */
#define CORE2_TCMB_BASE         0x40008000UL                        /*!< CORE2 TCMB base address (CORE2 side) */
...
/** @brief CR1[19:16]: Clock division */
#define ADC_CR1_CKD_Pos                     (16U)
#define ADC_CR1_CKD_Msk                     (0xFUL << ADC_CR1_CKD_Pos)
#define ADC_CR1_CKD                         ADC_CR1_CKD_Msk

#define ADC_CR1_CKD_DIV1                    (0x0UL << ADC_CR1_CKD_Pos)  /*!< CK_INT is not divided */
#define ADC_CR1_CKD_DIV2                    (0x1UL << ADC_CR1_CKD_Pos)  /*!< CK_INT is divided by 2 */
#define ADC_CR1_CKD_DIV3                    (0x2UL << ADC_CR1_CKD_Pos)  /*!< CK_INT is divided by 3 */
#define ADC_CR1_CKD_DIV4                    (0x3UL << ADC_CR1_CKD_Pos)  /*!< CK_INT is divided by 4 */
#define ADC_CR1_CKD_DIV5                    (0x4UL << ADC_CR1_CKD_Pos)  /*!< CK_INT is divided by 5 */
#define ADC_CR1_CKD_DIV6                    (0x5UL << ADC_CR1_CKD_Pos)  /*!< CK_INT is divided by 6 */
#define ADC_CR1_CKD_DIV7                    (0x6UL << ADC_CR1_CKD_Pos)  /*!< CK_INT is divided by 7 */
#define ADC_CR1_CKD_DIV8                    (0x7UL << ADC_CR1_CKD_Pos)  /*!< CK_INT is divided by 8 */
#define ADC_CR1_CKD_DIV9                    (0x8UL << ADC_CR1_CKD_Pos)  /*!< CK_INT is divided by 9 */
#define ADC_CR1_CKD_DIV10                   (0x9UL << ADC_CR1_CKD_Pos)  /*!< CK_INT is divided by 10 */
#define ADC_CR1_CKD_DIV11                   (0xAUL << ADC_CR1_CKD_Pos)  /*!< CK_INT is divided by 11 */
#define ADC_CR1_CKD_DIV12                   (0xBUL << ADC_CR1_CKD_Pos)  /*!< CK_INT is divided by 12 */
#define ADC_CR1_CKD_DIV13                   (0xCUL << ADC_CR1_CKD_Pos)  /*!< CK_INT is divided by 13 */
#define ADC_CR1_CKD_DIV14                   (0xDUL << ADC_CR1_CKD_Pos)  /*!< CK_INT is divided by 14 */
#define ADC_CR1_CKD_DIV15                   (0xEUL << ADC_CR1_CKD_Pos)  /*!< CK_INT is divided by 15 */
#define ADC_CR1_CKD_DIV16                   (0xFUL << ADC_CR1_CKD_Pos)  /*!< CK_INT is divided by 16 */

/** @brief CR1[20]: Clear interrupt */
...
/** @brief CR1[21]: Temperature sensor */
...
/** @brief CR1[22]: ADC clock from CLKI */
...
#define ADC_ASMPR_SMP0_0CYCLES              (0x0UL << ADC_ASMPR_SMP0_Pos)   /*!< 0 cycles */
...
#define ADC_ASMPR_SMP0_75CYCLES             (0x3UL << ADC_ASMPR_SMP0_Pos)   /*!< 75 cycles */
#define ADC_ASMPR_SMP0_125CYCLES            (0x4UL << ADC_ASMPR_SMP0_Pos)   /*!< 125 cycles */
#define ADC_ASMPR_SMP0_175CYCLES            (0x5UL << ADC_ASMPR_SMP0_Pos)   /*!< 175 cycles */
#define ADC_ASMPR_SMP0_225CYCLES            (0x6UL << ADC_ASMPR_SMP0_Pos)   /*!< 225 cycles */
#define ADC_ASMPR_SMP0_275CYCLES            (0x7UL << ADC_ASMPR_SMP0_Pos)   /*!< 275 cycles */
...
#define ADC_ASMPR_SMP1_0CYCLES              (0x0UL << ADC_ASMPR_SMP1_Pos)   /*!< 0 cycles */
#define ADC_ASMPR_SMP1_25CYCLES             (0x1UL << ADC_ASMPR_SMP1_Pos)   /*!< 25 cycles */
#define ADC_ASMPR_SMP1_50CYCLES             (0x2UL << ADC_ASMPR_SMP1_Pos)   /*!< 50 cycles */
#define ADC_ASMPR_SMP1_75CYCLES             (0x3UL << ADC_ASMPR_SMP1_Pos)   /*!< 75 cycles */
#define ADC_ASMPR_SMP1_125CYCLES            (0x4UL << ADC_ASMPR_SMP1_Pos)   /*!< 125 cycles */
#define ADC_ASMPR_SMP1_175CYCLES            (0x5UL << ADC_ASMPR_SMP1_Pos)   /*!< 175 cycles */
#define ADC_ASMPR_SMP1_225CYCLES            (0x6UL << ADC_ASMPR_SMP1_Pos)   /*!< 225 cycles */
#define ADC_ASMPR_SMP1_275CYCLES            (0x7UL << ADC_ASMPR_SMP1_Pos)   /*!< 275 cycles */
...
#define ADC_ASMPR_SMP2_0CYCLES              (0x0UL << ADC_ASMPR_SMP2_Pos)   /*!< 0 cycles */
#define ADC_ASMPR_SMP2_25CYCLES             (0x1UL << ADC_ASMPR_SMP2_Pos)   /*!< 25 cycles */
#define ADC_ASMPR_SMP2_50CYCLES             (0x2UL << ADC_ASMPR_SMP2_Pos)   /*!< 50 cycles */
#define ADC_ASMPR_SMP2_75CYCLES             (0x3UL << ADC_ASMPR_SMP2_Pos)   /*!< 75 cycles */
#define ADC_ASMPR_SMP2_125CYCLES            (0x4UL << ADC_ASMPR_SMP2_Pos)   /*!< 125 cycles */
#define ADC_ASMPR_SMP2_175CYCLES            (0x5UL << ADC_ASMPR_SMP2_Pos)   /*!< 175 cycles */
#define ADC_ASMPR_SMP2_225CYCLES            (0x6UL << ADC_ASMPR_SMP2_Pos)   /*!< 225 cycles */
#define ADC_ASMPR_SMP2_275CYCLES            (0x7UL << ADC_ASMPR_SMP2_Pos)   /*!< 275 cycles */
...
#define ADC_ASMPR_SMP3_0CYCLES              (0x0UL << ADC_ASMPR_SMP3_Pos)   /*!< 0 cycles */
#define ADC_ASMPR_SMP3_25CYCLES             (0x1UL << ADC_ASMPR_SMP3_Pos)   /*!< 25 cycles */
#define ADC_ASMPR_SMP3_50CYCLES             (0x2UL << ADC_ASMPR_SMP3_Pos)   /*!< 50 cycles */
#define ADC_ASMPR_SMP3_75CYCLES             (0x3UL << ADC_ASMPR_SMP3_Pos)   /*!< 75 cycles */
#define ADC_ASMPR_SMP3_125CYCLES            (0x4UL << ADC_ASMPR_SMP3_Pos)   /*!< 125 cycles */
#define ADC_ASMPR_SMP3_175CYCLES            (0x5UL << ADC_ASMPR_SMP3_Pos)   /*!< 175 cycles */
#define ADC_ASMPR_SMP3_225CYCLES            (0x6UL << ADC_ASMPR_SMP3_Pos)   /*!< 225 cycles */
#define ADC_ASMPR_SMP3_275CYCLES            (0x7UL << ADC_ASMPR_SMP3_Pos)   /*!< 275 cycles */
...
#define ADC_ASMPR_SMP4_0CYCLES              (0x0UL << ADC_ASMPR_SMP4_Pos)   /*!< 0 cycles */
#define ADC_ASMPR_SMP4_25CYCLES             (0x1UL << ADC_ASMPR_SMP4_Pos)   /*!< 25 cycles */
#define ADC_ASMPR_SMP4_50CYCLES             (0x2UL << ADC_ASMPR_SMP4_Pos)   /*!< 50 cycles */
#define ADC_ASMPR_SMP4_75CYCLES             (0x3UL << ADC_ASMPR_SMP4_Pos)   /*!< 75 cycles */
#define ADC_ASMPR_SMP4_125CYCLES            (0x4UL << ADC_ASMPR_SMP4_Pos)   /*!< 125 cycles */
#define ADC_ASMPR_SMP4_175CYCLES            (0x5UL << ADC_ASMPR_SMP4_Pos)   /*!< 175 cycles */
#define ADC_ASMPR_SMP4_225CYCLES            (0x6UL << ADC_ASMPR_SMP4_Pos)   /*!< 225 cycles */
#define ADC_ASMPR_SMP4_275CYCLES            (0x7UL << ADC_ASMPR_SMP4_Pos)   /*!< 275 cycles */
...
#define ADC_ASMPR_SMP5_0CYCLES              (0x0UL << ADC_ASMPR_SMP5_Pos)   /*!< 0 cycles */
#define ADC_ASMPR_SMP5_25CYCLES             (0x1UL << ADC_ASMPR_SMP5_Pos)   /*!< 25 cycles */
#define ADC_ASMPR_SMP5_50CYCLES             (0x2UL << ADC_ASMPR_SMP5_Pos)   /*!< 50 cycles */
#define ADC_ASMPR_SMP5_75CYCLES             (0x3UL << ADC_ASMPR_SMP5_Pos)   /*!< 75 cycles */
#define ADC_ASMPR_SMP5_125CYCLES            (0x4UL << ADC_ASMPR_SMP5_Pos)   /*!< 125 cycles */
#define ADC_ASMPR_SMP5_175CYCLES            (0x5UL << ADC_ASMPR_SMP5_Pos)   /*!< 175 cycles */
#define ADC_ASMPR_SMP5_225CYCLES            (0x6UL << ADC_ASMPR_SMP5_Pos)   /*!< 225 cycles */
#define ADC_ASMPR_SMP5_275CYCLES            (0x7UL << ADC_ASMPR_SMP5_Pos)   /*!< 275 cycles */
...
#define ADC_ASMPR_SMP6_0CYCLES              (0x0UL << ADC_ASMPR_SMP6_Pos)   /*!< 0 cycles */
#define ADC_ASMPR_SMP6_25CYCLES             (0x1UL << ADC_ASMPR_SMP6_Pos)   /*!< 25 cycles */
#define ADC_ASMPR_SMP6_50CYCLES             (0x2UL << ADC_ASMPR_SMP6_Pos)   /*!< 50 cycles */
#define ADC_ASMPR_SMP6_75CYCLES             (0x3UL << ADC_ASMPR_SMP6_Pos)   /*!< 75 cycles */
#define ADC_ASMPR_SMP6_125CYCLES            (0x4UL << ADC_ASMPR_SMP6_Pos)   /*!< 125 cycles */
#define ADC_ASMPR_SMP6_175CYCLES            (0x5UL << ADC_ASMPR_SMP6_Pos)   /*!< 175 cycles */
#define ADC_ASMPR_SMP6_225CYCLES            (0x6UL << ADC_ASMPR_SMP6_Pos)   /*!< 225 cycles */
#define ADC_ASMPR_SMP6_275CYCLES            (0x7UL << ADC_ASMPR_SMP6_Pos)   /*!< 275 cycles */
...
#define ADC_ASMPR_SMP7_0CYCLES              (0x0UL << ADC_ASMPR_SMP7_Pos)   /*!< 0 cycles */
#define ADC_ASMPR_SMP7_25CYCLES             (0x1UL << ADC_ASMPR_SMP7_Pos)   /*!< 25 cycles */
#define ADC_ASMPR_SMP7_50CYCLES             (0x2UL << ADC_ASMPR_SMP7_Pos)   /*!< 50 cycles */
#define ADC_ASMPR_SMP7_75CYCLES             (0x3UL << ADC_ASMPR_SMP7_Pos)   /*!< 75 cycles */
#define ADC_ASMPR_SMP7_125CYCLES            (0x4UL << ADC_ASMPR_SMP7_Pos)   /*!< 125 cycles */
#define ADC_ASMPR_SMP7_175CYCLES            (0x5UL << ADC_ASMPR_SMP7_Pos)   /*!< 175 cycles */
#define ADC_ASMPR_SMP7_225CYCLES            (0x6UL << ADC_ASMPR_SMP7_Pos)   /*!< 225 cycles */
#define ADC_ASMPR_SMP7_275CYCLES            (0x7UL << ADC_ASMPR_SMP7_Pos)   /*!< 275 cycles */
...
/** @brief CLKSEL[23:15]: CCLK 1MHz pulse generator prescaler */
...
/** @brief PLLSET[31]: PLL_NLOCK flag reset */
...
/*****************  Bit definition for CRU_CLKCR0 register  ***************/

/** @brief CLKCR0[4:0]: CCLK divider */
...
#define CRU_CLKCR0_CCLKDIV_DIV1         (0x0UL << CRU_CLKCR0_CCLKDIV_Pos)   /*!< CCLK not divided */
#define CRU_CLKCR0_CCLKDIV_DIV2         (0x2UL << CRU_CLKCR0_CCLKDIV_Pos)   /*!< CCLK divided by 2 */
#define CRU_CLKCR0_CCLKDIV_DIV3         (0x4UL << CRU_CLKCR0_CCLKDIV_Pos)   /*!< CCLK divided by 3 */
#define CRU_CLKCR0_CCLKDIV_DIV4         (0x6UL << CRU_CLKCR0_CCLKDIV_Pos)   /*!< CCLK divided by 4 */
#define CRU_CLKCR0_CCLKDIV_DIV5         (0x8UL << CRU_CLKCR0_CCLKDIV_Pos)   /*!< CCLK divided by 5 */
#define CRU_CLKCR0_CCLKDIV_DIV6         (0xAUL << CRU_CLKCR0_CCLKDIV_Pos)   /*!< CCLK divided by 6 */
#define CRU_CLKCR0_CCLKDIV_DIV7         (0xCUL << CRU_CLKCR0_CCLKDIV_Pos)   /*!< CCLK divided by 7 */
#define CRU_CLKCR0_CCLKDIV_DIV8         (0xEUL << CRU_CLKCR0_CCLKDIV_Pos)   /*!< CCLK divided by 8 */
#define CRU_CLKCR0_CCLKDIV_DIV9         (0x10UL << CRU_CLKCR0_CCLKDIV_Pos)  /*!< CCLK divided by 9 */
#define CRU_CLKCR0_CCLKDIV_DIV10        (0x12UL << CRU_CLKCR0_CCLKDIV_Pos)  /*!< CCLK divided by 10 */
#define CRU_CLKCR0_CCLKDIV_DIV11        (0x14UL << CRU_CLKCR0_CCLKDIV_Pos)  /*!< CCLK divided by 11 */
#define CRU_CLKCR0_CCLKDIV_DIV12        (0x16UL << CRU_CLKCR0_CCLKDIV_Pos)  /*!< CCLK divided by 12 */
#define CRU_CLKCR0_CCLKDIV_DIV13        (0x18UL << CRU_CLKCR0_CCLKDIV_Pos)  /*!< CCLK divided by 13 */
#define CRU_CLKCR0_CCLKDIV_DIV14        (0x1AUL << CRU_CLKCR0_CCLKDIV_Pos)  /*!< CCLK divided by 14 */
#define CRU_CLKCR0_CCLKDIV_DIV15        (0x1CUL << CRU_CLKCR0_CCLKDIV_Pos)  /*!< CCLK divided by 15 */
#define CRU_CLKCR0_CCLKDIV_DIV16        (0x1EUL << CRU_CLKCR0_CCLKDIV_Pos)  /*!< CCLK divided by 16 */

#define CRU_CLKCR0_CCLKDIV_DIV1_5       (0x1UL << CRU_CLKCR0_CCLKDIV_Pos)   /*!< CCLK divided by 1.5 */
#define CRU_CLKCR0_CCLKDIV_DIV2_5       (0x3UL << CRU_CLKCR0_CCLKDIV_Pos)   /*!< CCLK divided by 2.5 */
#define CRU_CLKCR0_CCLKDIV_DIV3_5       (0x5UL << CRU_CLKCR0_CCLKDIV_Pos)   /*!< CCLK divided by 3.5 */
#define CRU_CLKCR0_CCLKDIV_DIV4_5       (0x7UL << CRU_CLKCR0_CCLKDIV_Pos)   /*!< CCLK divided by 4.5 */
#define CRU_CLKCR0_CCLKDIV_DIV5_5       (0x9UL << CRU_CLKCR0_CCLKDIV_Pos)   /*!< CCLK divided by 5.5 */
#define CRU_CLKCR0_CCLKDIV_DIV6_5       (0xBUL << CRU_CLKCR0_CCLKDIV_Pos)   /*!< CCLK divided by 6.5 */
#define CRU_CLKCR0_CCLKDIV_DIV7_5       (0xDUL << CRU_CLKCR0_CCLKDIV_Pos)   /*!< CCLK divided by 7.5 */
#define CRU_CLKCR0_CCLKDIV_DIV8_5       (0xFUL << CRU_CLKCR0_CCLKDIV_Pos)   /*!< CCLK divided by 8.5 */
#define CRU_CLKCR0_CCLKDIV_DIV9_5       (0x11UL << CRU_CLKCR0_CCLKDIV_Pos)  /*!< CCLK divided by 9.5 */
#define CRU_CLKCR0_CCLKDIV_DIV10_5      (0x13UL << CRU_CLKCR0_CCLKDIV_Pos)  /*!< CCLK divided by 10.5 */
#define CRU_CLKCR0_CCLKDIV_DIV11_5      (0x15UL << CRU_CLKCR0_CCLKDIV_Pos)  /*!< CCLK divided by 11.5 */
#define CRU_CLKCR0_CCLKDIV_DIV12_5      (0x17UL << CRU_CLKCR0_CCLKDIV_Pos)  /*!< CCLK divided by 12.5 */
#define CRU_CLKCR0_CCLKDIV_DIV13_5      (0x19UL << CRU_CLKCR0_CCLKDIV_Pos)  /*!< CCLK divided by 13.5 */
#define CRU_CLKCR0_CCLKDIV_DIV14_5      (0x1BUL << CRU_CLKCR0_CCLKDIV_Pos)  /*!< CCLK divided by 14.5 */
#define CRU_CLKCR0_CCLKDIV_DIV15_5      (0x1DUL << CRU_CLKCR0_CCLKDIV_Pos)  /*!< CCLK divided by 15.5 */

/** @brief CLKCR0[5]: CCLK divider enable */
...
/** @brief CLKCR0[10:6]: PCLK0 divider */
...
#define CRU_CLKCR0_PCLK0DIV_DIV1        (0x0UL << CRU_CLKCR0_PCLK0DIV_Pos)   /*!< PCLK0 not divided */
#define CRU_CLKCR0_PCLK0DIV_DIV2        (0x2UL << CRU_CLKCR0_PCLK0DIV_Pos)   /*!< PCLK0 divided by 2 */
#define CRU_CLKCR0_PCLK0DIV_DIV3        (0x4UL << CRU_CLKCR0_PCLK0DIV_Pos)   /*!< PCLK0 divided by 3 */
#define CRU_CLKCR0_PCLK0DIV_DIV4        (0x6UL << CRU_CLKCR0_PCLK0DIV_Pos)   /*!< PCLK0 divided by 4 */
#define CRU_CLKCR0_PCLK0DIV_DIV5        (0x8UL << CRU_CLKCR0_PCLK0DIV_Pos)   /*!< PCLK0 divided by 5 */
#define CRU_CLKCR0_PCLK0DIV_DIV6        (0xAUL << CRU_CLKCR0_PCLK0DIV_Pos)   /*!< PCLK0 divided by 6 */
#define CRU_CLKCR0_PCLK0DIV_DIV7        (0xCUL << CRU_CLKCR0_PCLK0DIV_Pos)   /*!< PCLK0 divided by 7 */
#define CRU_CLKCR0_PCLK0DIV_DIV8        (0xEUL << CRU_CLKCR0_PCLK0DIV_Pos)   /*!< PCLK0 divided by 8 */
#define CRU_CLKCR0_PCLK0DIV_DIV9        (0x10UL << CRU_CLKCR0_PCLK0DIV_Pos)  /*!< PCLK0 divided by 9 */
#define CRU_CLKCR0_PCLK0DIV_DIV10       (0x12UL << CRU_CLKCR0_PCLK0DIV_Pos)  /*!< PCLK0 divided by 10 */
#define CRU_CLKCR0_PCLK0DIV_DIV11       (0x14UL << CRU_CLKCR0_PCLK0DIV_Pos)  /*!< PCLK0 divided by 11 */
#define CRU_CLKCR0_PCLK0DIV_DIV12       (0x16UL << CRU_CLKCR0_PCLK0DIV_Pos)  /*!< PCLK0 divided by 12 */
#define CRU_CLKCR0_PCLK0DIV_DIV13       (0x18UL << CRU_CLKCR0_PCLK0DIV_Pos)  /*!< PCLK0 divided by 13 */
#define CRU_CLKCR0_PCLK0DIV_DIV14       (0x1AUL << CRU_CLKCR0_PCLK0DIV_Pos)  /*!< PCLK0 divided by 14 */
#define CRU_CLKCR0_PCLK0DIV_DIV15       (0x1CUL << CRU_CLKCR0_PCLK0DIV_Pos)  /*!< PCLK0 divided by 15 */
#define CRU_CLKCR0_PCLK0DIV_DIV16       (0x1EUL << CRU_CLKCR0_PCLK0DIV_Pos)  /*!< PCLK0 divided by 16 */

#define CRU_CLKCR0_PCLK0DIV_DIV1_5      (0x1UL << CRU_CLKCR0_PCLK0DIV_Pos)   /*!< PCLK0 divided by 1.5 */
#define CRU_CLKCR0_PCLK0DIV_DIV2_5      (0x3UL << CRU_CLKCR0_PCLK0DIV_Pos)   /*!< PCLK0 divided by 2.5 */
#define CRU_CLKCR0_PCLK0DIV_DIV3_5      (0x5UL << CRU_CLKCR0_PCLK0DIV_Pos)   /*!< PCLK0 divided by 3.5 */
#define CRU_CLKCR0_PCLK0DIV_DIV4_5      (0x7UL << CRU_CLKCR0_PCLK0DIV_Pos)   /*!< PCLK0 divided by 4.5 */
#define CRU_CLKCR0_PCLK0DIV_DIV5_5      (0x9UL << CRU_CLKCR0_PCLK0DIV_Pos)   /*!< PCLK0 divided by 5.5 */
#define CRU_CLKCR0_PCLK0DIV_DIV6_5      (0xBUL << CRU_CLKCR0_PCLK0DIV_Pos)   /*!< PCLK0 divided by 6.5 */
#define CRU_CLKCR0_PCLK0DIV_DIV7_5      (0xDUL << CRU_CLKCR0_PCLK0DIV_Pos)   /*!< PCLK0 divided by 7.5 */
#define CRU_CLKCR0_PCLK0DIV_DIV8_5      (0xFUL << CRU_CLKCR0_PCLK0DIV_Pos)   /*!< PCLK0 divided by 8.5 */
#define CRU_CLKCR0_PCLK0DIV_DIV9_5      (0x11UL << CRU_CLKCR0_PCLK0DIV_Pos)  /*!< PCLK0 divided by 9.5 */
#define CRU_CLKCR0_PCLK0DIV_DIV10_5     (0x13UL << CRU_CLKCR0_PCLK0DIV_Pos)  /*!< PCLK0 divided by 10.5 */
#define CRU_CLKCR0_PCLK0DIV_DIV11_5     (0x15UL << CRU_CLKCR0_PCLK0DIV_Pos)  /*!< PCLK0 divided by 11.5 */
#define CRU_CLKCR0_PCLK0DIV_DIV12_5     (0x17UL << CRU_CLKCR0_PCLK0DIV_Pos)  /*!< PCLK0 divided by 12.5 */
#define CRU_CLKCR0_PCLK0DIV_DIV13_5     (0x19UL << CRU_CLKCR0_PCLK0DIV_Pos)  /*!< PCLK0 divided by 13.5 */
#define CRU_CLKCR0_PCLK0DIV_DIV14_5     (0x1BUL << CRU_CLKCR0_PCLK0DIV_Pos)  /*!< PCLK0 divided by 14.5 */
#define CRU_CLKCR0_PCLK0DIV_DIV15_5     (0x1DUL << CRU_CLKCR0_PCLK0DIV_Pos)  /*!< PCLK0 divided by 15.5 */

/** @brief CLKCR0[11]: PCLK0 divider enable */
...
/** @brief CLKCR0[16:12]: PCLK1 divider */
...
#define CRU_CLKCR0_PCLK1DIV_DIV1        (0x0UL << CRU_CLKCR0_PCLK1DIV_Pos)   /*!< PCLK1 not divided */
#define CRU_CLKCR0_PCLK1DIV_DIV2        (0x2UL << CRU_CLKCR0_PCLK1DIV_Pos)   /*!< PCLK1 divided by 2 */
#define CRU_CLKCR0_PCLK1DIV_DIV3        (0x4UL << CRU_CLKCR0_PCLK1DIV_Pos)   /*!< PCLK1 divided by 3 */
#define CRU_CLKCR0_PCLK1DIV_DIV4        (0x6UL << CRU_CLKCR0_PCLK1DIV_Pos)   /*!< PCLK1 divided by 4 */
#define CRU_CLKCR0_PCLK1DIV_DIV5        (0x8UL << CRU_CLKCR0_PCLK1DIV_Pos)   /*!< PCLK1 divided by 5 */
#define CRU_CLKCR0_PCLK1DIV_DIV6        (0xAUL << CRU_CLKCR0_PCLK1DIV_Pos)   /*!< PCLK1 divided by 6 */
#define CRU_CLKCR0_PCLK1DIV_DIV7        (0xCUL << CRU_CLKCR0_PCLK1DIV_Pos)   /*!< PCLK1 divided by 7 */
#define CRU_CLKCR0_PCLK1DIV_DIV8        (0xEUL << CRU_CLKCR0_PCLK1DIV_Pos)   /*!< PCLK1 divided by 8 */
#define CRU_CLKCR0_PCLK1DIV_DIV9        (0x10UL << CRU_CLKCR0_PCLK1DIV_Pos)  /*!< PCLK1 divided by 9 */
#define CRU_CLKCR0_PCLK1DIV_DIV10       (0x12UL << CRU_CLKCR0_PCLK1DIV_Pos)  /*!< PCLK1 divided by 10 */
#define CRU_CLKCR0_PCLK1DIV_DIV11       (0x14UL << CRU_CLKCR0_PCLK1DIV_Pos)  /*!< PCLK1 divided by 11 */
#define CRU_CLKCR0_PCLK1DIV_DIV12       (0x16UL << CRU_CLKCR0_PCLK1DIV_Pos)  /*!< PCLK1 divided by 12 */
#define CRU_CLKCR0_PCLK1DIV_DIV13       (0x18UL << CRU_CLKCR0_PCLK1DIV_Pos)  /*!< PCLK1 divided by 13 */
#define CRU_CLKCR0_PCLK1DIV_DIV14       (0x1AUL << CRU_CLKCR0_PCLK1DIV_Pos)  /*!< PCLK1 divided by 14 */
#define CRU_CLKCR0_PCLK1DIV_DIV15       (0x1CUL << CRU_CLKCR0_PCLK1DIV_Pos)  /*!< PCLK1 divided by 15 */
#define CRU_CLKCR0_PCLK1DIV_DIV16       (0x1EUL << CRU_CLKCR0_PCLK1DIV_Pos)  /*!< PCLK1 divided by 16 */

#define CRU_CLKCR0_PCLK1DIV_DIV1_5      (0x1UL << CRU_CLKCR0_PCLK1DIV_Pos)   /*!< PCLK1 divided by 1.5 */
#define CRU_CLKCR0_PCLK1DIV_DIV2_5      (0x3UL << CRU_CLKCR0_PCLK1DIV_Pos)   /*!< PCLK1 divided by 2.5 */
#define CRU_CLKCR0_PCLK1DIV_DIV3_5      (0x5UL << CRU_CLKCR0_PCLK1DIV_Pos)   /*!< PCLK1 divided by 3.5 */
#define CRU_CLKCR0_PCLK1DIV_DIV4_5      (0x7UL << CRU_CLKCR0_PCLK1DIV_Pos)   /*!< PCLK1 divided by 4.5 */
#define CRU_CLKCR0_PCLK1DIV_DIV5_5      (0x9UL << CRU_CLKCR0_PCLK1DIV_Pos)   /*!< PCLK1 divided by 5.5 */
#define CRU_CLKCR0_PCLK1DIV_DIV6_5      (0xBUL << CRU_CLKCR0_PCLK1DIV_Pos)   /*!< PCLK1 divided by 6.5 */
#define CRU_CLKCR0_PCLK1DIV_DIV7_5      (0xDUL << CRU_CLKCR0_PCLK1DIV_Pos)   /*!< PCLK1 divided by 7.5 */
#define CRU_CLKCR0_PCLK1DIV_DIV8_5      (0xFUL << CRU_CLKCR0_PCLK1DIV_Pos)   /*!< PCLK1 divided by 8.5 */
#define CRU_CLKCR0_PCLK1DIV_DIV9_5      (0x11UL << CRU_CLKCR0_PCLK1DIV_Pos)  /*!< PCLK1 divided by 9.5 */
#define CRU_CLKCR0_PCLK1DIV_DIV10_5     (0x13UL << CRU_CLKCR0_PCLK1DIV_Pos)  /*!< PCLK1 divided by 10.5 */
#define CRU_CLKCR0_PCLK1DIV_DIV11_5     (0x15UL << CRU_CLKCR0_PCLK1DIV_Pos)  /*!< PCLK1 divided by 11.5 */
#define CRU_CLKCR0_PCLK1DIV_DIV12_5     (0x17UL << CRU_CLKCR0_PCLK1DIV_Pos)  /*!< PCLK1 divided by 12.5 */
#define CRU_CLKCR0_PCLK1DIV_DIV13_5     (0x19UL << CRU_CLKCR0_PCLK1DIV_Pos)  /*!< PCLK1 divided by 13.5 */
#define CRU_CLKCR0_PCLK1DIV_DIV14_5     (0x1BUL << CRU_CLKCR0_PCLK1DIV_Pos)  /*!< PCLK1 divided by 14.5 */
#define CRU_CLKCR0_PCLK1DIV_DIV15_5     (0x1DUL << CRU_CLKCR0_PCLK1DIV_Pos)  /*!< PCLK1 divided by 15.5 */

/** @brief CLKCR0[17]: PCLK1 divider enable */
...
/** @brief CLKCR0[22:18]: PCLK2 divider */
...
#define CRU_CLKCR0_PCLK2DIV_DIV1        (0x0UL << CRU_CLKCR0_PCLK2DIV_Pos)   /*!< PCLK2 not divided */
#define CRU_CLKCR0_PCLK2DIV_DIV2        (0x2UL << CRU_CLKCR0_PCLK2DIV_Pos)   /*!< PCLK2 divided by 2 */
#define CRU_CLKCR0_PCLK2DIV_DIV3        (0x4UL << CRU_CLKCR0_PCLK2DIV_Pos)   /*!< PCLK2 divided by 3 */
#define CRU_CLKCR0_PCLK2DIV_DIV4        (0x6UL << CRU_CLKCR0_PCLK2DIV_Pos)   /*!< PCLK2 divided by 4 */
#define CRU_CLKCR0_PCLK2DIV_DIV5        (0x8UL << CRU_CLKCR0_PCLK2DIV_Pos)   /*!< PCLK2 divided by 5 */
#define CRU_CLKCR0_PCLK2DIV_DIV6        (0xAUL << CRU_CLKCR0_PCLK2DIV_Pos)   /*!< PCLK2 divided by 6 */
#define CRU_CLKCR0_PCLK2DIV_DIV7        (0xCUL << CRU_CLKCR0_PCLK2DIV_Pos)   /*!< PCLK2 divided by 7 */
#define CRU_CLKCR0_PCLK2DIV_DIV8        (0xEUL << CRU_CLKCR0_PCLK2DIV_Pos)   /*!< PCLK2 divided by 8 */
#define CRU_CLKCR0_PCLK2DIV_DIV9        (0x10UL << CRU_CLKCR0_PCLK2DIV_Pos)  /*!< PCLK2 divided by 9 */
#define CRU_CLKCR0_PCLK2DIV_DIV10       (0x12UL << CRU_CLKCR0_PCLK2DIV_Pos)  /*!< PCLK2 divided by 10 */
#define CRU_CLKCR0_PCLK2DIV_DIV11       (0x14UL << CRU_CLKCR0_PCLK2DIV_Pos)  /*!< PCLK2 divided by 11 */
#define CRU_CLKCR0_PCLK2DIV_DIV12       (0x16UL << CRU_CLKCR0_PCLK2DIV_Pos)  /*!< PCLK2 divided by 12 */
#define CRU_CLKCR0_PCLK2DIV_DIV13       (0x18UL << CRU_CLKCR0_PCLK2DIV_Pos)  /*!< PCLK2 divided by 13 */
#define CRU_CLKCR0_PCLK2DIV_DIV14       (0x1AUL << CRU_CLKCR0_PCLK2DIV_Pos)  /*!< PCLK2 divided by 14 */
#define CRU_CLKCR0_PCLK2DIV_DIV15       (0x1CUL << CRU_CLKCR0_PCLK2DIV_Pos)  /*!< PCLK2 divided by 15 */
#define CRU_CLKCR0_PCLK2DIV_DIV16       (0x1EUL << CRU_CLKCR0_PCLK2DIV_Pos)  /*!< PCLK2 divided by 16 */

#define CRU_CLKCR0_PCLK2DIV_DIV1_5      (0x1UL << CRU_CLKCR0_PCLK2DIV_Pos)   /*!< PCLK2 divided by 1.5 */
#define CRU_CLKCR0_PCLK2DIV_DIV2_5      (0x3UL << CRU_CLKCR0_PCLK2DIV_Pos)   /*!< PCLK2 divided by 2.5 */
#define CRU_CLKCR0_PCLK2DIV_DIV3_5      (0x5UL << CRU_CLKCR0_PCLK2DIV_Pos)   /*!< PCLK2 divided by 3.5 */
#define CRU_CLKCR0_PCLK2DIV_DIV4_5      (0x7UL << CRU_CLKCR0_PCLK2DIV_Pos)   /*!< PCLK2 divided by 4.5 */
#define CRU_CLKCR0_PCLK2DIV_DIV5_5      (0x9UL << CRU_CLKCR0_PCLK2DIV_Pos)   /*!< PCLK2 divided by 5.5 */
#define CRU_CLKCR0_PCLK2DIV_DIV6_5      (0xBUL << CRU_CLKCR0_PCLK2DIV_Pos)   /*!< PCLK2 divided by 6.5 */
#define CRU_CLKCR0_PCLK2DIV_DIV7_5      (0xDUL << CRU_CLKCR0_PCLK2DIV_Pos)   /*!< PCLK2 divided by 7.5 */
#define CRU_CLKCR0_PCLK2DIV_DIV8_5      (0xFUL << CRU_CLKCR0_PCLK2DIV_Pos)   /*!< PCLK2 divided by 8.5 */
#define CRU_CLKCR0_PCLK2DIV_DIV9_5      (0x11UL << CRU_CLKCR0_PCLK2DIV_Pos)  /*!< PCLK2 divided by 9.5 */
#define CRU_CLKCR0_PCLK2DIV_DIV10_5     (0x13UL << CRU_CLKCR0_PCLK2DIV_Pos)  /*!< PCLK2 divided by 10.5 */
#define CRU_CLKCR0_PCLK2DIV_DIV11_5     (0x15UL << CRU_CLKCR0_PCLK2DIV_Pos)  /*!< PCLK2 divided by 11.5 */
#define CRU_CLKCR0_PCLK2DIV_DIV12_5     (0x17UL << CRU_CLKCR0_PCLK2DIV_Pos)  /*!< PCLK2 divided by 12.5 */
#define CRU_CLKCR0_PCLK2DIV_DIV13_5     (0x19UL << CRU_CLKCR0_PCLK2DIV_Pos)  /*!< PCLK2 divided by 13.5 */
#define CRU_CLKCR0_PCLK2DIV_DIV14_5     (0x1BUL << CRU_CLKCR0_PCLK2DIV_Pos)  /*!< PCLK2 divided by 14.5 */
#define CRU_CLKCR0_PCLK2DIV_DIV15_5     (0x1DUL << CRU_CLKCR0_PCLK2DIV_Pos)  /*!< PCLK2 divided by 15.5 */

/** @brief CLKCR0[23]: PCLK2 divider enable */
...
/** @brief CLKCR0[28:24]: HCLK divider */
...
#define CRU_CLKCR0_HCLKDIV_DIV1         (0x0UL << CRU_CLKCR0_HCLKDIV_Pos)   /*!< HCLK not divided */
#define CRU_CLKCR0_HCLKDIV_DIV2         (0x2UL << CRU_CLKCR0_HCLKDIV_Pos)   /*!< HCLK divided by 2 */
#define CRU_CLKCR0_HCLKDIV_DIV3         (0x4UL << CRU_CLKCR0_HCLKDIV_Pos)   /*!< HCLK divided by 3 */
#define CRU_CLKCR0_HCLKDIV_DIV4         (0x6UL << CRU_CLKCR0_HCLKDIV_Pos)   /*!< HCLK divided by 4 */
#define CRU_CLKCR0_HCLKDIV_DIV5         (0x8UL << CRU_CLKCR0_HCLKDIV_Pos)   /*!< HCLK divided by 5 */
#define CRU_CLKCR0_HCLKDIV_DIV6         (0xAUL << CRU_CLKCR0_HCLKDIV_Pos)   /*!< HCLK divided by 6 */
#define CRU_CLKCR0_HCLKDIV_DIV7         (0xCUL << CRU_CLKCR0_HCLKDIV_Pos)   /*!< HCLK divided by 7 */
#define CRU_CLKCR0_HCLKDIV_DIV8         (0xEUL << CRU_CLKCR0_HCLKDIV_Pos)   /*!< HCLK divided by 8 */
#define CRU_CLKCR0_HCLKDIV_DIV9         (0x10UL << CRU_CLKCR0_HCLKDIV_Pos)  /*!< HCLK divided by 9 */
#define CRU_CLKCR0_HCLKDIV_DIV10        (0x12UL << CRU_CLKCR0_HCLKDIV_Pos)  /*!< HCLK divided by 10 */
#define CRU_CLKCR0_HCLKDIV_DIV11        (0x14UL << CRU_CLKCR0_HCLKDIV_Pos)  /*!< HCLK divided by 11 */
#define CRU_CLKCR0_HCLKDIV_DIV12        (0x16UL << CRU_CLKCR0_HCLKDIV_Pos)  /*!< HCLK divided by 12 */
#define CRU_CLKCR0_HCLKDIV_DIV13        (0x18UL << CRU_CLKCR0_HCLKDIV_Pos)  /*!< HCLK divided by 13 */
#define CRU_CLKCR0_HCLKDIV_DIV14        (0x1AUL << CRU_CLKCR0_HCLKDIV_Pos)  /*!< HCLK divided by 14 */
#define CRU_CLKCR0_HCLKDIV_DIV15        (0x1CUL << CRU_CLKCR0_HCLKDIV_Pos)  /*!< HCLK divided by 15 */
#define CRU_CLKCR0_HCLKDIV_DIV16        (0x1EUL << CRU_CLKCR0_HCLKDIV_Pos)  /*!< HCLK divided by 16 */

#define CRU_CLKCR0_HCLKDIV_DIV1_5       (0x1UL << CRU_CLKCR0_HCLKDIV_Pos)   /*!< HCLK divided by 1.5 */
#define CRU_CLKCR0_HCLKDIV_DIV2_5       (0x3UL << CRU_CLKCR0_HCLKDIV_Pos)   /*!< HCLK divided by 2.5 */
#define CRU_CLKCR0_HCLKDIV_DIV3_5       (0x5UL << CRU_CLKCR0_HCLKDIV_Pos)   /*!< HCLK divided by 3.5 */
#define CRU_CLKCR0_HCLKDIV_DIV4_5       (0x7UL << CRU_CLKCR0_HCLKDIV_Pos)   /*!< HCLK divided by 4.5 */
#define CRU_CLKCR0_HCLKDIV_DIV5_5       (0x9UL << CRU_CLKCR0_HCLKDIV_Pos)   /*!< HCLK divided by 5.5 */
#define CRU_CLKCR0_HCLKDIV_DIV6_5       (0xBUL << CRU_CLKCR0_HCLKDIV_Pos)   /*!< HCLK divided by 6.5 */
#define CRU_CLKCR0_HCLKDIV_DIV7_5       (0xDUL << CRU_CLKCR0_HCLKDIV_Pos)   /*!< HCLK divided by 7.5 */
#define CRU_CLKCR0_HCLKDIV_DIV8_5       (0xFUL << CRU_CLKCR0_HCLKDIV_Pos)   /*!< HCLK divided by 8.5 */
#define CRU_CLKCR0_HCLKDIV_DIV9_5       (0x11UL << CRU_CLKCR0_HCLKDIV_Pos)  /*!< HCLK divided by 9.5 */
#define CRU_CLKCR0_HCLKDIV_DIV10_5      (0x13UL << CRU_CLKCR0_HCLKDIV_Pos)  /*!< HCLK divided by 10.5 */
#define CRU_CLKCR0_HCLKDIV_DIV11_5      (0x15UL << CRU_CLKCR0_HCLKDIV_Pos)  /*!< HCLK divided by 11.5 */
#define CRU_CLKCR0_HCLKDIV_DIV12_5      (0x17UL << CRU_CLKCR0_HCLKDIV_Pos)  /*!< HCLK divided by 12.5 */
#define CRU_CLKCR0_HCLKDIV_DIV13_5      (0x19UL << CRU_CLKCR0_HCLKDIV_Pos)  /*!< HCLK divided by 13.5 */
#define CRU_CLKCR0_HCLKDIV_DIV14_5      (0x1BUL << CRU_CLKCR0_HCLKDIV_Pos)  /*!< HCLK divided by 14.5 */
#define CRU_CLKCR0_HCLKDIV_DIV15_5      (0x1DUL << CRU_CLKCR0_HCLKDIV_Pos)  /*!< HCLK divided by 15.5 */

/** @brief CLKCR0[29]: HCLK divider enable */
...
/** @brief CLKCR0[30]: RC generator enable */
...
/** @brief CLKCR0[31]: Boot clock source select */
...
/*****************  Bit definition for CRU_SYSCR0 register  *****************/

/** @brief SYSCR0[0]: Core 1 clock enable */
...
/** @brief SYSCR0[2]: Core 1 TCM arbitrator reset */
...
/** @brief SYSCR0[3]: Core 1 processor complex reset */
...
/** @brief SYSCR0[5]: Core 2 TCM arbitrator reset */
...
/** @brief SYSCR0[6]: Core 2 processor complex reset */
...
/** @brief SYSCR0[7]: QSPI0 XIP mode enable */
...
/** @brief SYSCR0[8]: QSPI1 XIP mode enable */
...
/** @brief SYSCR0[9]: Select core to trace */
...
#define CRU_SYSCR0_TRACESEL_CORE0         (0x0UL << CRU_SYSCR0_TRACESEL_Pos)    /*!< Connect Core 0 to trace module */
#define CRU_SYSCR0_TRACESEL_CORE1         (0x1UL << CRU_SYSCR0_TRACESEL_Pos)    /*!< Connect Core 1 to trace module */

/** @brief SYSCR0[10]: EFLASH NVR access enable */
#define CRU_SYSCR0_NVR_Pos                (10U)
#define CRU_SYSCR0_NVR_Msk                (0x1UL << CRU_SYSCR0_NVR_Pos)
#define CRU_SYSCR0_NVR                    CRU_SYSCR0_NVR_Msk

/** @brief SYSCR0[11]: CLKI monitor enable */
...
/** @brief SYSCR0[15:12]: CLKI monitor threshold */
...
#define CRU_SYSCR0_CLKI_ALARM_LVL_0       (0x0UL << CRU_SYSCR0_CLKI_ALARM_LVL_Pos)  /*!< CLKI monitor threshold level 0 */
#define CRU_SYSCR0_CLKI_ALARM_LVL_1       (0x1UL << CRU_SYSCR0_CLKI_ALARM_LVL_Pos)  /*!< CLKI monitor threshold level 1 */
#define CRU_SYSCR0_CLKI_ALARM_LVL_2       (0x2UL << CRU_SYSCR0_CLKI_ALARM_LVL_Pos)  /*!< CLKI monitor threshold level 2 */
#define CRU_SYSCR0_CLKI_ALARM_LVL_3       (0x3UL << CRU_SYSCR0_CLKI_ALARM_LVL_Pos)  /*!< CLKI monitor threshold level 3 */
#define CRU_SYSCR0_CLKI_ALARM_LVL_4       (0x4UL << CRU_SYSCR0_CLKI_ALARM_LVL_Pos)  /*!< CLKI monitor threshold level 4 */
#define CRU_SYSCR0_CLKI_ALARM_LVL_5       (0x5UL << CRU_SYSCR0_CLKI_ALARM_LVL_Pos)  /*!< CLKI monitor threshold level 5 */
#define CRU_SYSCR0_CLKI_ALARM_LVL_6       (0x6UL << CRU_SYSCR0_CLKI_ALARM_LVL_Pos)  /*!< CLKI monitor threshold level 6 */
#define CRU_SYSCR0_CLKI_ALARM_LVL_7       (0x7UL << CRU_SYSCR0_CLKI_ALARM_LVL_Pos)  /*!< CLKI monitor threshold level 7 */
#define CRU_SYSCR0_CLKI_ALARM_LVL_8       (0x8UL << CRU_SYSCR0_CLKI_ALARM_LVL_Pos)  /*!< CLKI monitor threshold level 8 */
#define CRU_SYSCR0_CLKI_ALARM_LVL_9       (0x9UL << CRU_SYSCR0_CLKI_ALARM_LVL_Pos)  /*!< CLKI monitor threshold level 9 */
#define CRU_SYSCR0_CLKI_ALARM_LVL_10      (0xAUL << CRU_SYSCR0_CLKI_ALARM_LVL_Pos)  /*!< CLKI monitor threshold level 10 */
#define CRU_SYSCR0_CLKI_ALARM_LVL_11      (0xBUL << CRU_SYSCR0_CLKI_ALARM_LVL_Pos)  /*!< CLKI monitor threshold level 11 */
#define CRU_SYSCR0_CLKI_ALARM_LVL_12      (0xCUL << CRU_SYSCR0_CLKI_ALARM_LVL_Pos)  /*!< CLKI monitor threshold level 12 */
#define CRU_SYSCR0_CLKI_ALARM_LVL_13      (0xDUL << CRU_SYSCR0_CLKI_ALARM_LVL_Pos)  /*!< CLKI monitor threshold level 13 */
#define CRU_SYSCR0_CLKI_ALARM_LVL_14      (0xEUL << CRU_SYSCR0_CLKI_ALARM_LVL_Pos)  /*!< CLKI monitor threshold level 14 */
#define CRU_SYSCR0_CLKI_ALARM_LVL_15      (0xFUL << CRU_SYSCR0_CLKI_ALARM_LVL_Pos)  /*!< CLKI monitor threshold level 15 */

/** @brief SYSCR0[16]: Clear WDTHIT flag */
...
/** @brief SYSCR0[20:18]: Single-port memory parameter value */
...
/** @brief SYSCR0[24:21]: Dual-port memory parameter value */
...
/** @brief SYSCR0[25]: Memory parameters adjustment enable */
...
/** @brief SYSCR0[26]: Disable EFLASH NVR access */
...
/** @brief SYSCR0[27]: Disable EFLASH access in manual mode */
...
/** @brief SYSCR0[28]: MAGMA0 command decryptor enable */
...
/** @brief SYSCR0[29]: MAGMA1 command decryptor enable */
...
/** @brief SYSCR0[30]: Enable CORE0 and CORE1 software debug */
...
/** @brief SYSCR0[31]: Disable write to EFLASH in DMA mode */
...
/*****************  Bit definition for CRU_SYSCR1 register  *****************/

/** @brief SYSCR1[31:0]: Core 1 reset vector address */
...
/*****************  Bit definition for CRU_SYSCR2 register  *****************/

/** @brief SYSCR2[31:0]: Core 2 reset vector address */
...
/** @brief PRIOR0[2:0]: MP Core0 AXI Interconnect priority level */
...
/** @brief PRIOR0[6:4]: DIO Core0 AXI Interconnect priority level */
...
/** @brief PRIOR0[10:8]: MP Core1 AXI Interconnect priority level */
...
/** @brief PRIOR0[14:12]: DIO Core1 AXI Interconnect priority level */
...
/** @brief PRIOR0[18:16]: DMA0 AXI Interconnect priority level */
...
/** @brief PRIOR0[22:20]: DMA1 AXI Interconnect priority level */
...
/** @brief PRIOR0[26:24]: USB DMA AXI Interconnect priority level */
...
/** @brief PRIOR1[2:0]: APB0 AXI Interconnect priority level */
...
/** @brief PRIOR1[6:4]: APB1 AXI Interconnect priority level */
...
/** @brief PRIOR1[10:8]: APB2 AXI Interconnect priority level */
...
/** @brief PRIOR1[14:12]: AHB AXI Interconnect priority level */
...
/** @brief PRIOR1[18:16]: FP Core0 AXI Interconnect priority level */
...
/** @brief PRIOR1[22:20]: SRAM AXI Interconnect priority level */
...
/** @brief PRIOR1[26:24]: EFLASH AXI Interconnect priority level */
...
/*****************  Bit definition for CRU_IOPUCR0 register  *****************/

/** @brief IOPUCR0[15:0]: PA[15:0] pull-up enable */
...
/** @brief IOPUCR0[31:16]: PB[15:0] pull-up enable */
...
/*****************  Bit definition for CRU_IOPUCR1 register  *****************/

/** @brief IOPUCR1[15:0]: PC[15:0] pull-up enable */
...
/*****************  Bit definition for CRU_IOPDCR0 register  *****************/

/** @brief IOPDCR0[15:0]: PA[15:0] pull-down enable */
...
/** @brief IOPDCR0[31:16]: PB[15:0] pull-down enable */
...
/*****************  Bit definition for CRU_IOPDCR1 register  *****************/

/** @brief IOPDCR1[15:0]: PC[15:0] pull-down enable */
...
/******************  Bit definition for CRU_IOAFCR0 register  *****************/

/** @brief IOAFCR0[2:0]: PA[0] pin alternate function */
...
/** @brief IOAFCR0[3]: PA[0] pin input enable */
...
/** @brief IOAFCR0[6:4]: PA[1] pin alternate function */
...
/** @brief IOAFCR0[7]: PA[1] pin input enable */
...
/** @brief IOAFCR0[10:8]: PA[2] pin alternate function */
...
/** @brief IOAFCR0[11]: PA[2] pin input enable */
...
/** @brief IOAFCR0[14:12]: PA[3] pin alternate function */
...
/** @brief IOAFCR0[15]: PA[3] pin input enable */
...
/** @brief IOAFCR0[18:16]: PA[4] pin alternate function */
...
/** @brief IOAFCR0[19]: PA[4] pin input enable */
...
/** @brief IOAFCR0[22:20]: PA[5] pin alternate function */
...
/** @brief IOAFCR0[23]: PA[5] pin input enable */
...
/** @brief IOAFCR0[26:24]: PA[6] pin alternate function */
...
/** @brief IOAFCR0[27]: PA[6] pin input enable */
...
/** @brief IOAFCR0[30:28]: PA[7] pin alternate function */
...
/** @brief IOAFCR0[31]: PA[7] pin input enable */
...
/******************  Bit definition for CRU_IOAFCR1 register  *****************/

/** @brief IOAFCR1[2:0]: PA[8] pin alternate function */
...
/** @brief IOAFCR1[3]: PA[8] pin input enable */
...
/** @brief IOAFCR1[6:4]: PA[9] pin alternate function */
...
/** @brief IOAFCR1[7]: PA[9] pin input enable */
...
/** @brief IOAFCR1[10:8]: PA[10] pin alternate function */
...
/** @brief IOAFCR1[11]: PA[10] pin input enable */
...
/** @brief IOAFCR1[14:12]: PA[11] pin alternate function */
...
/** @brief IOAFCR1[15]: PA[11] pin input enable */
...
/** @brief IOAFCR1[18:16]: PA[12] pin alternate function */
...
/** @brief IOAFCR1[19]: PA[12] pin input enable */
...
/** @brief IOAFCR1[22:20]: PA[13] pin alternate function */
...
/** @brief IOAFCR1[23]: PA[13] pin input enable */
...
/** @brief IOAFCR1[26:24]: PA[14] pin alternate function */
...
/** @brief IOAFCR1[27]: PA[14] pin input enable */
...
/** @brief IOAFCR1[30:28]: PA[15] pin alternate function */
...
/** @brief IOAFCR1[31]: PA[15] pin input enable */
...
/******************  Bit definition for CRU_IOAFCR2 register  *****************/

/** @brief IOAFCR2[2:0]: PB[0] pin alternate function */
...
/** @brief IOAFCR2[3]: PB[0] pin input enable */
...
/** @brief IOAFCR2[6:4]: PB[1] pin alternate function */
...
/** @brief IOAFCR2[7]: PB[1] pin input enable */
...
/** @brief IOAFCR2[10:8]: PB[2] pin alternate function */
...
/** @brief IOAFCR2[11]: PB[2] pin input enable */
...
/** @brief IOAFCR2[14:12]: PB[3] pin alternate function */
...
/** @brief IOAFCR2[15]: PB[3] pin input enable */
...
/** @brief IOAFCR2[18:16]: PB[4] pin alternate function */
...
/** @brief IOAFCR2[19]: PB[4] pin input enable */
...
/** @brief IOAFCR2[22:20]: PB[5] pin alternate function */
...
/** @brief IOAFCR2[23]: PB[5] pin input enable */
...
/** @brief IOAFCR2[26:24]: PB[6] pin alternate function */
...
/** @brief IOAFCR2[27]: PB[6] pin input enable */
...
/** @brief IOAFCR2[30:28]: PB[7] pin alternate function */
...
/** @brief IOAFCR2[31]: PB[7] pin input enable */
...
/******************  Bit definition for CRU_IOAFCR3 register  *****************/

/** @brief IOAFCR3[2:0]: PB[8] pin alternate function */
...
/** @brief IOAFCR3[3]: PB[8] pin input enable */
...
/** @brief IOAFCR3[6:4]: PB[9] pin alternate function */
...
/** @brief IOAFCR3[7]: PB[9] pin input enable */
...
/** @brief IOAFCR3[10:8]: PB[10] pin alternate function */
...
/** @brief IOAFCR3[11]: PB[10] pin input enable */
...
/** @brief IOAFCR3[14:12]: PB[11] pin alternate function */
...
/** @brief IOAFCR3[15]: PB[11] pin input enable */
...
/** @brief IOAFCR3[18:16]: PB[12] pin alternate function */
...
/** @brief IOAFCR3[19]: PB[12] pin input enable */
...
/** @brief IOAFCR3[22:20]: PB[13] pin alternate function */
...
/** @brief IOAFCR3[23]: PB[13] pin input enable */
...
/** @brief IOAFCR3[26:24]: PB[14] pin alternate function */
...
/** @brief IOAFCR3[27]: PB[14] pin input enable */
...
/** @brief IOAFCR3[30:28]: PB[15] pin alternate function */
...
/** @brief IOAFCR3[31]: PB[15] pin input enable */
...
/******************  Bit definition for CRU_IOAFCR4 register  *****************/

/** @brief IOAFCR4[2:0]: PC[0] pin alternate function */
...
/** @brief IOAFCR4[3]: PC[0] pin input enable */
...
/** @brief IOAFCR4[6:4]: PC[1] pin alternate function */
...
/** @brief IOAFCR4[7]: PC[1] pin input enable */
...
/** @brief IOAFCR4[10:8]: PC[2] pin alternate function */
...
/** @brief IOAFCR4[11]: PC[2] pin input enable */
...
/** @brief IOAFCR4[14:12]: PC[3] pin alternate function */
...
/** @brief IOAFCR4[15]: PC[3] pin input enable */
...
/** @brief IOAFCR4[18:16]: PC[4] pin alternate function */
...
/*!< IOAFCR4[19]: PC[4] pin input enable */
...
/** @brief IOAFCR4[22:20]: PC[5] pin alternate function */
...
/** @brief IOAFCR4[23]: PC[5] pin input enable */
...
/** @brief IOAFCR4[26:24]: PC[6] pin alternate function */
...
/** @brief IOAFCR4[27]: PC[6] pin input enable */
...
/** @brief IOAFCR4[30:28]: PC[7] pin alternate function */
...
/** @brief IOAFCR4[31]: PC[7] pin input enable */
...
/******************  Bit definition for CRU_IOAFCR5 register  *****************/

/** @brief IOAFCR5[2:0]: PC[8] pin alternate function */
...
/** @brief IOAFCR5[3]: PC[8] pin input enable */
...
/** @brief IOAFCR5[6:4]: PC[9] pin alternate function */
...
/** @brief IOAFCR5[7]: PC[9] pin input enable */
...
/** @brief IOAFCR5[10:8]: PC[10] pin alternate function */
...
/** @brief IOAFCR5[11]: PC[10] pin input enable */
...
/** @brief IOAFCR5[14:12]: PC[11] pin alternate function */
...
/** @brief IOAFCR5[15]: PC[11] pin input enable */
...
/** @brief IOAFCR5[18:16]: PC[12] pin alternate function */
...
/** @brief IOAFCR5[19]: PC[12] pin input enable */
...
/** @brief IOAFCR5[22:20]: PC[13] pin alternate function */
...
/** @brief IOAFCR5[23]: PC[13] pin input enable */
...
/** @brief IOAFCR5[26:24]: PC[14] pin alternate function */
...
/** @brief IOAFCR5[27]: PC[14] pin input enable */
...
/** @brief IOAFCR5[30:28]: PC[15] pin alternate function */
...
/** @brief IOAFCR5[31]: PC[15] pin input enable */
...
/******************  Bit definition for CRU_IODSCR0 register  ******************/

/** @brief IODSCR0[1:0]: PA[0] output drive mode */
...
/** @brief IODSCR0[3:2]: PA[1] output drive mode */
...
/** @brief IODSCR0[5:4]: PA[2] output drive mode */
...
/** @brief IODSCR0[7:6]: PA[3] output drive mode */
...
/** @brief IODSCR0[9:8]: PA[4] output drive mode */
...
/** @brief IODSCR0[11:10]: PA[5] output drive mode */
...
/** @brief IODSCR0[13:12]: PA[6] output drive mode */
...
/** @brief IODSCR0[15:14]: PA[7] output drive mode */
...
/** @brief IODSCR0[17:16]: PA[8] output drive mode */
...
/** @brief IODSCR0[19:18]: PA[9] output drive mode */
...
/** @brief IODSCR0[21:20]: PA[10] output drive mode */
...
/** @brief IODSCR0[23:22]: PA[11] output drive mode */
...
/** @brief IODSCR0[25:24]: PA[12] output drive mode */
...
/** @brief IODSCR0[27:26]: PA[13] output drive mode */
...
/** @brief IODSCR0[29:28]: PA[14] output drive mode */
...
/** @brief IODSCR0[31:30]: PA[15] output drive mode */
...
/******************  Bit definition for CRU_IODSCR1 register  ******************/

/** @brief IODSCR1[1:0]: PB[0] output drive mode */
...
/** @brief IODSCR1[3:2]: PB[1] output drive mode */
...
/** @brief IODSCR1[5:4]: PB[2] output drive mode */
...
/** @brief IODSCR1[7:6]: PB[3] output drive mode */
...
/** @brief IODSCR1[9:8]: PB[4] output drive mode */
...
/** @brief IODSCR1[11:10]: PB[5] output drive mode */
...
/** @brief IODSCR1[13:12]: PB[6] output drive mode */
...
/** @brief IODSCR1[15:14]: PB[7] output drive mode */
...
/** @brief IODSCR1[17:16]: PB[8] output drive mode */
...
/** @brief IODSCR1[19:18]: PB[9] output drive mode*/
...
/** @brief IODSCR1[21:20]: PB[10] output drive mode */
...
/** @brief IODSCR1[23:22]: PB[11] output drive mode */
...
/** @brief IODSCR1[25:24]: PB[12] output drive mode */
...
/** @brief IODSCR1[27:26]: PB[13] output drive mode */
...
/** @brief IODSCR1[29:28]: PB[14] output drive mode */
...
/** @brief IODSCR1[31:30]: PB[15] output drive mode */
...
/******************  Bit definition for CRU_IODSCR2 register  ******************/

/** @brief IODSCR2[1:0]: PC[0] output drive mode */
...
/** @brief IODSCR2[3:2]: PC[1] output drive mode */
...
/** @brief IODSCR2[5:4]: PC[2] output drive mode */
...
/** @brief IODSCR2[7:6]: PC[3] output drive mode */
...
/** @brief IODSCR2[9:8]: PC[4] output drive mode */
...
/** @brief IODSCR2[11:10]: PC[5] output drive mode */
...
/** @brief IODSCR2[13:12]: PC[6] output drive mode */
...
/** @brief IODSCR2[15:14]: PC[7] output drive mode */
...
/** @brief IODSCR2[17:16]: PC[8] output drive mode */
...
/** @brief IODSCR2[19:18]: PC[9] output drive mode */
...
/** @brief IODSCR2[21:20]: PC[10] output drive mode */
...
/** @brief IODSCR2[23:22]: PC[11] output drive mode */
...
/** @brief IODSCR2[25:24]: PC[12] output drive mode */
...
/** @brief IODSCR2[27:26]: PC[13] output drive mode */
...
/** @brief IODSCR2[29:28]: PC[14] output drive mode */
...
/** @brief IODSCR2[31:30]: PC[15] output drive mode */
...
/******************  Bit definition for CRU_LDOCR register  *****************/

/** @brief LDOCR[2:0]: LDO CORE output voltage */
...
#define CRU_LDOCR_LDOC_ADJ_LEV0           (0x0UL << CRU_LDOCR_LDOC_ADJ_Pos) /*!< LDO CORE output voltage 1.10V */
#define CRU_LDOCR_LDOC_ADJ_LEV1           (0x1UL << CRU_LDOCR_LDOC_ADJ_Pos) /*!< LDO CORE output voltage 1.15V */
#define CRU_LDOCR_LDOC_ADJ_LEV2           (0x2UL << CRU_LDOCR_LDOC_ADJ_Pos) /*!< LDO CORE output voltage 1.00V */
#define CRU_LDOCR_LDOC_ADJ_LEV3           (0x3UL << CRU_LDOCR_LDOC_ADJ_Pos) /*!< LDO CORE output voltage 1.05V */
#define CRU_LDOCR_LDOC_ADJ_LEV4           (0x4UL << CRU_LDOCR_LDOC_ADJ_Pos) /*!< LDO CORE output voltage 1.30V */
#define CRU_LDOCR_LDOC_ADJ_LEV5           (0x5UL << CRU_LDOCR_LDOC_ADJ_Pos) /*!< LDO CORE output voltage 1.35V */
#define CRU_LDOCR_LDOC_ADJ_LEV6           (0x6UL << CRU_LDOCR_LDOC_ADJ_Pos) /*!< LDO CORE output voltage 1.20V */
#define CRU_LDOCR_LDOC_ADJ_LEV7           (0x7UL << CRU_LDOCR_LDOC_ADJ_Pos) /*!< LDO CORE output voltage 1.25V */

/** @brief LDOCR[5:3]: LDO CORE protection current control */
...
#define CRU_LDOCR_LDOC_LDO_PI_LEV0        (0x0UL << CRU_LDOCR_LDOC_LDO_PI_Pos)  /*!< LDO CORE protection current 500mA */
#define CRU_LDOCR_LDOC_LDO_PI_LEV1        (0x1UL << CRU_LDOCR_LDOC_LDO_PI_Pos)  /*!< LDO CORE protection current 460mA */
#define CRU_LDOCR_LDOC_LDO_PI_LEV2        (0x2UL << CRU_LDOCR_LDOC_LDO_PI_Pos)  /*!< LDO CORE protection current 420mA */
#define CRU_LDOCR_LDOC_LDO_PI_LEV3        (0x3UL << CRU_LDOCR_LDOC_LDO_PI_Pos)  /*!< LDO CORE protection current 380mA */
#define CRU_LDOCR_LDOC_LDO_PI_LEV4        (0x4UL << CRU_LDOCR_LDOC_LDO_PI_Pos)  /*!< LDO CORE protection current 660mA */
#define CRU_LDOCR_LDOC_LDO_PI_LEV5        (0x5UL << CRU_LDOCR_LDOC_LDO_PI_Pos)  /*!< LDO CORE protection current 620mA */
#define CRU_LDOCR_LDOC_LDO_PI_LEV6        (0x6UL << CRU_LDOCR_LDOC_LDO_PI_Pos)  /*!< LDO CORE protection current 580mA */

/** @brief LDOCR[10:8]: LDO EFLASH output voltage */
...
#define CRU_LDOCR_LDOF_ADJ_LEV0           (0x0UL << CRU_LDOCR_LDOF_ADJ_Pos) /*!< LDO EFLASH output voltage 1.70V */
#define CRU_LDOCR_LDOF_ADJ_LEV1           (0x1UL << CRU_LDOCR_LDOF_ADJ_Pos) /*!< LDO EFLASH output voltage 1.75V */
#define CRU_LDOCR_LDOF_ADJ_LEV2           (0x2UL << CRU_LDOCR_LDOF_ADJ_Pos) /*!< LDO EFLASH output voltage 1.60V */
#define CRU_LDOCR_LDOF_ADJ_LEV3           (0x3UL << CRU_LDOCR_LDOF_ADJ_Pos) /*!< LDO EFLASH output voltage 1.65V */
#define CRU_LDOCR_LDOF_ADJ_LEV4           (0x4UL << CRU_LDOCR_LDOF_ADJ_Pos) /*!< LDO EFLASH output voltage 1.90V */
#define CRU_LDOCR_LDOF_ADJ_LEV5           (0x5UL << CRU_LDOCR_LDOF_ADJ_Pos) /*!< LDO EFLASH output voltage 1.95V */
#define CRU_LDOCR_LDOF_ADJ_LEV6           (0x6UL << CRU_LDOCR_LDOF_ADJ_Pos) /*!< LDO EFLASH output voltage 0.80V */
#define CRU_LDOCR_LDOF_ADJ_LEV7           (0x7UL << CRU_LDOCR_LDOF_ADJ_Pos) /*!< LDO EFLASH output voltage 0.85V */

/** @brief LDOCR[13:11]: LDO EFLASH protection current control */
...
#define CRU_LDOCR_LDOF_LDO_PI_LEV0        (0x0UL << CRU_LDOCR_LDOF_LDO_PI_Pos)  /*!< LDO EFLASH protection current 290mA */
#define CRU_LDOCR_LDOF_LDO_PI_LEV1        (0x1UL << CRU_LDOCR_LDOF_LDO_PI_Pos)  /*!< LDO EFLASH protection current 260mA */
#define CRU_LDOCR_LDOF_LDO_PI_LEV2        (0x2UL << CRU_LDOCR_LDOF_LDO_PI_Pos)  /*!< LDO EFLASH protection current 225mA */
#define CRU_LDOCR_LDOF_LDO_PI_LEV3        (0x3UL << CRU_LDOCR_LDOF_LDO_PI_Pos)  /*!< LDO EFLASH protection current 195mA */
#define CRU_LDOCR_LDOF_LDO_PI_LEV4        (0x4UL << CRU_LDOCR_LDOF_LDO_PI_Pos)  /*!< LDO EFLASH protection current 410mA */
#define CRU_LDOCR_LDOF_LDO_PI_LEV5        (0x5UL << CRU_LDOCR_LDOF_LDO_PI_Pos)  /*!< LDO EFLASH protection current 380mA */
#define CRU_LDOCR_LDOF_LDO_PI_LEV6        (0x6UL << CRU_LDOCR_LDOF_LDO_PI_Pos)  /*!< LDO EFLASH protection current 350mA */
#define CRU_LDOCR_LDOF_LDO_PI_LEV7        (0x7UL << CRU_LDOCR_LDOF_LDO_PI_Pos)  /*!< LDO EFLASH protection current 320mA */

/** @brief LDOCR[14]: LDO EFLASH Power Down mode */
...
/******************  Bit definition for CRU_USBCR register  ******************/

/** @brief USBCR[1]: USB PHY reset */
...
/** @brief USBCR[2]: USB PHY PLL enable */
...
/** @brief USBCR[3]: USB PHY Built-In Self Test (BIST) enable */
...
/** @brief USBCR[4]: USB PHY REFCLK_MODE control */
...
#define CRU_USBCR_REFCLK_MODE_25MHZ        (0x0UL << CRU_USBCR_REFCLK_MODE_Pos)   /*!< 25MHz */
#define CRU_USBCR_REFCLK_MODE_12MHZ        (0x1UL << CRU_USBCR_REFCLK_MODE_Pos)   /*!< 12MHz */

/** @brief USBCR[5]: USB PHY OTG_SUSPENDM control */
...
/** @brief USBCR[6]: USB PHY FSLS_SERIALMODE control */
...
/** @brief USBCR[7]: USB PHY TX_ENABLE_N control */
...
/** @brief USBCR[8]: USB PHY TX_DAT control */
...
/** @brief USBCR[9]: USB PHY TX_SE0 control */
...
/** @brief USBCR[13]: IDPULLUP polarity */
...
#define CRU_USBCR_IDPULLUPPOL_NONINVERTED  (0x0UL << CRU_USBCR_IDPULLUPPOL_Pos)   /*!< Same as IDPULLUP output */
#define CRU_USBCR_IDPULLUPPOL_INVERTED     (0x1UL << CRU_USBCR_IDPULLUPPOL_Pos)   /*!< Inverted */

/** @brief USBCR[14]: IDPULLUP source */
...
#define CRU_USBCR_IDPULLUPSRC_IDPULLUP     (0x0UL << CRU_USBCR_IDPULLUPSRC_Pos)   /*!< IDPULLUP output */
#define CRU_USBCR_IDPULLUPSRC_IDPULLUPGPR  (0x1UL << CRU_USBCR_IDPULLUPSRC_Pos)   /*!< IDPULLUPGPR bit of USBCR register */

/** @brief USBCR[15]: IDPULLUP control */
...
/** @brief USBCR[16]: USB PHY Built-In Self Test (BIST) result */
...
#define CRU_USBCR_BIST_STAT_ERROR          (0x0UL << CRU_USBCR_BIST_STAT_Pos)     /*!< Error */
#define CRU_USBCR_BIST_STAT_SUCCESS        (0x1UL << CRU_USBCR_BIST_STAT_Pos)     /*!< Success */

/** @brief USBCR[24]: IO value when DRVVBUS alternate function is selected */
...
/** @brief USBCR[25]: IO polarity when DRVVBUS alternate function is selected */
...
#define CRU_USBCR_DRVVBUSPOL_NONINVERTED   (0x0UL << CRU_USBCR_DRVVBUSPOL_Pos)    /*!< Same as DRVVBUS output */
#define CRU_USBCR_DRVVBUSPOL_INVERTED      (0x1UL << CRU_USBCR_DRVVBUSPOL_Pos)    /*!< Inverted */

/** @brief USBCR[26]: IO source when DRVVBUS alternate function is selected */
...
#define CRU_USBCR_DRVVBUSSRC_DRVVBUS       (0x0UL << CRU_USBCR_DRVVBUSSRC_Pos)    /*!< DRVVBUS output */
#define CRU_USBCR_DRVVBUSSRC_DRVVBUSGPR    (0x1UL << CRU_USBCR_DRVVBUSSRC_Pos)    /*!< DRVVBUSGPR bit of USBCR register */

/** @brief USBCR[27]: IO control when DRVVBUS alternate function is selected */
...
/** @brief USBCR[28]: HPROT[0] from USB controller AHB master */
...
/** @brief USBCR[29]: HPROT[1] from USB controller AHB master */
...
/** @brief USBCR[30]: HPROT[2] from USB controller AHB master */
...
/** @brief USBCR[31]: HPROT[3] from USB controller AHB master */
...
/*****************  Bit definition for CRU_SYSSR0 register  *****************/

/** @brief SYSSR0[2:0]: Bootstrap inputs state - Mode */
...
#define CRU_SYSSR0_STRAP_MODE_EFLASH      (0x0UL << CRU_SYSSR0_STRAP_MODE_Pos)  /*!< EFLASH boot */
#define CRU_SYSSR0_STRAP_MODE_UART        (0x1UL << CRU_SYSSR0_STRAP_MODE_Pos)  /*!< UART0 boot */
#define CRU_SYSSR0_STRAP_MODE_QSPI        (0x2UL << CRU_SYSSR0_STRAP_MODE_Pos)  /*!< QSPI0 boot */
#define CRU_SYSSR0_STRAP_MODE_USB         (0x3UL << CRU_SYSSR0_STRAP_MODE_Pos)  /*!< USB boot */
#define CRU_SYSSR0_STRAP_MODE_JTAG        (0x4UL << CRU_SYSSR0_STRAP_MODE_Pos)  /*!< JTAG chain */
#define CRU_SYSSR0_STRAP_MODE_PYTHON      (0x5UL << CRU_SYSSR0_STRAP_MODE_Pos)  /*!< Python boot */
#define CRU_SYSSR0_STRAP_MODE_MBR         (0x6UL << CRU_SYSSR0_STRAP_MODE_Pos)  /*!< MBR boot */

/** @brief SYSSR0[3]: Bootstrap inputs state - Clock */
...
#define CRU_SYSSR0_STRAP_CLK_CLKI         (0x0UL << CRU_SYSSR0_STRAP_CLK_Pos)   /*!< CLKI input */
#define CRU_SYSSR0_STRAP_CLK_RC           (0x1UL << CRU_SYSSR0_STRAP_CLK_Pos)   /*!< RC generator */

/** @brief SYSSR0[4]: Bootstrap inputs state - Debug */
...
#define CRU_SYSSR0_STRAP_DBG_EXT          (0x0UL << CRU_SYSSR0_STRAP_DBG_Pos)   /*!< External JTAG */
#define CRU_SYSSR0_STRAP_DBG_INT          (0x1UL << CRU_SYSSR0_STRAP_DBG_Pos)   /*!< Internal JTAG (CORE2 DEBUG) */

/** @brief SYSSR0[5]: NOSECURE (boot clock source) input state */
...
/** @brief SYSSR0[6]: EFLASH_OK (EFLASH good) input state */
...
/** @brief SYSSR0[7]: POR_OK (PoR circuitry good) input state */
...
/** @brief SYSSR0[8]: Watchdog reset flag */
...
/** @brief SYSSR0[9]: PLL RFSLIP output state */
...
/** @brief SYSSR0[10]: PLL FBSLIP output state */
...
/** @brief SYSSR0[11]: PLL NLOCK flag */
...
/** @brief SYSSR0[12]: EFLASH LDO NPOR output state */
...
/*****************  Bit definition for CRU_INTCR0 register  *****************/

/** @brief INTCR0[7:4]: PA external interrupt source (CORE0, CORE1 subsystem) */
...
/** @brief INTCR0[11:8]: PB external interrupt source (CORE0, CORE1 subsystem) */
...
/** @brief INTCR0[15:12]: PC external interrupt source (CORE0, CORE1 subsystem) */
...
/** @brief INTCR0[19:16]: PA external interrupt source (CORE2 subsystem) */
...
/** @brief INTCR0[23:20]: PB external interrupt source (CORE2 subsystem) */
...
/** @brief INTCR0[27:24]: PC external interrupt source (CORE2 subsystem) */
...
/*****************  Bit definition for CRU_CLKCR1 register  ***************/

/** @brief CLKCR1[4:0]: TCLK divider */
...
#define CRU_CLKCR1_TCLKDIV_DIV1         (0x0UL << CRU_CLKCR1_TCLKDIV_Pos)   /*!< TCLK not divided */
#define CRU_CLKCR1_TCLKDIV_DIV2         (0x2UL << CRU_CLKCR1_TCLKDIV_Pos)   /*!< TCLK divided by 2 */
#define CRU_CLKCR1_TCLKDIV_DIV3         (0x4UL << CRU_CLKCR1_TCLKDIV_Pos)   /*!< TCLK divided by 3 */
#define CRU_CLKCR1_TCLKDIV_DIV4         (0x6UL << CRU_CLKCR1_TCLKDIV_Pos)   /*!< TCLK divided by 4 */
#define CRU_CLKCR1_TCLKDIV_DIV5         (0x8UL << CRU_CLKCR1_TCLKDIV_Pos)   /*!< TCLK divided by 5 */
#define CRU_CLKCR1_TCLKDIV_DIV6         (0xAUL << CRU_CLKCR1_TCLKDIV_Pos)   /*!< TCLK divided by 6 */
#define CRU_CLKCR1_TCLKDIV_DIV7         (0xCUL << CRU_CLKCR1_TCLKDIV_Pos)   /*!< TCLK divided by 7 */
#define CRU_CLKCR1_TCLKDIV_DIV8         (0xEUL << CRU_CLKCR1_TCLKDIV_Pos)   /*!< TCLK divided by 8 */
#define CRU_CLKCR1_TCLKDIV_DIV9         (0x10UL << CRU_CLKCR1_TCLKDIV_Pos)  /*!< TCLK divided by 9 */
#define CRU_CLKCR1_TCLKDIV_DIV10        (0x12UL << CRU_CLKCR1_TCLKDIV_Pos)  /*!< TCLK divided by 10 */
#define CRU_CLKCR1_TCLKDIV_DIV11        (0x14UL << CRU_CLKCR1_TCLKDIV_Pos)  /*!< TCLK divided by 11 */
#define CRU_CLKCR1_TCLKDIV_DIV12        (0x16UL << CRU_CLKCR1_TCLKDIV_Pos)  /*!< TCLK divided by 12 */
#define CRU_CLKCR1_TCLKDIV_DIV13        (0x18UL << CRU_CLKCR1_TCLKDIV_Pos)  /*!< TCLK divided by 13 */
#define CRU_CLKCR1_TCLKDIV_DIV14        (0x1AUL << CRU_CLKCR1_TCLKDIV_Pos)  /*!< TCLK divided by 14 */
#define CRU_CLKCR1_TCLKDIV_DIV15        (0x1CUL << CRU_CLKCR1_TCLKDIV_Pos)  /*!< TCLK divided by 15 */
#define CRU_CLKCR1_TCLKDIV_DIV16        (0x1EUL << CRU_CLKCR1_TCLKDIV_Pos)  /*!< TCLK divided by 16 */

#define CRU_CLKCR1_TCLKDIV_DIV1_5       (0x1UL << CRU_CLKCR1_TCLKDIV_Pos)   /*!< TCLK divided by 1.5 */
#define CRU_CLKCR1_TCLKDIV_DIV2_5       (0x3UL << CRU_CLKCR1_TCLKDIV_Pos)   /*!< TCLK divided by 2.5 */
#define CRU_CLKCR1_TCLKDIV_DIV3_5       (0x5UL << CRU_CLKCR1_TCLKDIV_Pos)   /*!< TCLK divided by 3.5 */
#define CRU_CLKCR1_TCLKDIV_DIV4_5       (0x7UL << CRU_CLKCR1_TCLKDIV_Pos)   /*!< TCLK divided by 4.5 */
#define CRU_CLKCR1_TCLKDIV_DIV5_5       (0x9UL << CRU_CLKCR1_TCLKDIV_Pos)   /*!< TCLK divided by 5.5 */
#define CRU_CLKCR1_TCLKDIV_DIV6_5       (0xBUL << CRU_CLKCR1_TCLKDIV_Pos)   /*!< TCLK divided by 6.5 */
#define CRU_CLKCR1_TCLKDIV_DIV7_5       (0xDUL << CRU_CLKCR1_TCLKDIV_Pos)   /*!< TCLK divided by 7.5 */
#define CRU_CLKCR1_TCLKDIV_DIV8_5       (0xFUL << CRU_CLKCR1_TCLKDIV_Pos)   /*!< TCLK divided by 8.5 */
#define CRU_CLKCR1_TCLKDIV_DIV9_5       (0x11UL << CRU_CLKCR1_TCLKDIV_Pos)  /*!< TCLK divided by 9.5 */
#define CRU_CLKCR1_TCLKDIV_DIV10_5      (0x13UL << CRU_CLKCR1_TCLKDIV_Pos)  /*!< TCLK divided by 10.5 */
#define CRU_CLKCR1_TCLKDIV_DIV11_5      (0x15UL << CRU_CLKCR1_TCLKDIV_Pos)  /*!< TCLK divided by 11.5 */
#define CRU_CLKCR1_TCLKDIV_DIV12_5      (0x17UL << CRU_CLKCR1_TCLKDIV_Pos)  /*!< TCLK divided by 12.5 */
#define CRU_CLKCR1_TCLKDIV_DIV13_5      (0x19UL << CRU_CLKCR1_TCLKDIV_Pos)  /*!< TCLK divided by 13.5 */
#define CRU_CLKCR1_TCLKDIV_DIV14_5      (0x1BUL << CRU_CLKCR1_TCLKDIV_Pos)  /*!< TCLK divided by 14.5 */
#define CRU_CLKCR1_TCLKDIV_DIV15_5      (0x1DUL << CRU_CLKCR1_TCLKDIV_Pos)  /*!< TCLK divided by 15.5 */

/** @brief CLKCR1[5]: TCLK divider enable */
...
/** @brief CLKCR1[10:6]: CANCLK divider */
...
#define CRU_CLKCR1_CANCLKDIV_DIV1       (0x0UL << CRU_CLKCR1_CANCLKDIV_Pos)     /*!< CANCLK not divided */
#define CRU_CLKCR1_CANCLKDIV_DIV2       (0x2UL << CRU_CLKCR1_CANCLKDIV_Pos)     /*!< CANCLK divided by 2 */
#define CRU_CLKCR1_CANCLKDIV_DIV3       (0x4UL << CRU_CLKCR1_CANCLKDIV_Pos)     /*!< CANCLK divided by 3 */
#define CRU_CLKCR1_CANCLKDIV_DIV4       (0x6UL << CRU_CLKCR1_CANCLKDIV_Pos)     /*!< CANCLK divided by 4 */
#define CRU_CLKCR1_CANCLKDIV_DIV5       (0x8UL << CRU_CLKCR1_CANCLKDIV_Pos)     /*!< CANCLK divided by 5 */
#define CRU_CLKCR1_CANCLKDIV_DIV6       (0xAUL << CRU_CLKCR1_CANCLKDIV_Pos)     /*!< CANCLK divided by 6 */
#define CRU_CLKCR1_CANCLKDIV_DIV7       (0xCUL << CRU_CLKCR1_CANCLKDIV_Pos)     /*!< CANCLK divided by 7 */
#define CRU_CLKCR1_CANCLKDIV_DIV8       (0xEUL << CRU_CLKCR1_CANCLKDIV_Pos)     /*!< CANCLK divided by 8 */
#define CRU_CLKCR1_CANCLKDIV_DIV9       (0x10UL << CRU_CLKCR1_CANCLKDIV_Pos)    /*!< CANCLK divided by 9 */
#define CRU_CLKCR1_CANCLKDIV_DIV10      (0x12UL << CRU_CLKCR1_CANCLKDIV_Pos)    /*!< CANCLK divided by 10 */
#define CRU_CLKCR1_CANCLKDIV_DIV11      (0x14UL << CRU_CLKCR1_CANCLKDIV_Pos)    /*!< CANCLK divided by 11 */
#define CRU_CLKCR1_CANCLKDIV_DIV12      (0x16UL << CRU_CLKCR1_CANCLKDIV_Pos)    /*!< CANCLK divided by 12 */
#define CRU_CLKCR1_CANCLKDIV_DIV13      (0x18UL << CRU_CLKCR1_CANCLKDIV_Pos)    /*!< CANCLK divided by 13 */
#define CRU_CLKCR1_CANCLKDIV_DIV14      (0x1AUL << CRU_CLKCR1_CANCLKDIV_Pos)    /*!< CANCLK divided by 14 */
#define CRU_CLKCR1_CANCLKDIV_DIV15      (0x1CUL << CRU_CLKCR1_CANCLKDIV_Pos)    /*!< CANCLK divided by 15 */
#define CRU_CLKCR1_CANCLKDIV_DIV16      (0x1EUL << CRU_CLKCR1_CANCLKDIV_Pos)    /*!< CANCLK divided by 16 */

#define CRU_CLKCR1_CANCLKDIV_DIV1_5     (0x1UL << CRU_CLKCR1_CANCLKDIV_Pos)     /*!< CANCLK divided by 1.5 */
#define CRU_CLKCR1_CANCLKDIV_DIV2_5     (0x3UL << CRU_CLKCR1_CANCLKDIV_Pos)     /*!< CANCLK divided by 2.5 */
#define CRU_CLKCR1_CANCLKDIV_DIV3_5     (0x5UL << CRU_CLKCR1_CANCLKDIV_Pos)     /*!< CANCLK divided by 3.5 */
#define CRU_CLKCR1_CANCLKDIV_DIV4_5     (0x7UL << CRU_CLKCR1_CANCLKDIV_Pos)     /*!< CANCLK divided by 4.5 */
#define CRU_CLKCR1_CANCLKDIV_DIV5_5     (0x9UL << CRU_CLKCR1_CANCLKDIV_Pos)     /*!< CANCLK divided by 5.5 */
#define CRU_CLKCR1_CANCLKDIV_DIV6_5     (0xBUL << CRU_CLKCR1_CANCLKDIV_Pos)     /*!< CANCLK divided by 6.5 */
#define CRU_CLKCR1_CANCLKDIV_DIV7_5     (0xDUL << CRU_CLKCR1_CANCLKDIV_Pos)     /*!< CANCLK divided by 7.5 */
#define CRU_CLKCR1_CANCLKDIV_DIV8_5     (0xFUL << CRU_CLKCR1_CANCLKDIV_Pos)     /*!< CANCLK divided by 8.5 */
#define CRU_CLKCR1_CANCLKDIV_DIV9_5     (0x11UL << CRU_CLKCR1_CANCLKDIV_Pos)    /*!< CANCLK divided by 9.5 */
#define CRU_CLKCR1_CANCLKDIV_DIV10_5    (0x13UL << CRU_CLKCR1_CANCLKDIV_Pos)    /*!< CANCLK divided by 10.5 */
#define CRU_CLKCR1_CANCLKDIV_DIV11_5    (0x15UL << CRU_CLKCR1_CANCLKDIV_Pos)    /*!< CANCLK divided by 11.5 */
#define CRU_CLKCR1_CANCLKDIV_DIV12_5    (0x17UL << CRU_CLKCR1_CANCLKDIV_Pos)    /*!< CANCLK divided by 12.5 */
#define CRU_CLKCR1_CANCLKDIV_DIV13_5    (0x19UL << CRU_CLKCR1_CANCLKDIV_Pos)    /*!< CANCLK divided by 13.5 */
#define CRU_CLKCR1_CANCLKDIV_DIV14_5    (0x1BUL << CRU_CLKCR1_CANCLKDIV_Pos)    /*!< CANCLK divided by 14.5 */
#define CRU_CLKCR1_CANCLKDIV_DIV15_5    (0x1DUL << CRU_CLKCR1_CANCLKDIV_Pos)    /*!< CANCLK divided by 15.5 */

/** @brief CLKCR1[11]: CANCLK divider enable */
...
/******************  Bit definition for CRU_FLASHNVRCR register  *****************/

/** @brief FLASHNVRCR[0]: Disable EFLASH NVR Sector 1 modification operations */
#define CRU_FLASHNVRCR_Pos                     (0U)
#define CRU_FLASHNVRCR_Msk                     (0x1UL << CRU_FLASHNVRCR_Pos)
#define CRU_FLASHNVRCR                         CRU_FLASHNVRCR_Msk

/******************  Bit definition for CRU_CORE1CR register  *****************/

/** @brief CORE1CR[0]: CORE1 enable */
...
/** @brief CH_SAR[31:0]: Source address of DMA transfer */
...
/** @brief CH_DAR[31:0]: Destination address of DMA transfer */
...
/** @brief CH_LLP[31:2]: Start address of the next LLI */
...
/** @brief CH_CTL0[0]: Interrupt enable */
...
/** @brief CH_CTL0[3:1]: Destination transfer width */
...
/** @brief CH_CTL0[6:4]: Source transfer width */
...
/** @brief CH_CTL0[8:7]: Destination address increment */
...
/** @brief CH_CTL0[10:9]: Source address increment */
...
/** @brief CH_CTL0[13:11]: Destination burst transaction length */
...
/** @brief CH_CTL0[16:14]: Source burst transaction length */
...
/** @brief CH_CTL0[21:20]: Transfer type and flow control */
...
/** @brief CH_CTL0[27]: Enable block chaining using Linked List on the destination side */
...
/** @brief CH_CTL0[28]: Enable block chaining using Linked List on the source side */
...
/** @brief CH_CTL1[7:0]: Block transfer size */
...
/** @brief CH_CTL1[12]: Block transfer is done */
...
/** @brief CH_CFG0[7:5]: Channel priority */
...
/** @brief CH_CFG0[8]: Channel suspend */
...
/** @brief CH_CFG0[9]: Channel FIFO status */
...
/** @brief CH_CFG0[10]: Destination handshaking select */
...
/** @brief CH_CFG0[11]: Source handshaking select */
...
/** @brief CH_CFG0[18]: Destination handshaking interface polarity */
...
/** @brief CH_CFG0[19]: Source handshaking interface polarity */
...
/** @brief CH_CFG0[30]: Automatic source reload */
...
/** @brief CH_CFG0[31]: Automatic destination reload */
...
/** @brief CH_CFG1[0]: Flow control mode */
...
/** @brief CH_CFG1[1]: FIFO mode select */
...
/** @brief CH_CFG1[4:2]: Protection control */
...
/** @brief CH_CFG1[10:7]: Source hardware interface */
...
/** @brief CH_CFG1[14:11]: Destination hardware interface */
...
/** @brief INT_RAW_TFR[0]: Channel 0 raw status for IntTfr interrupt */
...
/** @brief INT_RAW_TFR[1]: Channel 1 raw status for IntTfr interrupt */
...
/** @brief INT_RAW_TFR[2]: Channel 2 raw status for IntTfr interrupt */
...
/** @brief INT_RAW_TFR[3]: Channel 3 raw status for IntTfr interrupt */
...
/** @brief INT_RAW_TFR[4]: Channel 4 raw status for IntTfr interrupt */
...
/** @brief INT_RAW_TFR[5]: Channel 5 raw status for IntTfr interrupt */
...
/** @brief INT_RAW_TFR[6]: Channel 6 raw status for IntTfr interrupt */
...
/** @brief INT_RAW_TFR[7]: Channel 7 raw status for IntTfr interrupt */
...
/** @brief INT_RAW_BLOCK[0]: Channel 0 raw status for IntBlock interrupt */
...
/** @brief INT_RAW_BLOCK[1]: Channel 1 raw status for IntBlock interrupt */
...
/** @brief INT_RAW_BLOCK[2]: Channel 2 raw status for IntBlock interrupt */
...
/** @brief INT_RAW_BLOCK[3]: Channel 3 raw status for IntBlock interrupt */
...
/** @brief INT_RAW_BLOCK[4]: Channel 4 raw status for IntBlock interrupt */
...
/** @brief INT_RAW_BLOCK[5]: Channel 5 raw status for IntBlock interrupt */
...
/** @brief INT_RAW_BLOCK[6]: Channel 6 raw status for IntBlock interrupt */
...
/** @brief INT_RAW_BLOCK[7]: Channel 7 raw status for IntBlock interrupt */
...
/** @brief INT_RAW_SRC_TRAN[0]: Channel 0 raw status for IntSrcTran interrupt */
...
/** @brief INT_RAW_SRC_TRAN[1]: Channel 1 raw status for IntSrcTran interrupt */
...
/** @brief INT_RAW_SRC_TRAN[2]: Channel 2 raw status for IntSrcTran interrupt */
...
/** @brief INT_RAW_SRC_TRAN[3]: Channel 3 raw status for IntSrcTran interrupt */
...
/** @brief INT_RAW_SRC_TRAN[4]: Channel 4 raw status for IntSrcTran interrupt */
...
/** @brief INT_RAW_SRC_TRAN[5]: Channel 5 raw status for IntSrcTran interrupt */
...
/** @brief INT_RAW_SRC_TRAN[6]: Channel 6 raw status for IntSrcTran interrupt */
...
/** @brief INT_RAW_SRC_TRAN[7]: Channel 7 raw status for IntSrcTran interrupt */
...
/** @brief INT_RAW_DST_TRAN[0]: Channel 0 raw status for IntDstTran interrupt */
...
/** @brief INT_RAW_DST_TRAN[1]: Channel 1 raw status for IntDstTran interrupt */
...
/** @brief INT_RAW_DST_TRAN[2]: Channel 2 raw status for IntDstTran interrupt */
...
/** @brief INT_RAW_DST_TRAN[3]: Channel 3 raw status for IntDstTran interrupt */
...
/** @brief INT_RAW_DST_TRAN[4]: Channel 4 raw status for IntDstTran interrupt */
...
/** @brief INT_RAW_DST_TRAN[5]: Channel 5 raw status for IntDstTran interrupt */
...
/** @brief INT_RAW_DST_TRAN[6]: Channel 6 raw status for IntDstTran interrupt */
...
/** @brief INT_RAW_DST_TRAN[7]: Channel 7 raw status for IntDstTran interrupt */
...
/** @brief INT_RAW_ERR[0]: Channel 0 raw status for IntErr interrupt */
...
/** @brief INT_RAW_ERR[1]: Channel 1 raw status for IntErr interrupt */
...
/** @brief INT_RAW_ERR[2]: Channel 2 raw status for IntErr interrupt */
...
/** @brief INT_RAW_ERR[3]: Channel 3 raw status for IntErr interrupt */
...
/** @brief INT_RAW_ERR[4]: Channel 4 raw status for IntErr interrupt */
...
/** @brief INT_RAW_ERR[5]: Channel 5 raw status for IntErr interrupt */
...
/** @brief INT_RAW_ERR[6]: Channel 6 raw status for IntErr interrupt */
...
/** @brief INT_RAW_ERR[7]: Channel 7 raw status for IntErr interrupt */
...
/** @brief INT_STAT_TFR[0]: Channel 0 status for IntTfr interrupt */
...
/** @brief INT_STAT_TFR[1]: Channel 1 status for IntTfr interrupt */
...
/** @brief INT_STAT_TFR[2]: Channel 2 status for IntTfr interrupt */
...
/** @brief INT_STAT_TFR[3]: Channel 3 status for IntTfr interrupt */
...
/** @brief INT_STAT_TFR[4]: Channel 4 status for IntTfr interrupt */
...
/** @brief INT_STAT_TFR[5]: Channel 5 status for IntTfr interrupt */
...
/** @brief INT_STAT_TFR[6]: Channel 6 status for IntTfr interrupt */
...
/** @brief INT_STAT_TFR[7]: Channel 7 status for IntTfr interrupt */
...
/** @brief INT_STAT_BLOCK[0]: Channel 0 status for IntBlock interrupt */
...
/** @brief INT_STAT_BLOCK[1]: Channel 1 status for IntBlock interrupt */
...
/** @brief INT_STAT_BLOCK[2]: Channel 2 status for IntBlock interrupt */
...
/** @brief INT_STAT_BLOCK[3]: Channel 3 status for IntBlock interrupt */
...
/** @brief INT_STAT_BLOCK[4]: Channel 4 status for IntBlock interrupt */
...
/** @brief INT_STAT_BLOCK[5]: Channel 5 status for IntBlock interrupt */
...
/** @brief INT_STAT_BLOCK[6]: Channel 6 status for IntBlock interrupt */
...
/** @brief INT_STAT_BLOCK[7]: Channel 7 status for IntBlock interrupt */
...
/** @brief INT_STAT_SRC_TRAN[0]: Channel 0 status for IntSrcTran interrupt */
...
/** @brief INT_STAT_SRC_TRAN[1]: Channel 1 status for IntSrcTran interrupt */
...
/** @brief INT_STAT_SRC_TRAN[2]: Channel 2 status for IntSrcTran interrupt */
...
/** @brief INT_STAT_SRC_TRAN[3]: Channel 3 status for IntSrcTran interrupt */
...
/** @brief INT_STAT_SRC_TRAN[4]: Channel 4 status for IntSrcTran interrupt */
...
/** @brief INT_STAT_SRC_TRAN[5]: Channel 5 status for IntSrcTran interrupt */
...
/** @brief INT_STAT_SRC_TRAN[6]: Channel 6 status for IntSrcTran interrupt */
...
/** @brief INT_STAT_SRC_TRAN[7]: Channel 7 status for IntSrcTran interrupt */
...
/** @brief INT_STAT_DST_TRAN[0]: Channel 0 status for IntDstTran interrupt */
...
/** @brief INT_STAT_DST_TRAN[1]: Channel 1 status for IntDstTran interrupt */
...
/** @brief INT_STAT_DST_TRAN[2]: Channel 2 status for IntDstTran interrupt */
...
/** @brief INT_STAT_DST_TRAN[3]: Channel 3 status for IntDstTran interrupt */
...
/** @brief INT_STAT_DST_TRAN[4]: Channel 4 status for IntDstTran interrupt */
...
/** @brief INT_STAT_DST_TRAN[5]: Channel 5 status for IntDstTran interrupt */
...
/** @brief INT_STAT_DST_TRAN[6]: Channel 6 status for IntDstTran interrupt */
...
/** @brief INT_STAT_DST_TRAN[7]: Channel 7 status for IntDstTran interrupt */
...
/** @brief INT_STAT_ERR[0]: Channel 0 status for IntErr interrupt */
...
/** @brief INT_STAT_ERR[1]: Channel 1 status for IntErr interrupt */
...
/** @brief INT_STAT_ERR[2]: Channel 2 status for IntErr interrupt */
...
/** @brief INT_STAT_ERR[3]: Channel 3 status for IntErr interrupt */
...
/** @brief INT_STAT_ERR[4]: Channel 4 status for IntErr interrupt */
...
/** @brief INT_STAT_ERR[5]: Channel 5 status for IntErr interrupt */
...
/** @brief INT_STAT_ERR[6]: Channel 6 status for IntErr interrupt */
...
/** @brief INT_STAT_ERR[7]: Channel 7 status for IntErr interrupt */
...
/** @brief INT_MASK_TFR[0]: Channel 0 mask for IntTfr interrupt */
...
/** @brief INT_MASK_TFR[1]: Channel 1 mask for IntTfr interrupt */
...
/** @brief INT_MASK_TFR[2]: Channel 2 mask for IntTfr interrupt */
...
/** @brief INT_MASK_TFR[3]: Channel 3 mask for IntTfr interrupt */
...
/** @brief INT_MASK_TFR[4]: Channel 4 mask for IntTfr interrupt */
...
/** @brief INT_MASK_TFR[5]: Channel 5 mask for IntTfr interrupt */
...
/** @brief INT_MASK_TFR[6]: Channel 6 mask for IntTfr interrupt */
...
/** @brief INT_MASK_TFR[7]: Channel 7 mask for IntTfr interrupt */
...
/** @brief INT_MASK_TFR[8]: Channel 0 mask write enable for IntTfr interrupt */
...
/** @brief INT_MASK_TFR[9]: Channel 1 mask write enable for IntTfr interrupt */
...
/** @brief INT_MASK_TFR[10]: Channel 2 mask write enable for IntTfr interrupt */
...
/** @brief INT_MASK_TFR[11]: Channel 3 mask write enable for IntTfr interrupt */
...
/** @brief INT_MASK_TFR[12]: Channel 4 mask write enable for IntTfr interrupt */
...
/** @brief INT_MASK_TFR[13]: Channel 5 mask write enable for IntTfr interrupt */
...
/** @brief INT_MASK_TFR[14]: Channel 6 mask write enable for IntTfr interrupt */
...
/** @brief INT_MASK_TFR[15]: Channel 7 mask write enable for IntTfr interrupt */
...
/** @brief INT_MASK_BLOCK[0]: Channel 0 mask for IntBlock interrupt */
...
/** @brief INT_MASK_BLOCK[1]: Channel 1 mask for IntBlock interrupt */
...
/** @brief INT_MASK_BLOCK[2]: Channel 2 mask for IntBlock interrupt */
...
/** @brief INT_MASK_BLOCK[3]: Channel 3 mask for IntBlock interrupt */
...
/** @brief INT_MASK_BLOCK[4]: Channel 4 mask for IntBlock interrupt */
...
/** @brief INT_MASK_BLOCK[5]: Channel 5 mask for IntBlock interrupt */
...
/** @brief INT_MASK_BLOCK[6]: Channel 6 mask for IntBlock interrupt */
...
/** @brief INT_MASK_BLOCK[7]: Channel 7 mask for IntBlock interrupt */
...
/** @brief INT_MASK_BLOCK[8]: Channel 0 mask write enable for IntBlock interrupt */
...
/** @brief INT_MASK_BLOCK[9]: Channel 1 mask write enable for IntBlock interrupt */
...
/** @brief INT_MASK_BLOCK[10]: Channel 2 mask write enable for IntBlock interrupt */
...
/** @brief INT_MASK_BLOCK[11]: Channel 3 mask write enable for IntBlock interrupt */
...
/** @brief INT_MASK_BLOCK[12]: Channel 4 mask write enable for IntBlock interrupt */
...
/** @brief INT_MASK_BLOCK[13]: Channel 5 mask write enable for IntBlock interrupt */
...
/** @brief INT_MASK_BLOCK[14]: Channel 6 mask write enable for IntBlock interrupt */
...
/** @brief INT_MASK_BLOCK[15]: Channel 7 mask write enable for IntBlock interrupt */
...
/** @brief INT_MASK_SRC_TRAN[0]: Channel 0 mask for IntSrcTran interrupt */
...
/** @brief INT_MASK_SRC_TRAN[1]: Channel 1 mask for IntSrcTran interrupt */
...
/** @brief INT_MASK_SRC_TRAN[2]: Channel 2 mask for IntSrcTran interrupt */
...
/** @brief INT_MASK_SRC_TRAN[3]: Channel 3 mask for IntSrcTran interrupt */
...
/** @brief INT_MASK_SRC_TRAN[4]: Channel 4 mask for IntSrcTran interrupt */
...
/** @brief INT_MASK_SRC_TRAN[5]: Channel 5 mask for IntSrcTran interrupt */
...
/** @brief INT_MASK_SRC_TRAN[6]: Channel 6 mask for IntSrcTran interrupt */
...
/** @brief INT_MASK_SRC_TRAN[7]: Channel 7 mask for IntSrcTran interrupt */
...
/** @brief INT_MASK_SRC_TRAN[8]: Channel 0 mask write enable for IntSrcTran interrupt */
...
/** @brief INT_MASK_SRC_TRAN[9]: Channel 1 mask write enable for IntSrcTran interrupt */
...
/** @brief INT_MASK_SRC_TRAN[10]: Channel 2 mask write enable for IntSrcTran interrupt */
...
/** @brief INT_MASK_SRC_TRAN[11]: Channel 3 mask write enable for IntSrcTran interrupt */
...
/** @brief INT_MASK_SRC_TRAN[12]: Channel 4 mask write enable for IntSrcTran interrupt */
...
/** @brief INT_MASK_SRC_TRAN[13]: Channel 5 mask write enable for IntSrcTran interrupt */
...
/** @brief INT_MASK_SRC_TRAN[14]: Channel 6 mask write enable for IntSrcTran interrupt */
...
/** @brief INT_MASK_SRC_TRAN[15]: Channel 7 mask write enable for IntSrcTran interrupt */
...
/** @brief INT_MASK_DST_TRAN[0]: Channel 0 mask for IntDstTran interrupt */
...
/** @brief INT_MASK_DST_TRAN[1]: Channel 1 mask for IntDstTran interrupt */
...
/** @brief INT_MASK_DST_TRAN[2]: Channel 2 mask for IntDstTran interrupt */
...
/** @brief INT_MASK_DST_TRAN[3]: Channel 3 mask for IntDstTran interrupt */
...
/** @brief INT_MASK_DST_TRAN[4]: Channel 4 mask for IntDstTran interrupt */
...
/** @brief INT_MASK_DST_TRAN[5]: Channel 5 mask for IntDstTran interrupt */
...
/** @brief INT_MASK_DST_TRAN[6]: Channel 6 mask for IntDstTran interrupt */
...
/** @brief INT_MASK_DST_TRAN[7]: Channel 7 mask for IntDstTran interrupt */
...
/** @brief INT_MASK_DST_TRAN[8]: Channel 0 mask write enable for IntDstTran interrupt */
...
/** @brief INT_MASK_DST_TRAN[9]: Channel 1 mask write enable for IntDstTran interrupt */
...
/** @brief INT_MASK_DST_TRAN[10]: Channel 2 mask write enable for IntDstTran interrupt */
...
/** @brief INT_MASK_DST_TRAN[11]: Channel 3 mask write enable for IntDstTran interrupt */
...
/** @brief INT_MASK_DST_TRAN[12]: Channel 4 mask write enable for IntDstTran interrupt */
...
/** @brief INT_MASK_DST_TRAN[13]: Channel 5 mask write enable for IntDstTran interrupt */
...
/** @brief INT_MASK_DST_TRAN[14]: Channel 6 mask write enable for IntDstTran interrupt */
...
/** @brief INT_MASK_DST_TRAN[15]: Channel 7 mask write enable for IntDstTran interrupt */
...
/** @brief INT_MASK_ERR[0]: Channel 0 mask for IntErr interrupt */
...
/** @brief INT_MASK_ERR[1]: Channel 1 mask for IntErr interrupt */
...
/** @brief INT_MASK_ERR[2]: Channel 2 mask for IntErr interrupt */
...
/** @brief INT_MASK_ERR[3]: Channel 3 mask for IntErr interrupt */
...
/** @brief INT_MASK_ERR[4]: Channel 4 mask for IntErr interrupt */
...
/** @brief INT_MASK_ERR[5]: Channel 5 mask for IntErr interrupt */
...
/** @brief INT_MASK_ERR[6]: Channel 6 mask for IntErr interrupt */
...
/** @brief INT_MASK_ERR[7]: Channel 7 mask for IntErr interrupt */
...
/** @brief INT_MASK_ERR[8]: Channel 0 mask write enable for IntErr interrupt */
...
/** @brief INT_MASK_ERR[9]: Channel 1 mask write enable for IntErr interrupt */
...
/** @brief INT_MASK_ERR[10]: Channel 2 mask write enable for IntErr interrupt */
...
/** @brief INT_MASK_ERR[11]: Channel 3 mask write enable for IntErr interrupt */
...
/** @brief INT_MASK_ERR[12]: Channel 4 mask write enable for IntErr interrupt */
...
/** @brief INT_MASK_ERR[13]: Channel 5 mask write enable for IntErr interrupt */
...
/** @brief INT_MASK_ERR[14]: Channel 6 mask write enable for IntErr interrupt */
...
/** @brief INT_MASK_ERR[15]: Channel 7 mask write enable for IntErr interrupt */
...
/** @brief INT_CLR_TFR[0]: Channel 0 clear for IntTfr interrupt */
...
/** @brief INT_CLR_TFR[1]: Channel 1 clear for IntTfr interrupt */
...
/** @brief INT_CLR_TFR[2]: Channel 2 clear for IntTfr interrupt */
...
/** @brief INT_CLR_TFR[3]: Channel 3 clear for IntTfr interrupt */
...
/** @brief INT_CLR_TFR[4]: Channel 4 clear for IntTfr interrupt */
...
/** @brief INT_CLR_TFR[5]: Channel 5 clear for IntTfr interrupt */
...
/** @brief INT_CLR_TFR[6]: Channel 6 clear for IntTfr interrupt */
...
/** @brief INT_CLR_TFR[7]: Channel 7 clear for IntTfr interrupt */
...
/** @brief INT_CLR_BLOCK[0]: Channel 0 clear for IntBlock interrupt */
...
/** @brief INT_CLR_BLOCK[1]: Channel 1 clear for IntBlock interrupt */
...
/** @brief INT_CLR_BLOCK[2]: Channel 2 clear for IntBlock interrupt */
...
/** @brief INT_CLR_BLOCK[3]: Channel 3 clear for IntBlock interrupt */
...
/** @brief INT_CLR_BLOCK[4]: Channel 4 clear for IntBlock interrupt */
...
/** @brief INT_CLR_BLOCK[5]: Channel 5 clear for IntBlock interrupt */
...
/** @brief INT_CLR_BLOCK[6]: Channel 6 clear for IntBlock interrupt */
...
/** @brief INT_CLR_BLOCK[7]: Channel 7 clear for IntBlock interrupt */
...
/** @brief INT_CLR_SRC_TRAN[0]: Channel 0 clear for IntSrcTran interrupt */
...
/** @brief INT_CLR_SRC_TRAN[1]: Channel 1 clear for IntSrcTran interrupt */
...
/** @brief INT_CLR_SRC_TRAN[2]: Channel 2 clear for IntSrcTran interrupt */
...
/** @brief INT_CLR_SRC_TRAN[3]: Channel 3 clear for IntSrcTran interrupt */
...
/** @brief INT_CLR_SRC_TRAN[4]: Channel 4 clear for IntSrcTran interrupt */
...
/** @brief INT_CLR_SRC_TRAN[5]: Channel 5 clear for IntSrcTran interrupt */
...
/** @brief INT_CLR_SRC_TRAN[6]: Channel 6 clear for IntSrcTran interrupt */
...
/** @brief INT_CLR_SRC_TRAN[7]: Channel 7 clear for IntSrcTran interrupt */
...
/** @brief INT_CLR_DST_TRAN[0]: Channel 0 clear for IntDstTran interrupt */
...
/** @brief INT_CLR_DST_TRAN[1]: Channel 1 clear for IntDstTran interrupt */
...
/** @brief INT_CLR_DST_TRAN[2]: Channel 2 clear for IntDstTran interrupt */
...
/** @brief INT_CLR_DST_TRAN[3]: Channel 3 clear for IntDstTran interrupt */
...
/** @brief INT_CLR_DST_TRAN[4]: Channel 4 clear for IntDstTran interrupt */
...
/** @brief INT_CLR_DST_TRAN[5]: Channel 5 clear for IntDstTran interrupt */
...
/** @brief INT_CLR_DST_TRAN[6]: Channel 6 clear for IntDstTran interrupt */
...
/** @brief INT_CLR_DST_TRAN[7]: Channel 7 clear for IntDstTran interrupt */
...
/** @brief INT_CLR_ERR[0]: Channel 0 clear for IntErr interrupt */
...
/** @brief INT_CLR_ERR[1]: Channel 1 clear for IntErr interrupt */
...
/** @brief INT_CLR_ERR[2]: Channel 2 clear for IntErr interrupt */
...
/** @brief INT_CLR_ERR[3]: Channel 3 clear for IntErr interrupt */
...
/** @brief INT_CLR_ERR[4]: Channel 4 clear for IntErr interrupt */
...
/** @brief INT_CLR_ERR[5]: Channel 5 clear for IntErr interrupt */
...
/** @brief INT_CLR_ERR[6]: Channel 6 clear for IntErr interrupt */
...
/** @brief INT_CLR_ERR[7]: Channel 7 clear for IntErr interrupt */
...
/** @brief INT_STAT[0]: OR of the contents of STAT_TFR register */
...
/** @brief INT_STAT[1]: OR of the contents of STAT_BLOCK register */
...
/** @brief INT_STAT[2]: OR of the contents of STAT_SRC_TRAN register */
...
/** @brief INT_STAT[3]: OR of the contents of STAT_DST_TRAN register */
...
/** @brief INT_STAT[4]: OR of the contents of STAT_ERR register */
...
/** @brief HS_REQ_SRC[0]: Channel 0 source software transaction request */
...
/** @brief HS_REQ_SRC[1]: Channel 1 source software transaction request */
...
/** @brief HS_REQ_SRC[2]: Channel 2 source software transaction request */
...
/** @brief HS_REQ_SRC[3]: Channel 3 source software transaction request */
...
/** @brief HS_REQ_SRC[4]: Channel 4 source software transaction request */
...
/** @brief HS_REQ_SRC[5]: Channel 5 source software transaction request */
...
/** @brief HS_REQ_SRC[6]: Channel 6 source software transaction request */
...
/** @brief HS_REQ_SRC[7]: Channel 7 source software transaction request */
...
/** @brief HS_REQ_SRC[8]: Channel 0 source software transaction request write enable */
...
/** @brief HS_REQ_SRC[9]: Channel 1 source software transaction request write enable */
...
/** @brief HS_REQ_SRC[10]: Channel 2 source software transaction request write enable */
...
/** @brief HS_REQ_SRC[11]: Channel 3 source software transaction request write enable */
...
/** @brief HS_REQ_SRC[12]: Channel 4 source software transaction request write enable */
...
/** @brief HS_REQ_SRC[13]: Channel 5 source software transaction request write enable */
...
/** @brief HS_REQ_SRC[14]: Channel 6 source software transaction request write enable */
...
/** @brief HS_REQ_SRC[15]: Channel 7 source software transaction request write enable */
...
/** @brief HS_REQ_DST[0]: Channel 0 destination software transaction request */
...
/** @brief HS_REQ_DST[1]: Channel 1 destination software transaction request */
...
/** @brief HS_REQ_DST[2]: Channel 2 destination software transaction request */
...
/** @brief HS_REQ_DST[3]: Channel 3 destination software transaction request */
...
/** @brief HS_REQ_DST[4]: Channel 4 destination software transaction request */
...
/** @brief HS_REQ_DST[5]: Channel 5 destination software transaction request */
...
/** @brief HS_REQ_DST[6]: Channel 6 destination software transaction request */
...
/** @brief HS_REQ_DST[7]: Channel 7 destination software transaction request */
...
/** @brief HS_REQ_DST[8]: Channel 0 destination software transaction request write enable */
...
/** @brief HS_REQ_DST[9]: Channel 1 destination software transaction request write enable */
...
/** @brief HS_REQ_DST[10]: Channel 2 destination software transaction request write enable */
...
/** @brief HS_REQ_DST[11]: Channel 3 destination software transaction request write enable */
...
/** @brief HS_REQ_DST[12]: Channel 4 destination software transaction request write enable */
...
/** @brief HS_REQ_DST[13]: Channel 5 destination software transaction request write enable */
...
/** @brief HS_REQ_DST[14]: Channel 6 destination software transaction request write enable */
...
/** @brief HS_REQ_DST[15]: Channel 7 destination software transaction request write enable */
...
/** @brief HS_SGL_REQ_SRC[0]: Channel 0 source single transaction request */
...
/** @brief HS_SGL_REQ_SRC[1]: Channel 1 source single transaction request */
...
/** @brief HS_SGL_REQ_SRC[2]: Channel 2 source single transaction request */
...
/** @brief HS_SGL_REQ_SRC[3]: Channel 3 source single transaction request */
...
/** @brief HS_SGL_REQ_SRC[4]: Channel 4 source single transaction request */
...
/** @brief HS_SGL_REQ_SRC[5]: Channel 5 source single transaction request */
...
/** @brief HS_SGL_REQ_SRC[6]: Channel 6 source single transaction request */
...
/** @brief HS_SGL_REQ_SRC[7]: Channel 7 source single transaction request */
...
/** @brief HS_SGL_REQ_SRC[8]: Channel 0 source single transaction request write enable */
...
/** @brief HS_SGL_REQ_SRC[9]: Channel 1 source single transaction request write enable */
...
/** @brief HS_SGL_REQ_SRC[10]: Channel 2 source single transaction request write enable */
...
/** @brief HS_SGL_REQ_SRC[11]: Channel 3 source single transaction request write enable */
...
/** @brief HS_SGL_REQ_SRC[12]: Channel 4 source single transaction request write enable */
...
/** @brief HS_SGL_REQ_SRC[13]: Channel 5 source single transaction request write enable */
...
/** @brief HS_SGL_REQ_SRC[14]: Channel 6 source single transaction request write enable */
...
/** @brief HS_SGL_REQ_SRC[15]: Channel 7 source single transaction request write enable */
...
/** @brief HS_SGL_REQ_DST[0]: Channel 0 destination single transaction request */
...
/** @brief HS_SGL_REQ_DST[1]: Channel 1 destination single transaction request */
...
/** @brief HS_SGL_REQ_DST[2]: Channel 2 destination single transaction request */
...
/** @brief HS_SGL_REQ_DST[3]: Channel 3 destination single transaction request */
...
/** @brief HS_SGL_REQ_DST[4]: Channel 4 destination single transaction request */
...
/** @brief HS_SGL_REQ_DST[5]: Channel 5 destination single transaction request */
...
/** @brief HS_SGL_REQ_DST[6]: Channel 6 destination single transaction request */
...
/** @brief HS_SGL_REQ_DST[7]: Channel 7 destination single transaction request */
...
/** @brief HS_SGL_REQ_DST[8]: Channel 0 destination single transaction request write enable */
...
/** @brief HS_SGL_REQ_DST[9]: Channel 1 destination single transaction request write enable */
...
/** @brief HS_SGL_REQ_DST[10]: Channel 2 destination single transaction request write enable */
...
/** @brief HS_SGL_REQ_DST[11]: Channel 3 destination single transaction request write enable */
...
/** @brief HS_SGL_REQ_DST[12]: Channel 4 destination single transaction request write enable */
...
/** @brief HS_SGL_REQ_DST[13]: Channel 5 destination single transaction request write enable */
...
/** @brief HS_SGL_REQ_DST[14]: Channel 6 destination single transaction request write enable */
...
/** @brief HS_SGL_REQ_DST[15]: Channel 7 destination single transaction request write enable */
...
/** @brief HS_LST_SRC[0]: Channel 0 source last transaction request */
...
/** @brief HS_LST_SRC[1]: Channel 1 source last transaction request */
...
/** @brief HS_LST_SRC[2]: Channel 2 source last transaction request */
...
/** @brief HS_LST_SRC[3]: Channel 3 source last transaction request */
...
/** @brief HS_LST_SRC[4]: Channel 4 source last transaction request */
...
/** @brief HS_LST_SRC[5]: Channel 5 source last transaction request */
...
/** @brief HS_LST_SRC[6]: Channel 6 source last transaction request */
...
/** @brief HS_LST_SRC[7]: Channel 7 source last transaction request */
...
/** @brief HS_LST_SRC[8]: Channel 0 source last transaction request write enable */
...
/** @brief HS_LST_SRC[9]: Channel 1 source last transaction request write enable */
...
/** @brief HS_LST_SRC[10]: Channel 2 source last transaction request write enable */
...
/** @brief HS_LST_SRC[11]: Channel 3 source last transaction request write enable */
...
/** @brief HS_LST_SRC[12]: Channel 4 source last transaction request write enable */
...
/** @brief HS_LST_SRC[13]: Channel 5 source last transaction request write enable */
...
/** @brief HS_LST_SRC[14]: Channel 6 source last transaction request write enable */
...
/** @brief HS_LST_SRC[15]: Channel 7 source last transaction request write enable */
...
/** @brief HS_LST_DST[0]: Channel 0 destination last transaction request */
...
/** @brief HS_LST_DST[1]: Channel 1 destination last transaction request */
...
/** @brief HS_LST_DST[2]: Channel 2 destination last transaction request */
...
/** @brief HS_LST_DST[3]: Channel 3 destination last transaction request */
...
/** @brief HS_LST_DST[4]: Channel 4 destination last transaction request */
...
/** @brief HS_LST_DST[5]: Channel 5 destination last transaction request */
...
/** @brief HS_LST_DST[6]: Channel 6 destination last transaction request */
...
/** @brief HS_LST_DST[7]: Channel 7 destination last transaction request */
...
/** @brief HS_LST_DST[8]: Channel 0 destination last transaction request write enable */
...
/** @brief HS_LST_DST[9]: Channel 1 destination last transaction request write enable */
...
/** @brief HS_LST_DST[10]: Channel 2 destination last transaction request write enable */
...
/** @brief HS_LST_DST[11]: Channel 3 destination last transaction request write enable */
...
/** @brief HS_LST_DST[12]: Channel 4 destination last transaction request write enable */
...
/** @brief HS_LST_DST[13]: Channel 5 destination last transaction request write enable */
...
/** @brief HS_LST_DST[14]: Channel 6 destination last transaction request write enable */
...
/** @brief HS_LST_DST[15]: Channel 7 destination last transaction request write enable */
...
/** @brief MSC_CFG[0]: DMA controller enable */
...
/** @brief MSC_CH_EN[0]: Channel 0 enable */
...
/** @brief MSC_CH_EN[1]: Channel 1 enable */
...
/** @brief MSC_CH_EN[2]: Channel 2 enable */
...
/** @brief MSC_CH_EN[3]: Channel 3 enable */
...
/** @brief MSC_CH_EN[4]: Channel 4 enable */
...
/** @brief MSC_CH_EN[5]: Channel 5 enable */
...
/** @brief MSC_CH_EN[6]: Channel 6 enable */
...
/** @brief MSC_CH_EN[7]: Channel 7 enable */
...
/** @brief MSC_CH_EN[8]: Channel 0 enable write enable */
...
/** @brief MSC_CH_EN[9]: Channel 1 enable write enable */
...
/** @brief MSC_CH_EN[10]: Channel 2 enable write enable */
...
/** @brief MSC_CH_EN[11]: Channel 3 enable write enable */
...
/** @brief MSC_CH_EN[12]: Channel 4 enable write enable */
...
/** @brief MSC_CH_EN[13]: Channel 5 enable write enable */
...
/** @brief MSC_CH_EN[14]: Channel 6 enable write enable */
...
/** @brief MSC_CH_EN[15]: Channel 7 enable write enable */
...
/** @brief MSC_ID[31:0]: DMA controller peripheral ID */
...
/** @brief MSC_TEST[0]: DMA test mode */
...
/** @brief MSC_COMP_TYPE[31:0]: DMA component type */
...
/** @brief MSC_COMP_VERSION[31:0]: DMA component version */
...
/******************  Bit definition for EFLASH_CR register  *****************/
...
#define EFLASH_CR_OP_CODE_CFG             (0x0UL << EFLASH_CR_OP_CODE_Pos)  /*!< CFG: The flash memory configuration */
#define EFLASH_CR_OP_CODE_WRITE           (0x1UL << EFLASH_CR_OP_CODE_Pos)  /*!< WRITE: Write a word to the flash memory */
#define EFLASH_CR_OP_CODE_READ            (0x2UL << EFLASH_CR_OP_CODE_Pos)  /*!< READ: Read a word from the flash memory */
#define EFLASH_CR_OP_CODE_CHIP_ERASE      (0x3UL << EFLASH_CR_OP_CODE_Pos)  /*!< CHIP_ERASE: Chip erase */
#define EFLASH_CR_OP_CODE_BLOCK_ERASE     (0x4UL << EFLASH_CR_OP_CODE_Pos)  /*!< BLOCK_ERASE: Block erase*/
#define EFLASH_CR_OP_CODE_SECTOR_ERASE    (0x5UL << EFLASH_CR_OP_CODE_Pos)  /*!< SECTOR_ERASE: Sector erase */
#define EFLASH_CR_OP_CODE_ENTER_DPD       (0x6UL << EFLASH_CR_OP_CODE_Pos)  /*!< ENTER_DPD: Enter Deep Power Down mode */
#define EFLASH_CR_OP_CODE_EXIT_DPD        (0x7UL << EFLASH_CR_OP_CODE_Pos)  /*!< EXIT_DPD: Exit Deep Power Down mode */
...
/*****************  Bit definition for EFLASH_SR register  ****************/
...
/**************  Bit definition for EFLASH_MANUAL_ADDR register  **************/

/** @brief MANUAL_ADDR[15:0]: Address input in manual mode */
...
/*** Bits definition for GPIO_INTEN register **************************************/
...
/*** Bits definition for GPIO_INTMSK register ************************************/
...
/*** Bits definition for GPIO_INTLVL register ***********************************/
...
/*** Bits definition for GPIO_INTPOLARITY register ********************************/
...
/*** Bits definition for GPIO_INTSTAT register ***********************************/
...
/*** Bits definition for GPIO_INTSTATRAW register ******************************/
...
/*** Bits definition for GPIO_DEBOUNCE register ************************************/
...
/*** Bits definition for GPIO_EOI register *****************************************/
...
/*** Bits definition for GPIO_BOTHEDGE register ************************************/
...
/** @brief SCL_STUCK_AT_LOW_TIMEOUT[31:0]: SCL stuck at low timeout */
...
/** @brief SDA_STUCK_AT_LOW_TIMEOUT[31:0]: SDA stuck at low timeout */
...
#define PWMA_CR1_OPM_REPETITIVE             (0x0UL << PWMA_CR1_OPM_Pos)     /*!< Counter is not stopped at update event */
#define PWMA_CR1_OPM_SINGLE                 (0x1UL << PWMA_CR1_OPM_Pos)     /*!< Counter stops counting at the next update event */
...
#define PWMA_CR1_CMS_EDGE_ALIGNED           (0x0UL << PWMA_CR1_CMS_Pos)     /*!< Edge-aligned mode */
#define PWMA_CR1_CMS_CENTER_ALIGNED_1       (0x1UL << PWMA_CR1_CMS_Pos)     /*!< Center-aligned mode 1 */
#define PWMA_CR1_CMS_CENTER_ALIGNED_2       (0x2UL << PWMA_CR1_CMS_Pos)     /*!< Center-aligned mode 2 */
#define PWMA_CR1_CMS_CENTER_ALIGNED_3       (0x3UL << PWMA_CR1_CMS_Pos)     /*!< Center-aligned mode 3 */
...
#define PWMA_CR1_CKD_DIV1                   (0x0UL << PWMA_CR1_CKD_Pos)     /*!< Clock is not divided */
#define PWMA_CR1_CKD_DIV2                   (0x1UL << PWMA_CR1_CKD_Pos)     /*!< Clock is divided by 2 */
#define PWMA_CR1_CKD_DIV4                   (0x2UL << PWMA_CR1_CKD_Pos)     /*!< Clock is divided by 4 */
...
#define PWMA_CR2_CCUS_COMG_ONLY             (0x0UL << PWMA_CR2_CCUS_Pos)    /*!< If buffering of capture/compare control bits \
                                                                                 (CCxE, CCxNE, OCxM) is used; \
                                                                                 Update occurs when CR2_CCPC=1 and COMG=1 */
#define PWMA_CR2_CCUS_COMG_TRGI             (0x1UL << PWMA_CR2_CCUS_Pos)    /*!< If buffering of capture/compare control bits \
                                                                                 (CCxE, CCxNE, OCxM) is used; \
...
#define PWMA_CR2_MMS_RESET                  (0x0UL << PWMA_CR2_MMS_Pos)     /*!< Reset; TRGO=EGR_UG */
#define PWMA_CR2_MMS_ENABLE                 (0x1UL << PWMA_CR2_MMS_Pos)     /*!< Enable; TRGO=CEN or TRGI */
#define PWMA_CR2_MMS_UPDATE                 (0x2UL << PWMA_CR2_MMS_Pos)     /*!< Update; TRGO=EUV */
#define PWMA_CR2_MMS_CC0IF                  (0x3UL << PWMA_CR2_MMS_Pos)     /*!< Compare Pulse; TRGO=CC0IF */
#define PWMA_CR2_MMS_OC0REF                 (0x4UL << PWMA_CR2_MMS_Pos)     /*!< Compare; TRGO=OC0REF */
#define PWMA_CR2_MMS_OC1REF                 (0x5UL << PWMA_CR2_MMS_Pos)     /*!< Compare; TRGO=OC1REF */
#define PWMA_CR2_MMS_OC2REF                 (0x6UL << PWMA_CR2_MMS_Pos)     /*!< Compare; TRGO=OC2REF */
#define PWMA_CR2_MMS_OC3REF                 (0x7UL << PWMA_CR2_MMS_Pos)     /*!< Compare; TRGO=OC3REF */
...
#define PWMA_SMCR_SMS_DISABLE               (0x0UL << PWMA_SMCR_SMS_Pos)    /*!< Slave mode disabled; At prescaler input: CEN=1 and "internal clock signal" */
#define PWMA_SMCR_SMS_RESET                 (0x4UL << PWMA_SMCR_SMS_Pos)    /*!< Reset mode; posedge(TRGI) resets the counter and updates the registers */
#define PWMA_SMCR_SMS_GATED                 (0x5UL << PWMA_SMCR_SMS_Pos)    /*!< Gated mode; The counter is started by posedge (TRGI); \
                                                                                 The counter is stopped by negedge(TRGI); The counter is not reset. */
#define PWMA_SMCR_SMS_TRIGGER               (0x6UL << PWMA_SMCR_SMS_Pos)    /*!< Trigger mode; The counter is started by posedge(TRGI); Stopping the counter \
                                                                                 is not controlled. The counter is not reset. */
#define PWMA_SMCR_SMS_EXTCLK_1              (0x7UL << PWMA_SMCR_SMS_Pos)    /*!< External Clock Mode 1; The counter is clocked by posedge(TRGI). */
...
#define PWMA_SMCR_TS_ITR0                   (0x0UL << PWMA_SMCR_TS_Pos)     /*!< Internal Trigger 0 (ITR0) */
#define PWMA_SMCR_TS_ITR1                   (0x1UL << PWMA_SMCR_TS_Pos)     /*!< Internal Trigger 1 (ITR1) */
#define PWMA_SMCR_TS_ITR2                   (0x2UL << PWMA_SMCR_TS_Pos)     /*!< Internal Trigger 2 (ITR2) */
#define PWMA_SMCR_TS_TI0F_ED                (0x4UL << PWMA_SMCR_TS_Pos)     /*!< TI0 Edge Detector (TI0F_ED) */
#define PWMA_SMCR_TS_TI0FP0                 (0x5UL << PWMA_SMCR_TS_Pos)     /*!< Filtered Timer Input 0 (TI0FP0) */
#define PWMA_SMCR_TS_TI1FP1                 (0x6UL << PWMA_SMCR_TS_Pos)     /*!< Filtered Timer Input 1 (TI1FP1) */
#define PWMA_SMCR_TS_ETRF                   (0x7UL << PWMA_SMCR_TS_Pos)     /*!< External Trigger Input (ETRF) */
...
#define PWMA_SMCR_ETF_FDIV1                 (0x0UL << PWMA_SMCR_ETF_Pos)    /*!< f_sampling=f_dts; Filter not used */
#define PWMA_SMCR_ETF_FDIV1_N2              (0x1UL << PWMA_SMCR_ETF_Pos)    /*!< f_sampling=f_ck_int, N=2 */
#define PWMA_SMCR_ETF_FDIV1_N4              (0x2UL << PWMA_SMCR_ETF_Pos)    /*!< f_sampling=f_ck_int, N=4 */
#define PWMA_SMCR_ETF_FDIV1_N8              (0x3UL << PWMA_SMCR_ETF_Pos)    /*!< f_sampling=f_ck_int, N=8 */
#define PWMA_SMCR_ETF_FDIV2_N6              (0x4UL << PWMA_SMCR_ETF_Pos)    /*!< f_sampling=f_dts/2, N=6 */
#define PWMA_SMCR_ETF_FDIV2_N8              (0x5UL << PWMA_SMCR_ETF_Pos)    /*!< f_sampling=f_dts/2, N=8 */
#define PWMA_SMCR_ETF_FDIV4_N6              (0x6UL << PWMA_SMCR_ETF_Pos)    /*!< f_sampling=f_dts/4, N=6 */
#define PWMA_SMCR_ETF_FDIV4_N8              (0x7UL << PWMA_SMCR_ETF_Pos)    /*!< f_sampling=f_dts/4, N=8 */
#define PWMA_SMCR_ETF_FDIV8_N6              (0x8UL << PWMA_SMCR_ETF_Pos)    /*!< f_sampling=f_dts/8, N=6 */
#define PWMA_SMCR_ETF_FDIV8_N8              (0x9UL << PWMA_SMCR_ETF_Pos)    /*!< f_sampling=f_dts/8, N=8 */
#define PWMA_SMCR_ETF_FDIV16_N5             (0xAUL << PWMA_SMCR_ETF_Pos)    /*!< f_sampling=f_dts/16, N=5 */
#define PWMA_SMCR_ETF_FDIV16_N6             (0xBUL << PWMA_SMCR_ETF_Pos)    /*!< f_sampling=f_dts/16, N=6 */
#define PWMA_SMCR_ETF_FDIV16_N8             (0xCUL << PWMA_SMCR_ETF_Pos)    /*!< f_sampling=f_dts/16, N=8 */
#define PWMA_SMCR_ETF_FDIV32_N5             (0xDUL << PWMA_SMCR_ETF_Pos)    /*!< f_sampling=f_dts/32, N=5 */
#define PWMA_SMCR_ETF_FDIV32_N6             (0xEUL << PWMA_SMCR_ETF_Pos)    /*!< f_sampling=f_dts/32, N=6 */
#define PWMA_SMCR_ETF_FDIV32_N8             (0xFUL << PWMA_SMCR_ETF_Pos)    /*!< f_sampling=f_dts/32, N=8 */
...
#define PWMA_SMCR_ETPS_DIV1                 (0x0UL << PWMA_SMCR_ETPS_Pos)   /*!< ETR signal is not divided */
#define PWMA_SMCR_ETPS_DIV2                 (0x1UL << PWMA_SMCR_ETPS_Pos)   /*!< ETR signal is divided by 2 */
#define PWMA_SMCR_ETPS_DIV4                 (0x2UL << PWMA_SMCR_ETPS_Pos)   /*!< ETR signal is divided by 4 */
#define PWMA_SMCR_ETPS_DIV8                 (0x3UL << PWMA_SMCR_ETPS_Pos)   /*!< ETR signal is divided by 8 */
...
#define PWMA_SMCR_ETP_NONINVERTED           (0x0UL << PWMA_SMCR_ETP_Pos)    /*!< ETR is non-inverted, active at high level or rising edge */
#define PWMA_SMCR_ETP_INVERTED              (0x1UL << PWMA_SMCR_ETP_Pos)    /*!< ETR is inverted, active at low level or falling edge */
...
#define PWMA_CCMR1_CC0S_OC                  (0x0UL << PWMA_CCMR1_CC0S_Pos)      /*!< Channel 0 configured as output */
#define PWMA_CCMR1_CC0S_IC_TI0              (0x1UL << PWMA_CCMR1_CC0S_Pos)      /*!< Channel 0 configured as input; IC0 signal connected to TI0 */
#define PWMA_CCMR1_CC0S_IC_TI1              (0x2UL << PWMA_CCMR1_CC0S_Pos)      /*!< Channel 0 configured as input; IC0 signal connected to TI1 */
#define PWMA_CCMR1_CC0S_IC_TRC              (0x3UL << PWMA_CCMR1_CC0S_Pos)      /*!< Channel 0 configured as input; IC0 signal connected to TRC when SMCR_TS=1 */

/* Capture/Compare 0: Output Compare */

/** @brief CCMR1_OC[3]: Output Compare 0 preload enable */
...
/** @brief CCMR1_OC[6:4]: Output Compare 0 mode */
...
#define PWMA_CCMR1_OC_OC0M_FROZEN           (0x0UL << PWMA_CCMR1_OC_OC0M_Pos)      /*!< Frozen; When CNT=CCR0, the output states do not change. */
#define PWMA_CCMR1_OC_OC0M_ACTIVE           (0x1UL << PWMA_CCMR1_OC_OC0M_Pos)      /*!< Set the Channel 0 output to the active level when the comparison circuit is triggered; When CNT=CCR0, OC0REF=1 is set. */
#define PWMA_CCMR1_OC_OC0M_INACTIVE         (0x2UL << PWMA_CCMR1_OC_OC0M_Pos)      /*!< Set the Channel 0 output to the inactive level when the comparison circuit is triggered; When CNT=CCR0, OC0REF=0 is set. */
#define PWMA_CCMR1_OC_OC0M_TOGGLE           (0x3UL << PWMA_CCMR1_OC_OC0M_Pos)      /*!< Toggle; When CNT=CCR0, OC0REF = not OC0REF is set. */
#define PWMA_CCMR1_OC_OC0M_FORCED_INACTIVE  (0x4UL << PWMA_CCMR1_OC_OC0M_Pos)      /*!< Force switch to the inactive state; OC0REF=0. */
#define PWMA_CCMR1_OC_OC0M_FORCED_ACTIVE    (0x5UL << PWMA_CCMR1_OC_OC0M_Pos)      /*!< Force switch to the active state; OC0REF=1. */
#define PWMA_CCMR1_OC_OC0M_PWM1             (0x6UL << PWMA_CCMR1_OC_OC0M_Pos)      /*!< PWM mode 1; When counting up, Channel 0 is active (OC0REF=1) \
...
#define PWMA_CCMR1_OC_OC0M_PWM2             (0x7UL << PWMA_CCMR1_OC_OC0M_Pos)      /*!< PWM Mode 2; When counting up, Channel 0 is inactive (OC0REF=0) \
...
/** @brief CCMR1_OC[7]: Output Compare 0 clear enable */
...
/* Capture/Compare 0: Input Capture */

/** @brief CCMR1_IC[3:2]: Input capture 0 prescaler */
...
#define PWMA_CCMR1_IC_IC0PSC_DIV1           (0x0UL << PWMA_CCMR1_IC_IC0PSC_Pos)    /*!< Prescaler is not used */
#define PWMA_CCMR1_IC_IC0PSC_DIV2           (0x1UL << PWMA_CCMR1_IC_IC0PSC_Pos)    /*!< Prescaler is 2 */
#define PWMA_CCMR1_IC_IC0PSC_DIV4           (0x2UL << PWMA_CCMR1_IC_IC0PSC_Pos)    /*!< Prescaler is 4 */
#define PWMA_CCMR1_IC_IC0PSC_DIV8           (0x3UL << PWMA_CCMR1_IC_IC0PSC_Pos)    /*!< Prescaler is 8 */

/** @brief CCMR1_IC[7:4]: Input capture 0 filter */
...
#define PWMA_CCMR1_IC_IC0F_FDIV1            (0x0UL << PWMA_CCMR1_IC_IC0F_Pos)      /*!< f_sampling=f_dts; Filter not used */
#define PWMA_CCMR1_IC_IC0F_FDIV1_N2         (0x1UL << PWMA_CCMR1_IC_IC0F_Pos)      /*!< f_sampling=f_ck_int, N=2 */
#define PWMA_CCMR1_IC_IC0F_FDIV1_N4         (0x2UL << PWMA_CCMR1_IC_IC0F_Pos)      /*!< f_sampling=f_ck_int, N=4 */
#define PWMA_CCMR1_IC_IC0F_FDIV1_N8         (0x3UL << PWMA_CCMR1_IC_IC0F_Pos)      /*!< f_sampling=f_ck_int, N=8 */
#define PWMA_CCMR1_IC_IC0F_FDIV2_N6         (0x4UL << PWMA_CCMR1_IC_IC0F_Pos)      /*!< f_sampling=f_dts/2, N=6 */
#define PWMA_CCMR1_IC_IC0F_FDIV2_N8         (0x5UL << PWMA_CCMR1_IC_IC0F_Pos)      /*!< f_sampling=f_dts/2, N=8 */
#define PWMA_CCMR1_IC_IC0F_FDIV4_N6         (0x6UL << PWMA_CCMR1_IC_IC0F_Pos)      /*!< f_sampling=f_dts/4, N=6 */
#define PWMA_CCMR1_IC_IC0F_FDIV4_N8         (0x7UL << PWMA_CCMR1_IC_IC0F_Pos)      /*!< f_sampling=f_dts/4, N=8 */
#define PWMA_CCMR1_IC_IC0F_FDIV8_N6         (0x8UL << PWMA_CCMR1_IC_IC0F_Pos)      /*!< f_sampling=f_dts/8, N=6 */
#define PWMA_CCMR1_IC_IC0F_FDIV8_N8         (0x9UL << PWMA_CCMR1_IC_IC0F_Pos)      /*!< f_sampling=f_dts/8, N=8 */
#define PWMA_CCMR1_IC_IC0F_FDIV16_N5        (0xAUL << PWMA_CCMR1_IC_IC0F_Pos)      /*!< f_sampling=f_dts/16, N=5 */
#define PWMA_CCMR1_IC_IC0F_FDIV16_N6        (0xBUL << PWMA_CCMR1_IC_IC0F_Pos)      /*!< f_sampling=f_dts/16, N=6 */
#define PWMA_CCMR1_IC_IC0F_FDIV16_N8        (0xCUL << PWMA_CCMR1_IC_IC0F_Pos)      /*!< f_sampling=f_dts/16, N=8 */
#define PWMA_CCMR1_IC_IC0F_FDIV32_N5        (0xDUL << PWMA_CCMR1_IC_IC0F_Pos)      /*!< f_sampling=f_dts/32, N=5 */
#define PWMA_CCMR1_IC_IC0F_FDIV32_N6        (0xEUL << PWMA_CCMR1_IC_IC0F_Pos)      /*!< f_sampling=f_dts/32, N=6 */
#define PWMA_CCMR1_IC_IC0F_FDIV32_N8        (0xFUL << PWMA_CCMR1_IC_IC0F_Pos)      /*!< f_sampling=f_dts/32, N=8 */
...
#define PWMA_CCMR1_CC1S_OC                  (0x0UL << PWMA_CCMR1_CC1S_Pos)      /*!< Channel 1 configured as output */
#define PWMA_CCMR1_CC1S_IC_TI1              (0x1UL << PWMA_CCMR1_CC1S_Pos)      /*!< Channel 1 configured as input; IC1 signal connected to TI1 */
#define PWMA_CCMR1_CC1S_IC_TI0              (0x2UL << PWMA_CCMR1_CC1S_Pos)      /*!< Channel 1 configured as input; IC1 signal connected to TI0 */
#define PWMA_CCMR1_CC1S_IC_TRC              (0x3UL << PWMA_CCMR1_CC1S_Pos)      /*!< Channel 1 configured as input; IC1 signal connected to TRC when SMCR_TS=1 */

/* Capture/Compare 1: Output Compare */

/** @brief CCMR1_OC[11]: Output Compare 1 preload enable */
...
/** @brief CCMR1_OC[14:12]: Output Compare 1 mode */
...
#define PWMA_CCMR1_OC_OC1M_FROZEN           (0x0UL << PWMA_CCMR1_OC_OC1M_Pos)      /*!< Frozen; When CNT=CCR1 the output states do not change. */
#define PWMA_CCMR1_OC_OC1M_ACTIVE           (0x1UL << PWMA_CCMR1_OC_OC1M_Pos)      /*!< Set the Channel 1 output to the active level when the comparison circuit \
                                                                                           is triggered; When CNT=CCR1, OC1REF=1 is set. */
#define PWMA_CCMR1_OC_OC1M_INACTIVE         (0x2UL << PWMA_CCMR1_OC_OC1M_Pos)      /*!< Set the Channel 1 output to the inactive level when the comparison circuit \
                                                                                           is triggered; When CNT=CCR1, OC1REF=0 is set. */
#define PWMA_CCMR1_OC_OC1M_TOGGLE           (0x3UL << PWMA_CCMR1_OC_OC1M_Pos)      /*!< Toggle; When CNT=CCR1, OC1REF = not OC1REF is set. */
#define PWMA_CCMR1_OC_OC1M_FORCED_INACTIVE  (0x4UL << PWMA_CCMR1_OC_OC1M_Pos)      /*!< Force switch to the inactive state; OC1REF=0. */
#define PWMA_CCMR1_OC_OC1M_FORCED_ACTIVE    (0x5UL << PWMA_CCMR1_OC_OC1M_Pos)      /*!< Force switch to the active state; OC1REF=1. */
#define PWMA_CCMR1_OC_OC1M_PWM1             (0x6UL << PWMA_CCMR1_OC_OC1M_Pos)      /*!< PWM mode 1; When counting up, Channel 1 is active (OC1REF=1) \
                                                                                     ...
                                                                                     until (CNT greater-than-or-equal CCR1), otherwise Channel 1 is active (OC1REF=1). */
#define PWMA_CCMR1_OC_OC1M_PWM2             (0x7UL << PWMA_CCMR1_OC_OC1M_Pos)      /*!< PWM Mode 2; When counting up, Channel 1 is inactive (OC1REF=0) \
                                                                                     until (CNT less-than-or-equal CCR1), otherwise Channel 1 is active (OC1REF=1); \
                                                                                     When counting down, Channel 1 is active (OC1REF=1) \
                                                                                     until (CNT greater-than-or-equal CCR1), otherwise Channel 1 is inactive (OC1REF=1). */

/** @brief CCMR1_OC[15]: Output Compare 1 clear enable */
...
/* Capture/Compare 1: Input Capture */

/** @brief CCMR1_IC[11:10]: Input capture 1 prescaler */
...
#define PWMA_CCMR1_IC_IC1PSC_DIV1           (0x0UL << PWMA_CCMR1_IC_IC1PSC_Pos)    /*!< Prescaler is not used */
#define PWMA_CCMR1_IC_IC1PSC_DIV2           (0x1UL << PWMA_CCMR1_IC_IC1PSC_Pos)    /*!< Prescaler is 2 */
#define PWMA_CCMR1_IC_IC1PSC_DIV4           (0x2UL << PWMA_CCMR1_IC_IC1PSC_Pos)    /*!< Prescaler is 4 */
#define PWMA_CCMR1_IC_IC1PSC_DIV8           (0x3UL << PWMA_CCMR1_IC_IC1PSC_Pos)    /*!< Prescaler is 8 */

/** @brief CCMR1_IC[15:12]: Input capture 1 filter */
...
#define PWMA_CCMR1_IC_IC1F_FDIV1            (0x0UL << PWMA_CCMR1_IC_IC1F_Pos)      /*!< f_sampling=f_dts; Filter not used */
#define PWMA_CCMR1_IC_IC1F_FDIV1_N2         (0x1UL << PWMA_CCMR1_IC_IC1F_Pos)      /*!< f_sampling=f_ck_int, N=2 */
#define PWMA_CCMR1_IC_IC1F_FDIV1_N4         (0x2UL << PWMA_CCMR1_IC_IC1F_Pos)      /*!< f_sampling=f_ck_int, N=4 */
#define PWMA_CCMR1_IC_IC1F_FDIV1_N8         (0x3UL << PWMA_CCMR1_IC_IC1F_Pos)      /*!< f_sampling=f_ck_int, N=8 */
#define PWMA_CCMR1_IC_IC1F_FDIV2_N6         (0x4UL << PWMA_CCMR1_IC_IC1F_Pos)      /*!< f_sampling=f_dts/2, N=6 */
#define PWMA_CCMR1_IC_IC1F_FDIV2_N8         (0x5UL << PWMA_CCMR1_IC_IC1F_Pos)      /*!< f_sampling=f_dts/2, N=8 */
#define PWMA_CCMR1_IC_IC1F_FDIV4_N6         (0x6UL << PWMA_CCMR1_IC_IC1F_Pos)      /*!< f_sampling=f_dts/4, N=6 */
#define PWMA_CCMR1_IC_IC1F_FDIV4_N8         (0x7UL << PWMA_CCMR1_IC_IC1F_Pos)      /*!< f_sampling=f_dts/4, N=8 */
#define PWMA_CCMR1_IC_IC1F_FDIV8_N6         (0x8UL << PWMA_CCMR1_IC_IC1F_Pos)      /*!< f_sampling=f_dts/8, N=6 */
#define PWMA_CCMR1_IC_IC1F_FDIV8_N8         (0x9UL << PWMA_CCMR1_IC_IC1F_Pos)      /*!< f_sampling=f_dts/8, N=8 */
#define PWMA_CCMR1_IC_IC1F_FDIV16_N5        (0xAUL << PWMA_CCMR1_IC_IC1F_Pos)      /*!< f_sampling=f_dts/16, N=5 */
#define PWMA_CCMR1_IC_IC1F_FDIV16_N6        (0xBUL << PWMA_CCMR1_IC_IC1F_Pos)      /*!< f_sampling=f_dts/16, N=6 */
#define PWMA_CCMR1_IC_IC1F_FDIV16_N8        (0xCUL << PWMA_CCMR1_IC_IC1F_Pos)      /*!< f_sampling=f_dts/16, N=8 */
#define PWMA_CCMR1_IC_IC1F_FDIV32_N5        (0xDUL << PWMA_CCMR1_IC_IC1F_Pos)      /*!< f_sampling=f_dts/32, N=5 */
#define PWMA_CCMR1_IC_IC1F_FDIV32_N6        (0xEUL << PWMA_CCMR1_IC_IC1F_Pos)      /*!< f_sampling=f_dts/32, N=6 */
#define PWMA_CCMR1_IC_IC1F_FDIV32_N8        (0xFUL << PWMA_CCMR1_IC_IC1F_Pos)      /*!< f_sampling=f_dts/32, N=8 */
...
#define PWMA_CCMR2_CC2S_OC                  (0x0UL << PWMA_CCMR2_CC2S_Pos)      /*!< Channel 2 configured as output */
#define PWMA_CCMR2_CC2S_IC_TI2              (0x1UL << PWMA_CCMR2_CC2S_Pos)      /*!< Channel 2 configured as input; IC2 signal connected to TI2 */
#define PWMA_CCMR2_CC2S_IC_TI3              (0x2UL << PWMA_CCMR2_CC2S_Pos)      /*!< Channel 2 configured as input; IC2 signal connected to TI3 */
#define PWMA_CCMR2_CC2S_IC_TRC              (0x3UL << PWMA_CCMR2_CC2S_Pos)      /*!< Channel 2 configured as input; IC2 signal connected to TRC when SMCR_TS=1 */

/* Capture/Compare 2: Output Compare */

/** @brief CCMR2_OC[3]: Output Compare 2 preload enable */
...
/** @brief CCMR2_OC[6:4]: Output Compare 2 mode */
...
#define PWMA_CCMR2_OC_OC2M_FROZEN           (0x0UL << PWMA_CCMR2_OC_OC2M_Pos)      /*!< Frozen; When CNT=CCR2 the output states do not change. */
#define PWMA_CCMR2_OC_OC2M_ACTIVE           (0x1UL << PWMA_CCMR2_OC_OC2M_Pos)      /*!< Set the Channel 2 output to the active level when the comparison circuit \
                                                                                                 is triggered; When CNT=CCR2, OC2REF=1 is set. */
#define PWMA_CCMR2_OC_OC2M_INACTIVE         (0x2UL << PWMA_CCMR2_OC_OC2M_Pos)      /*!< Set the Channel 2 output to the inactive level when the comparison circuit \
                                                                                                 is triggered; When CNT=CCR2, OC2REF=0 is set. */
#define PWMA_CCMR2_OC_OC2M_TOGGLE           (0x3UL << PWMA_CCMR2_OC_OC2M_Pos)      /*!< Toggle; When CNT=CCR2, OC2REF = not OC2REF is set. */
#define PWMA_CCMR2_OC_OC2M_FORCED_INACTIVE  (0x4UL << PWMA_CCMR2_OC_OC2M_Pos)      /*!< Force switch to the inactive state; OC2REF=0. */
#define PWMA_CCMR2_OC_OC2M_FORCED_ACTIVE    (0x5UL << PWMA_CCMR2_OC_OC2M_Pos)      /*!< Force switch to the active state; OC2REF=1. */
#define PWMA_CCMR2_OC_OC2M_PWM1             (0x6UL << PWMA_CCMR2_OC_OC2M_Pos)      /*!< PWM mode 1; When counting up, Channel 2 is active (OC2REF=1) \
                                                                                     ...
                                                                                     until (CNT greater-than-or-equal CCR2), otherwise Channel 2 is active (OC2REF=1). */
#define PWMA_CCMR2_OC_OC2M_PWM2             (0x7UL << PWMA_CCMR2_OC_OC2M_Pos)      /*!< PWM Mode 2; When counting up, Channel 2 is inactive (OC2REF=0) \
                                                                                     until (CNT less-than-or-equal CCR2), otherwise Channel 2 is active (OC2REF=1); \
                                                                                     When counting down, Channel 2 is active (OC2REF=1) \
                                                                                     until (CNT greater-than-or-equal CCR2), otherwise Channel 2 is inactive (OC2REF=1). */

/** @brief CCMR2_OC[7]: Output Compare 2 clear enable */
...
/* Capture/Compare 2: Input Capture */

/** @brief CCMR2_IC[3:2]: Input capture 2 prescaler */
...
#define PWMA_CCMR2_IC_IC2PSC_DIV1           (0x0UL << PWMA_CCMR2_IC_IC2PSC_Pos)    /*!< Prescaler is not used */
#define PWMA_CCMR2_IC_IC2PSC_DIV2           (0x1UL << PWMA_CCMR2_IC_IC2PSC_Pos)    /*!< Prescaler is 2 */
#define PWMA_CCMR2_IC_IC2PSC_DIV4           (0x2UL << PWMA_CCMR2_IC_IC2PSC_Pos)    /*!< Prescaler is 4 */
#define PWMA_CCMR2_IC_IC2PSC_DIV8           (0x3UL << PWMA_CCMR2_IC_IC2PSC_Pos)    /*!< Prescaler is 8 */

/** @brief CCMR2_IC[7:4]: Input capture 2 filter */
...
#define PWMA_CCMR2_IC_IC2F_FDIV1            (0x0UL << PWMA_CCMR2_IC_IC2F_Pos)      /*!< f_sampling=f_dts; Filter not used */
#define PWMA_CCMR2_IC_IC2F_FDIV1_N2         (0x1UL << PWMA_CCMR2_IC_IC2F_Pos)      /*!< f_sampling=f_ck_int, N=2 */
#define PWMA_CCMR2_IC_IC2F_FDIV1_N4         (0x2UL << PWMA_CCMR2_IC_IC2F_Pos)      /*!< f_sampling=f_ck_int, N=4 */
#define PWMA_CCMR2_IC_IC2F_FDIV1_N8         (0x3UL << PWMA_CCMR2_IC_IC2F_Pos)      /*!< f_sampling=f_ck_int, N=8 */
#define PWMA_CCMR2_IC_IC2F_FDIV2_N6         (0x4UL << PWMA_CCMR2_IC_IC2F_Pos)      /*!< f_sampling=f_dts/2, N=6 */
#define PWMA_CCMR2_IC_IC2F_FDIV2_N8         (0x5UL << PWMA_CCMR2_IC_IC2F_Pos)      /*!< f_sampling=f_dts/2, N=8 */
#define PWMA_CCMR2_IC_IC2F_FDIV4_N6         (0x6UL << PWMA_CCMR2_IC_IC2F_Pos)      /*!< f_sampling=f_dts/4, N=6 */
#define PWMA_CCMR2_IC_IC2F_FDIV4_N8         (0x7UL << PWMA_CCMR2_IC_IC2F_Pos)      /*!< f_sampling=f_dts/4, N=8 */
#define PWMA_CCMR2_IC_IC2F_FDIV8_N6         (0x8UL << PWMA_CCMR2_IC_IC2F_Pos)      /*!< f_sampling=f_dts/8, N=6 */
#define PWMA_CCMR2_IC_IC2F_FDIV8_N8         (0x9UL << PWMA_CCMR2_IC_IC2F_Pos)      /*!< f_sampling=f_dts/8, N=8 */
#define PWMA_CCMR2_IC_IC2F_FDIV16_N5        (0xAUL << PWMA_CCMR2_IC_IC2F_Pos)      /*!< f_sampling=f_dts/16, N=5 */
#define PWMA_CCMR2_IC_IC2F_FDIV16_N6        (0xBUL << PWMA_CCMR2_IC_IC2F_Pos)      /*!< f_sampling=f_dts/16, N=6 */
#define PWMA_CCMR2_IC_IC2F_FDIV16_N8        (0xCUL << PWMA_CCMR2_IC_IC2F_Pos)      /*!< f_sampling=f_dts/16, N=8 */
#define PWMA_CCMR2_IC_IC2F_FDIV32_N5        (0xDUL << PWMA_CCMR2_IC_IC2F_Pos)      /*!< f_sampling=f_dts/32, N=5 */
#define PWMA_CCMR2_IC_IC2F_FDIV32_N6        (0xEUL << PWMA_CCMR2_IC_IC2F_Pos)      /*!< f_sampling=f_dts/32, N=6 */
#define PWMA_CCMR2_IC_IC2F_FDIV32_N8        (0xFUL << PWMA_CCMR2_IC_IC2F_Pos)      /*!< f_sampling=f_dts/32, N=8 */
...
#define PWMA_CCMR2_CC3S_OC                  (0x0UL << PWMA_CCMR2_CC3S_Pos)      /*!< Channel 3 configured as output */
#define PWMA_CCMR2_CC3S_IC_TI3              (0x1UL << PWMA_CCMR2_CC3S_Pos)      /*!< Channel 3 configured as input; IC3 signal connected to TI3 */
#define PWMA_CCMR2_CC3S_IC_TI2              (0x2UL << PWMA_CCMR2_CC3S_Pos)      /*!< Channel 3 configured as input; IC3 signal connected to TI2 */
#define PWMA_CCMR2_CC3S_IC                  (0x3UL << PWMA_CCMR2_CC3S_Pos)      /*!< Channel 3 configured as input; IC3 signal connected to TRC when SMCR_TS=1 */

/* Capture/Compare 3: Output Compare */

/** @brief CCMR2_OC[11]: Output Compare 3 preload enable */
...
/** @brief CCMR2_OC[14:12]: Output Compare 3 mode */
...
#define PWMA_CCMR2_OC_OC3M_FROZEN           (0x0UL << PWMA_CCMR2_OC_OC3M_Pos)      /*!< Frozen; When CNT=CCR3 the output states do not change. */
#define PWMA_CCMR2_OC_OC3M_ACTIVE           (0x1UL << PWMA_CCMR2_OC_OC3M_Pos)      /*!< Set the Channel 3 output to the active level when the comparison circuit \
                                                                                                 is triggered; When CNT=CCR3, OC3REF=1 is set. */
#define PWMA_CCMR2_OC_OC3M_INACTIVE         (0x2UL << PWMA_CCMR2_OC_OC3M_Pos)      /*!< Set the Channel 3 output to the inactive level when the comparison circuit \
                                                                                                 is triggered; When CNT=CCR3, OC3REF=0 is set. */
#define PWMA_CCMR2_OC_OC3M_TOGGLE           (0x3UL << PWMA_CCMR2_OC_OC3M_Pos)      /*!< Toggle; When CNT=CCR3, OC3REF = not OC3REF is set. */
#define PWMA_CCMR2_OC_OC3M_FORCED_INACTIVE  (0x4UL << PWMA_CCMR2_OC_OC3M_Pos)      /*!< Force switch to the inactive state; OC3REF=0. */
#define PWMA_CCMR2_OC_OC3M_FORCED_ACTIVE    (0x5UL << PWMA_CCMR2_OC_OC3M_Pos)      /*!< Force switch to the active state; OC3REF=1. */
#define PWMA_CCMR2_OC_OC3M_PWM1             (0x6UL << PWMA_CCMR2_OC_OC3M_Pos)      /*!< PWM mode 1; When counting up, Channel 3 is active (OC3REF=1) \
                                                                                     ...
                                                                                     until (CNT greater-than-or-equal CCR3), otherwise Channel 3 is active (OC3REF=1). */
#define PWMA_CCMR2_OC_OC3M_PWM2             (0x7UL << PWMA_CCMR2_OC_OC3M_Pos)      /*!< PWM Mode 2; When counting up, Channel 3 is inactive (OC3REF=0) \
                                                                                     until (CNT less-than-or-equal CCR3), otherwise Channel 3 is active (OC3REF=1); \
                                                                                     When counting down, Channel 3 is active (OC3REF=1) \
                                                                                     until (CNT greater-than-or-equal CCR3), otherwise Channel 3 is inactive (OC3REF=1). */

/** @brief CCMR2_OC[15]: Output Compare 3 clear enable */
...
/* Capture/Compare 3: Input Capture */

/** @brief CCMR2_IC[11:10]: Input capture 3 prescaler */
...
#define PWMA_CCMR2_IC_IC3PSC_DIV1           (0x0UL << PWMA_CCMR2_IC_IC3PSC_Pos)    /*!< Prescaler is not used */
#define PWMA_CCMR2_IC_IC3PSC_DIV2           (0x1UL << PWMA_CCMR2_IC_IC3PSC_Pos)    /*!< Prescaler is 2 */
#define PWMA_CCMR2_IC_IC3PSC_DIV4           (0x2UL << PWMA_CCMR2_IC_IC3PSC_Pos)    /*!< Prescaler is 4 */
#define PWMA_CCMR2_IC_IC3PSC_DIV8           (0x3UL << PWMA_CCMR2_IC_IC3PSC_Pos)    /*!< Prescaler is 8 */

/** @brief CCMR2_IC[15:12]: Input capture 3 filter */
...
#define PWMA_CCMR2_IC_IC3F_FDIV1            (0x0UL << PWMA_CCMR2_IC_IC3F_Pos)      /*!< f_sampling=f_dts; Filter not used */
#define PWMA_CCMR2_IC_IC3F_FDIV1_N2         (0x1UL << PWMA_CCMR2_IC_IC3F_Pos)      /*!< f_sampling=f_ck_int, N=2 */
#define PWMA_CCMR2_IC_IC3F_FDIV1_N4         (0x2UL << PWMA_CCMR2_IC_IC3F_Pos)      /*!< f_sampling=f_ck_int, N=4 */
#define PWMA_CCMR2_IC_IC3F_FDIV1_N8         (0x3UL << PWMA_CCMR2_IC_IC3F_Pos)      /*!< f_sampling=f_ck_int, N=8 */
#define PWMA_CCMR2_IC_IC3F_FDIV2_N6         (0x4UL << PWMA_CCMR2_IC_IC3F_Pos)      /*!< f_sampling=f_dts/2, N=6 */
#define PWMA_CCMR2_IC_IC3F_FDIV2_N8         (0x5UL << PWMA_CCMR2_IC_IC3F_Pos)      /*!< f_sampling=f_dts/2, N=8 */
#define PWMA_CCMR2_IC_IC3F_FDIV4_N6         (0x6UL << PWMA_CCMR2_IC_IC3F_Pos)      /*!< f_sampling=f_dts/4, N=6 */
#define PWMA_CCMR2_IC_IC3F_FDIV4_N8         (0x7UL << PWMA_CCMR2_IC_IC3F_Pos)      /*!< f_sampling=f_dts/4, N=8 */
#define PWMA_CCMR2_IC_IC3F_FDIV8_N6         (0x8UL << PWMA_CCMR2_IC_IC3F_Pos)      /*!< f_sampling=f_dts/8, N=6 */
#define PWMA_CCMR2_IC_IC3F_FDIV8_N8         (0x9UL << PWMA_CCMR2_IC_IC3F_Pos)      /*!< f_sampling=f_dts/8, N=8 */
#define PWMA_CCMR2_IC_IC3F_FDIV16_N5        (0xAUL << PWMA_CCMR2_IC_IC3F_Pos)      /*!< f_sampling=f_dts/16, N=5 */
#define PWMA_CCMR2_IC_IC3F_FDIV16_N6        (0xBUL << PWMA_CCMR2_IC_IC3F_Pos)      /*!< f_sampling=f_dts/16, N=6 */
#define PWMA_CCMR2_IC_IC3F_FDIV16_N8        (0xCUL << PWMA_CCMR2_IC_IC3F_Pos)      /*!< f_sampling=f_dts/16, N=8 */
#define PWMA_CCMR2_IC_IC3F_FDIV32_N5        (0xDUL << PWMA_CCMR2_IC_IC3F_Pos)      /*!< f_sampling=f_dts/32, N=5 */
#define PWMA_CCMR2_IC_IC3F_FDIV32_N6        (0xEUL << PWMA_CCMR2_IC_IC3F_Pos)      /*!< f_sampling=f_dts/32, N=6 */
#define PWMA_CCMR2_IC_IC3F_FDIV32_N8        (0xFUL << PWMA_CCMR2_IC_IC3F_Pos)      /*!< f_sampling=f_dts/32, N=8 */
...
#define PWMA_CCER_CC0P_NONINVERTED          (0x0UL << PWMA_CCER_CC0P_Pos)       /*!< Channel 0 configured as input:  non-inverted/rising edge */
#define PWMA_CCER_CC0P_INVERTED             (0x1UL << PWMA_CCER_CC0P_Pos)       /*!< Channel 0 configured as input:  inverted/falling edge */
...
#define PWMA_CCER_CC0NP_NONINVERTED         (0x0UL << PWMA_CCER_CC0NP_Pos)      /*!< This bit is used in conjunction with CC0P to define the polarity of TI0FP1 and TI1FP1. Refer to CC0P description. Channel 0 configured as input:  non-inverted/rising edge */
#define PWMA_CCER_CC0NP_INVERTED            (0x1UL << PWMA_CCER_CC0NP_Pos)      /*!< Channel 0 configured as input:  inverted/falling edge */
...
#define PWMA_CCER_CC1P_NONINVERTED          (0x0UL << PWMA_CCER_CC1P_Pos)       /*!< Channel 1 configured as input:  non-inverted/rising edge */
#define PWMA_CCER_CC1P_INVERTED             (0x1UL << PWMA_CCER_CC1P_Pos)       /*!< Channel 1 configured as input:  inverted/falling edge */
...
#define PWMA_CCER_CC1NP_NONINVERTED         (0x0UL << PWMA_CCER_CC1NP_Pos)      /*!< This bit is used in conjunction with CC1P to define the polarity of TI0FP1 and TI1FP1. Refer to CC1P description. Channel 1 configured as input:  non-inverted/rising edge */
#define PWMA_CCER_CC1NP_INVERTED            (0x1UL << PWMA_CCER_CC1NP_Pos)      /*!< Channel 1 configured as input:  inverted/falling edge */
...
#define PWMA_CCER_CC2P_NONINVERTED          (0x0UL << PWMA_CCER_CC2P_Pos)       /*!< Channel 2 configured as input:  non-inverted/rising edge */
#define PWMA_CCER_CC2P_INVERTED             (0x1UL << PWMA_CCER_CC2P_Pos)       /*!< Channel 2 configured as input:  inverted/falling edge */
...
#define PWMA_CCER_CC2NP_NONINVERTED         (0x0UL << PWMA_CCER_CC2NP_Pos)      /*!< This bit is used in conjunction with CC2P to define the polarity of TI0FP1 and TI1FP1. Refer to CC2P description. Channel 2 configured as input:  non-inverted/rising edge */
#define PWMA_CCER_CC2NP_INVERTED            (0x1UL << PWMA_CCER_CC2NP_Pos)      /*!< Channel 2 configured as input:  inverted/falling edge */
...
#define PWMA_CCER_CC3P_NONINVERTED          (0x0UL << PWMA_CCER_CC3P_Pos)       /*!< Channel 3 configured as input:  non-inverted/rising edge */
#define PWMA_CCER_CC3P_INVERTED             (0x1UL << PWMA_CCER_CC3P_Pos)       /*!< Channel 3 configured as input:  inverted/falling edge */
...
/** @brief BDTR[11]: Off-state selection for Run mode */
...
#define PWMA_DCR_DBA_CR1                    (0x0UL << PWMA_DCR_DBA_Pos)         /*!< (0x00) CR1 */
#define PWMA_DCR_DBA_CR2                    (0x1UL << PWMA_DCR_DBA_Pos)         /*!< (0x04) CR2 */
#define PWMA_DCR_DBA_SMCR                   (0x2UL << PWMA_DCR_DBA_Pos)         /*!< (0x08) SMCR */
#define PWMA_DCR_DBA_DIER                   (0x3UL << PWMA_DCR_DBA_Pos)         /*!< (0x0C) DIER */
#define PWMA_DCR_DBA_SR                     (0x4UL << PWMA_DCR_DBA_Pos)         /*!< (0x10) SR */
#define PWMA_DCR_DBA_EGR                    (0x5UL << PWMA_DCR_DBA_Pos)         /*!< (0x14) EGR */
#define PWMA_DCR_DBA_CCMR1                  (0x6UL << PWMA_DCR_DBA_Pos)         /*!< (0x18) CCMR1 */
#define PWMA_DCR_DBA_CCMR2                  (0x7UL << PWMA_DCR_DBA_Pos)         /*!< (0x1C) CCMR2 */
#define PWMA_DCR_DBA_CCER                   (0x8UL << PWMA_DCR_DBA_Pos)         /*!< (0x20) CCER */
#define PWMA_DCR_DBA_CNT                    (0x9UL << PWMA_DCR_DBA_Pos)         /*!< (0x24) CNT */
#define PWMA_DCR_DBA_PSC                    (0xAUL << PWMA_DCR_DBA_Pos)         /*!< (0x28) PSC */
#define PWMA_DCR_DBA_ARR                    (0xBUL << PWMA_DCR_DBA_Pos)         /*!< (0x2C) ARR */
#define PWMA_DCR_DBA_RCR                    (0xCUL << PWMA_DCR_DBA_Pos)         /*!< (0x30) RCR */
#define PWMA_DCR_DBA_CCR0                   (0xDUL << PWMA_DCR_DBA_Pos)         /*!< (0x34) CCR0 */
#define PWMA_DCR_DBA_CCR1                   (0xEUL << PWMA_DCR_DBA_Pos)         /*!< (0x38) CCR1 */
#define PWMA_DCR_DBA_CCR2                   (0xFUL << PWMA_DCR_DBA_Pos)         /*!< (0x3C) CCR2 */
#define PWMA_DCR_DBA_CCR3                   (0x10UL << PWMA_DCR_DBA_Pos)        /*!< (0x40) CCR3 */
#define PWMA_DCR_DBA_BDTR                   (0x11UL << PWMA_DCR_DBA_Pos)        /*!< (0x44) BDTR */
#define PWMA_DCR_DBA_DCR                    (0x12UL << PWMA_DCR_DBA_Pos)        /*!< (0x48) DCR */
...
#define PWMA_DCR_DBL_1TRANSFER              (0x1UL << PWMA_DCR_DBL_Pos)         /*!< Transfer is done to 1 register starting from the DMA burst base address */
#define PWMA_DCR_DBL_2TRANSFERS             (0x2UL << PWMA_DCR_DBL_Pos)         /*!< Transfer is done to 2 registers starting from the DMA burst base address */
#define PWMA_DCR_DBL_3TRANSFERS             (0x3UL << PWMA_DCR_DBL_Pos)         /*!< Transfer is done to 3 registers starting from the DMA burst base address */
#define PWMA_DCR_DBL_4TRANSFERS             (0x4UL << PWMA_DCR_DBL_Pos)         /*!< Transfer is done to 4 registers starting from the DMA burst base address */
#define PWMA_DCR_DBL_5TRANSFERS             (0x5UL << PWMA_DCR_DBL_Pos)         /*!< Transfer is done to 5 registers starting from the DMA burst base address*/
#define PWMA_DCR_DBL_6TRANSFERS             (0x6UL << PWMA_DCR_DBL_Pos)         /*!< Transfer is done to 6 registers starting from the DMA burst base address */
#define PWMA_DCR_DBL_7TRANSFERS             (0x7UL << PWMA_DCR_DBL_Pos)         /*!< Transfer is done to 7 registers starting from the DMA burst base address */
#define PWMA_DCR_DBL_8TRANSFERS             (0x8UL << PWMA_DCR_DBL_Pos)         /*!< Transfer is done to 8 registers starting from the DMA burst base address */
#define PWMA_DCR_DBL_9TRANSFERS             (0x9UL << PWMA_DCR_DBL_Pos)         /*!< Transfer is done to 9 registers starting from the DMA burst base address */
#define PWMA_DCR_DBL_10TRANSFERS            (0xAUL << PWMA_DCR_DBL_Pos)         /*!< Transfer is done to 10 registers starting from the DMA burst base address */
#define PWMA_DCR_DBL_11TRANSFERS            (0xBUL << PWMA_DCR_DBL_Pos)         /*!< Transfer is done to 11 registers starting from the DMA burst base address */
#define PWMA_DCR_DBL_12TRANSFERS            (0xCUL << PWMA_DCR_DBL_Pos)         /*!< Transfer is done to 12 registers starting from the DMA burst base address */
#define PWMA_DCR_DBL_13TRANSFERS            (0xDUL << PWMA_DCR_DBL_Pos)         /*!< Transfer is done to 13 registers starting from the DMA burst base address */
#define PWMA_DCR_DBL_14TRANSFERS            (0xEUL << PWMA_DCR_DBL_Pos)         /*!< Transfer is done to 14 registers starting from the DMA burst base address */
#define PWMA_DCR_DBL_15TRANSFERS            (0xFUL << PWMA_DCR_DBL_Pos)         /*!< Transfer is done to 15 registers starting from the DMA burst base address */
#define PWMA_DCR_DBL_16TRANSFERS            (0x10UL << PWMA_DCR_DBL_Pos)         /*!< Transfer is done to 16 registers starting from the DMA burst base address */
#define PWMA_DCR_DBL_17TRANSFERS            (0x11UL << PWMA_DCR_DBL_Pos)        /*!< Transfer is done to 17 registers starting from the DMA burst base address */
#define PWMA_DCR_DBL_18TRANSFERS            (0x12UL << PWMA_DCR_DBL_Pos)        /*!< Transfer is done to 18 registers starting from the DMA burst base address */

/******************* Bit definition for PWMA_DMAR register ********************/

/** @brief DMAR[15:0]: DMA register for burst accesses */
...
#define PWMG_CR1_OPM_REPETITIVE             (0x0UL << PWMG_CR1_OPM_Pos)     /*!< Counter is not stopped at update event */
#define PWMG_CR1_OPM_SINGLE                 (0x1UL << PWMG_CR1_OPM_Pos)     /*!< Counter stops counting at the next update event */
...
#define PWMG_CR1_CKD_DIV1                   (0x0UL << PWMG_CR1_CKD_Pos)     /*!< Clock is not divided */
#define PWMG_CR1_CKD_DIV2                   (0x1UL << PWMG_CR1_CKD_Pos)     /*!< Clock is divided by 2 */
#define PWMG_CR1_CKD_DIV4                   (0x2UL << PWMG_CR1_CKD_Pos)     /*!< Clock is divided by 4 */
...
/******************* Bit definition for PWMG_CCMR1 register *******************/
...
#define PWMG_CCMR1_CC0S_OC                  (0x0UL << PWMG_CCMR1_CC0S_Pos)  /*!< Output Compare */
#define PWMG_CCMR1_CC0S_IC                  (0x3UL << PWMG_CCMR1_CC0S_Pos)  /*!< Input Capture */
...
#define PWMG_CCMR1_OC_OC0M_FROZEN           (0x0UL << PWMG_CCMR1_OC_OC0M_Pos)  /*!< The comparison between the output compare register CCR0 and the counter CNT has no effect on the output channel level */
#define PWMG_CCMR1_OC_OC0M_ACTIVE           (0x1UL << PWMG_CCMR1_OC_OC0M_Pos)  /*!< OC0REF is forced high on compare match */
#define PWMG_CCMR1_OC_OC0M_INACTIVE         (0x2UL << PWMG_CCMR1_OC_OC0M_Pos)  /*!< OC0REF is forced low on compare match */
#define PWMG_CCMR1_OC_OC0M_TOGGLE           (0x3UL << PWMG_CCMR1_OC_OC0M_Pos)  /*!< OC0REF toggles on compare match */
#define PWMG_CCMR1_OC_OC0M_FORCED_INACTIVE  (0x4UL << PWMG_CCMR1_OC_OC0M_Pos)  /*!< OC0REF is forced low */
#define PWMG_CCMR1_OC_OC0M_FORCED_ACTIVE    (0x5UL << PWMG_CCMR1_OC_OC0M_Pos)  /*!< OC0REF is forced high */
#define PWMG_CCMR1_OC_OC0M_PWM1             (0x6UL << PWMG_CCMR1_OC_OC0M_Pos)  /*!< In upcounting, channel 0 is active as long as CNT <= CCR0, else inactive. In downcounting, channel 0 is inactive as long as CNT >= CCR0, else active. */
#define PWMG_CCMR1_OC_OC0M_PWM2             (0x7UL << PWMG_CCMR1_OC_OC0M_Pos)  /*!< In upcounting, channel 0 is inactive as long as CNT <= CCR0, else active. In downcounting, channel 0 is active as long as CNT >= CCR0, else inactive. */
...
#define PWMG_CCMR1_IC_IC0PSC_DIV1           (0x0UL << PWMG_CCMR1_IC_IC0PSC_Pos)    /*!< Prescaler is not used */
#define PWMG_CCMR1_IC_IC0PSC_DIV2           (0x1UL << PWMG_CCMR1_IC_IC0PSC_Pos)    /*!< Prescaler is 2 */
#define PWMG_CCMR1_IC_IC0PSC_DIV4           (0x2UL << PWMG_CCMR1_IC_IC0PSC_Pos)    /*!< Prescaler is 4 */
#define PWMG_CCMR1_IC_IC0PSC_DIV8           (0x3UL << PWMG_CCMR1_IC_IC0PSC_Pos)    /*!< Prescaler is 8 */
...
#define PWMG_CCMR1_IC_IC0F_FDIV1            (0x0UL << PWMG_CCMR1_IC_IC0F_Pos)  /*!< No filter, sampling is done at fDTS */
#define PWMG_CCMR1_IC_IC0F_FDIV1_N2         (0x1UL << PWMG_CCMR1_IC_IC0F_Pos)  /*!< fSAMPLING = fCK_INT, N = 2 */
#define PWMG_CCMR1_IC_IC0F_FDIV1_N4         (0x2UL << PWMG_CCMR1_IC_IC0F_Pos)  /*!< fSAMPLING = fCK_INT, N = 4 */
#define PWMG_CCMR1_IC_IC0F_FDIV1_N8         (0x3UL << PWMG_CCMR1_IC_IC0F_Pos)  /*!< fSAMPLING = fCK_INT, N = 8 */
#define PWMG_CCMR1_IC_IC0F_FDIV2_N6         (0x4UL << PWMG_CCMR1_IC_IC0F_Pos)  /*!< fSAMPLING = fDTS/2, N = 6 */
#define PWMG_CCMR1_IC_IC0F_FDIV2_N8         (0x5UL << PWMG_CCMR1_IC_IC0F_Pos)  /*!< fSAMPLING = fDTS/2, N = 8 */
#define PWMG_CCMR1_IC_IC0F_FDIV4_N6         (0x6UL << PWMG_CCMR1_IC_IC0F_Pos)  /*!< fSAMPLING = fDTS/4, N = 6 */
#define PWMG_CCMR1_IC_IC0F_FDIV4_N8         (0x7UL << PWMG_CCMR1_IC_IC0F_Pos)  /*!< fSAMPLING = fDTS/4, N = 8 */
#define PWMG_CCMR1_IC_IC0F_FDIV8_N6         (0x8UL << PWMG_CCMR1_IC_IC0F_Pos)  /*!< fSAMPLING = fDTS/8, N = 6 */
#define PWMG_CCMR1_IC_IC0F_FDIV8_N8         (0x9UL << PWMG_CCMR1_IC_IC0F_Pos)  /*!< fSAMPLING = fDTS/8, N = 8 */
#define PWMG_CCMR1_IC_IC0F_FDIV16_N5        (0xAUL << PWMG_CCMR1_IC_IC0F_Pos)  /*!< fSAMPLING = fDTS/16, N = 5 */
#define PWMG_CCMR1_IC_IC0F_FDIV16_N6        (0xBUL << PWMG_CCMR1_IC_IC0F_Pos)  /*!< fSAMPLING = fDTS/16, N = 6 */
#define PWMG_CCMR1_IC_IC0F_FDIV16_N8        (0xCUL << PWMG_CCMR1_IC_IC0F_Pos)  /*!< fSAMPLING = fDTS/16, N = 8 */
#define PWMG_CCMR1_IC_IC0F_FDIV32_N5        (0xDUL << PWMG_CCMR1_IC_IC0F_Pos)  /*!< fSAMPLING = fDTS/32, N = 5 */
#define PWMG_CCMR1_IC_IC0F_FDIV32_N6        (0xEUL << PWMG_CCMR1_IC_IC0F_Pos)  /*!< fSAMPLING = fDTS/32, N = 6 */
#define PWMG_CCMR1_IC_IC0F_FDIV32_N8        (0xFUL << PWMG_CCMR1_IC_IC0F_Pos)  /*!< fSAMPLING = fDTS/32, N = 8 */
...
#define PWMG_CCER_CC0E_DISABLE              (0x0UL << PWMG_CCER_CC0E_Pos)   /*!< OC: not active; IC: capture disabled */
#define PWMG_CCER_CC0E_ENABLE               (0x1UL << PWMG_CCER_CC0E_Pos)   /*!< OC: signal is output on the corresponding output pin; IC: capture enabled */
...
#define PWMG_CCER_CC0P_HIGH                 (0x0UL << PWMG_CCER_CC0P_Pos)   /*!< Output: active high */
#define PWMG_CCER_CC0P_LOW                  (0x1UL << PWMG_CCER_CC0P_Pos)   /*!< Output: active low */

#define PWMG_CCER_CC0P_NONINVERTED          (0x0UL << PWMG_CCER_CC0P_Pos)   /*!< Input: not inverted/rising edge */
#define PWMG_CCER_CC0P_INVERTED             (0x1UL << PWMG_CCER_CC0P_Pos)   /*!< Input: inverted/falling edge */
...
/** @brief PSC[15:0]: Prescaler value */
...
/** @brief ARR[15:0]: Auto-reload value */
...
/** @brief CCR0[15:0]: Capture/Compare 0 value */
...
#define QE_QESET_QEMODE_QUADRATURE          (0x0UL << QE_QESET_QEMODE_Pos)      /*!< Counter counts up/down on both QA and QB edges depending on the level of the other input */
#define QE_QESET_QEMODE_EDGE                (0x1UL << QE_QESET_QEMODE_Pos)      /*!< Counter counts up/down on QA edge depending on QB level */

/** @brief QESET[2]: QA swapped with QB */
...
#define QE_QESET_INDXPOL_NONINVERTED        (0x0UL << QE_QESET_INDXPOL_Pos)     /*!< INDX signal is not inverted */
#define QE_QESET_INDXPOL_INVERTED           (0x1UL << QE_QESET_INDXPOL_Pos)     /*!< INDX signal is inverted */

/** @brief QESET[9]: Single mode enable */
...
#define QE_QESET_SINGLE_MODE_DISABLE        (0x0UL << QE_QESET_SINGLE_MODE_Pos) /*!< Single mode is disabled */
#define QE_QESET_SINGLE_MODE_ENABLE         (0x1UL << QE_QESET_SINGLE_MODE_Pos) /*!< Single mode is enabled */

/** @brief QESET[10]: Counter initialization mode */
...
#define QE_QESET_INIT_MODE_RESET            (0x0UL << QE_QESET_INIT_MODE_Pos)   /*!< INDX resets the counter */
#define QE_QESET_INIT_MODE_INITSET          (0x1UL << QE_QESET_INIT_MODE_Pos)   /*!< INDX sets the counter to INITSET value */
...
#define QE_FILTSET_QASF_FDIV1               (0x0UL << QE_FILTSET_QASF_Pos)      /*!< No filter, sampling is done at fDTS */
#define QE_FILTSET_QASF_FDIV1_N2            (0x1UL << QE_FILTSET_QASF_Pos)      /*!< fSAMPLING = fCK_INT, N = 2 */
#define QE_FILTSET_QASF_FDIV1_N4            (0x2UL << QE_FILTSET_QASF_Pos)      /*!< fSAMPLING = fCK_INT, N = 4 */
#define QE_FILTSET_QASF_FDIV1_N8            (0x3UL << QE_FILTSET_QASF_Pos)      /*!< fSAMPLING = fCK_INT, N = 8 */
#define QE_FILTSET_QASF_FDIV2_N6            (0x4UL << QE_FILTSET_QASF_Pos)      /*!< fSAMPLING = fDTS/2, N = 6 */
#define QE_FILTSET_QASF_FDIV2_N8            (0x5UL << QE_FILTSET_QASF_Pos)      /*!< fSAMPLING = fDTS/2, N = 8 */
#define QE_FILTSET_QASF_FDIV4_N6            (0x6UL << QE_FILTSET_QASF_Pos)      /*!< fSAMPLING = fDTS/4, N = 6 */
#define QE_FILTSET_QASF_FDIV4_N8            (0x7UL << QE_FILTSET_QASF_Pos)      /*!< fSAMPLING = fDTS/4, N = 8 */
#define QE_FILTSET_QASF_FDIV8_N6            (0x8UL << QE_FILTSET_QASF_Pos)      /*!< fSAMPLING = fDTS/8, N = 6 */
#define QE_FILTSET_QASF_FDIV8_N8            (0x9UL << QE_FILTSET_QASF_Pos)      /*!< fSAMPLING = fDTS/8, N = 8 */
#define QE_FILTSET_QASF_FDIV16_N5           (0xAUL << QE_FILTSET_QASF_Pos)      /*!< fSAMPLING = fDTS/16, N = 5 */
#define QE_FILTSET_QASF_FDIV16_N6           (0xBUL << QE_FILTSET_QASF_Pos)      /*!< fSAMPLING = fDTS/16, N = 6 */
#define QE_FILTSET_QASF_FDIV16_N8           (0xCUL << QE_FILTSET_QASF_Pos)      /*!< fSAMPLING = fDTS/16, N = 8 */
#define QE_FILTSET_QASF_FDIV32_N5           (0xDUL << QE_FILTSET_QASF_Pos)      /*!< fSAMPLING = fDTS/32, N = 5 */
#define QE_FILTSET_QASF_FDIV32_N6           (0xEUL << QE_FILTSET_QASF_Pos)      /*!< fSAMPLING = fDTS/32, N = 6 */
#define QE_FILTSET_QASF_FDIV32_N8           (0xFUL << QE_FILTSET_QASF_Pos)      /*!< fSAMPLING = fDTS/32, N = 8 */
...
#define QE_FILTSET_QBSF_FDIV1               (0x0UL << QE_FILTSET_QBSF_Pos)      /*!< No filter, sampling is done at fDTS */
#define QE_FILTSET_QBSF_FDIV1_N2            (0x1UL << QE_FILTSET_QBSF_Pos)      /*!< fSAMPLING = fCK_INT, N = 2 */
#define QE_FILTSET_QBSF_FDIV1_N4            (0x2UL << QE_FILTSET_QBSF_Pos)      /*!< fSAMPLING = fCK_INT, N = 4 */
#define QE_FILTSET_QBSF_FDIV1_N8            (0x3UL << QE_FILTSET_QBSF_Pos)      /*!< fSAMPLING = fCK_INT, N = 8 */
#define QE_FILTSET_QBSF_FDIV2_N6            (0x4UL << QE_FILTSET_QBSF_Pos)      /*!< fSAMPLING = fDTS/2, N = 6 */
#define QE_FILTSET_QBSF_FDIV2_N8            (0x5UL << QE_FILTSET_QBSF_Pos)      /*!< fSAMPLING = fDTS/2, N = 8 */
#define QE_FILTSET_QBSF_FDIV4_N6            (0x6UL << QE_FILTSET_QBSF_Pos)      /*!< fSAMPLING = fDTS/4, N = 6 */
#define QE_FILTSET_QBSF_FDIV4_N8            (0x7UL << QE_FILTSET_QBSF_Pos)      /*!< fSAMPLING = fDTS/4, N = 8 */
#define QE_FILTSET_QBSF_FDIV8_N6            (0x8UL << QE_FILTSET_QBSF_Pos)      /*!< fSAMPLING = fDTS/8, N = 6 */
#define QE_FILTSET_QBSF_FDIV8_N8            (0x9UL << QE_FILTSET_QBSF_Pos)      /*!< fSAMPLING = fDTS/8, N = 8 */
#define QE_FILTSET_QBSF_FDIV16_N5           (0xAUL << QE_FILTSET_QBSF_Pos)      /*!< fSAMPLING = fDTS/16, N = 5 */
#define QE_FILTSET_QBSF_FDIV16_N6           (0xBUL << QE_FILTSET_QBSF_Pos)      /*!< fSAMPLING = fDTS/16, N = 6 */
#define QE_FILTSET_QBSF_FDIV16_N8           (0xCUL << QE_FILTSET_QBSF_Pos)      /*!< fSAMPLING = fDTS/16, N = 8 */
#define QE_FILTSET_QBSF_FDIV32_N5           (0xDUL << QE_FILTSET_QBSF_Pos)      /*!< fSAMPLING = fDTS/32, N = 5 */
#define QE_FILTSET_QBSF_FDIV32_N6           (0xEUL << QE_FILTSET_QBSF_Pos)      /*!< fSAMPLING = fDTS/32, N = 6 */
#define QE_FILTSET_QBSF_FDIV32_N8           (0xFUL << QE_FILTSET_QBSF_Pos)      /*!< fSAMPLING = fDTS/32, N = 8 */

/** @brief FILTSET[11:8]: INDX filter setting */
...
#define QE_FILTSET_INDXSF_FDIV1             (0x0UL << QE_FILTSET_INDXSF_Pos)    /*!< No filter, sampling is done at fDTS */
#define QE_FILTSET_INDXSF_FDIV1_N2          (0x1UL << QE_FILTSET_INDXSF_Pos)    /*!< fSAMPLING = fCK_INT, N = 2 */
#define QE_FILTSET_INDXSF_FDIV1_N4          (0x2UL << QE_FILTSET_INDXSF_Pos)    /*!< fSAMPLING = fCK_INT, N = 4 */
#define QE_FILTSET_INDXSF_FDIV1_N8          (0x3UL << QE_FILTSET_INDXSF_Pos)    /*!< fSAMPLING = fCK_INT, N = 8 */
#define QE_FILTSET_INDXSF_FDIV2_N6          (0x4UL << QE_FILTSET_INDXSF_Pos)    /*!< fSAMPLING = fDTS/2, N = 6 */
#define QE_FILTSET_INDXSF_FDIV2_N8          (0x5UL << QE_FILTSET_INDXSF_Pos)    /*!< fSAMPLING = fDTS/2, N = 8 */
#define QE_FILTSET_INDXSF_FDIV4_N6          (0x6UL << QE_FILTSET_INDXSF_Pos)    /*!< fSAMPLING = fDTS/4, N = 6 */
#define QE_FILTSET_INDXSF_FDIV4_N8          (0x7UL << QE_FILTSET_INDXSF_Pos)    /*!< fSAMPLING = fDTS/4, N = 8 */
#define QE_FILTSET_INDXSF_FDIV8_N6          (0x8UL << QE_FILTSET_INDXSF_Pos)    /*!< fSAMPLING = fDTS/8, N = 6 */
#define QE_FILTSET_INDXSF_FDIV8_N8          (0x9UL << QE_FILTSET_INDXSF_Pos)    /*!< fSAMPLING = fDTS/8, N = 8 */
#define QE_FILTSET_INDXSF_FDIV16_N5         (0xAUL << QE_FILTSET_INDXSF_Pos)    /*!< fSAMPLING = fDTS/16, N = 5 */
#define QE_FILTSET_INDXSF_FDIV16_N6         (0xBUL << QE_FILTSET_INDXSF_Pos)    /*!< fSAMPLING = fDTS/16, N = 6 */
#define QE_FILTSET_INDXSF_FDIV16_N8         (0xCUL << QE_FILTSET_INDXSF_Pos)    /*!< fSAMPLING = fDTS/16, N = 8 */
#define QE_FILTSET_INDXSF_FDIV32_N5         (0xDUL << QE_FILTSET_INDXSF_Pos)    /*!< fSAMPLING = fDTS/32, N = 5 */
#define QE_FILTSET_INDXSF_FDIV32_N6         (0xEUL << QE_FILTSET_INDXSF_Pos)    /*!< fSAMPLING = fDTS/32, N = 6 */
#define QE_FILTSET_INDXSF_FDIV32_N8         (0xFUL << QE_FILTSET_INDXSF_Pos)    /*!< fSAMPLING = fDTS/32, N = 8 */
...
/*** Bits definition for XIP_CMD registers  ************************************/
/** @brief CMD_EN[0]: The bit responsible for changing the address space to the required one, with the necessary bits added to the end of the address phase */
...
/** @brief CMD_SEL[2:1]: Selecting the content of bk_xip_cmd_byte_w */
#define QSPI_CMD_SEL_Pos                    (1U)
#define QSPI_CMD_SEL_Msk                    (0x1UL << QSPI_CMD_SEL_Pos)

#define QSPI_CMD_SEL_8h                     (0x00UL << QSPI_CMD_SEL_Pos) /*!< conent = 8’h0 */
#define QSPI_CMD_SEL_BYTE0                  (0x01UL << QSPI_CMD_SEL_Pos)  /*!< conent = byte 0 (see [15:8] bits of this register)  */
#define QSPI_CMD_SEL_BYTE1                  (0x02UL << QSPI_CMD_SEL_Pos)  /*!< conent = byte 1 (see [23:16] bits of this register) */
#define QSPI_CMD_SEL_BYTE2                  (0x03UL << QSPI_CMD_SEL_Pos)  /*!< conent = byte 2 (see [31:24] bits of this register) */

/** @brief S2R[3]: The place where the extra byte was inserted */
...
/** @brief RSVD[7:4]: reserved bits */

/** @brief CMD_BYTE0[15:8]: Content byte 0  (see CMD_SEL[2:1])*/
#define QSPI_CMD_BYTE0_Pos                  (8U)
#define QSPI_CMD_BYTE0_Msk                  (0xFFUL << QSPI_CMD_BYTE0_Pos)

/** @brief CMD_BYTE1[23:16]: Content byte 1  (see CMD_SEL[2:1])*/
#define QSPI_CMD_BYTE1_Pos                  (16U)
#define QSPI_CMD_BYTE1_Msk                  (0xFFUL << QSPI_CMD_BYTE1_Pos)

/** @brief CMD_BYTE1[31:24]: Content byte 2  (see CMD_SEL[2:1])*/
...
/**************** Bit definition for TIM_CH_LOADCOUNT register ****************/

/** @brief CH_LOADCOUNT1[31:0]: The value to be loaded into timer channel n */
...
/*************** Bit definition for TIM_CH_CURRENTVAL register ****************/

/** @brief CH_CURRENTVAL[31:0]: Current value of timer channel n */
...
/***************** Bit definition for TIM_CH_CONTROL register *****************/

/** @brief CH_CONTROL[0]: Timer channel n enable */
...
/** @brief CH_CONTROL[1]: Timer channel n mode */
...
#define TIM_CH_CONTROL_MODE_FREE_RUNNING    (0x0UL << TIM_CH_CONTROL_MODE_Pos)  /*!< Free Running mode */
#define TIM_CH_CONTROL_MODE_USER_DEFINED    (0x1UL << TIM_CH_CONTROL_MODE_Pos)  /*!< User Defined mode */

/** @brief CH_CONTROL[2]: Timer channel n interrupt mask */
...
/** @brief CH_CONTROL[3]: Timer channel n PWM output enable */
...
/** @brief CH_CONTROL[4]: Timer channel n 0% and 100% PWM duty cycle mode enable */
...
/******************* Bit definition for TIM_CH_EOI register *******************/

/** @brief CH_EOI[0]: Clear timer channel n interrupt */
#define TIM_CH_EOI_Pos                      (0U)
#define TIM_CH_EOI_Msk                      (0x1UL << TIM_CH_EOI_Pos)
#define TIM_CH_EOI                          TIM_CH_EOI_Msk

/***************** Bit definition for TIM_CH_INTSTAT register *****************/

/** @brief CH_INTSTAT[0]: Timer channel n interrupt status */
#define TIM_CH_INTSTAT_Pos                  (0U)
#define TIM_CH_INTSTAT_Msk                  (0x1UL << TIM_CH_INTSTAT_Pos)
#define TIM_CH_INTSTAT                      TIM_CH_INTSTAT_Msk

/****************** Bit definition for TIM_INTSTAT register *******************/

/** @brief INTSTAT[0]: Timer channel 0 interrupt status */
...
/** @brief INTSTAT[1]: Timer channel 1 interrupt status */
...
/** @brief INTSTAT[2]: Timer channel 2 interrupt status */
...
/** @brief INTSTAT[3]: Timer channel 3 interrupt status */
...
/** @brief RAWINTSTAT[1]: Timer channel 1 unmasked interrupt status */
...
/** @brief RAWINTSTAT[2]: Timer channel 2 unmasked interrupt status */
...
/** @brief RAWINTSTAT[3]: Timer channel 3 unmasked interrupt status */
...
/**************** Bit definition for TIM_COMPVERSION register *****************/

/** @brief COMPVERSION[31:0]: Timer component version */
...
/*************** Bit definition for TIM_CH_LOADCOUNT2 register ****************/

/** @brief CH_LOADCOUNT2[31:0]: Value to be loaded into timer channel n when toggle output changes from 0 to 1 */
...
#define UART_SRT_FIFO_CHAR_1                (0x0UL << UART_SRT_Pos)     /*!< 1 character in FIFO */
#define UART_SRT_FIFO_QUARTER_FULL          (0x1UL << UART_SRT_Pos)     /*!< FIFO 1/4 full */
#define UART_SRT_FIFO_HALF_FULL             (0x2UL << UART_SRT_Pos)     /*!< FIFO 1/2 full */
#define UART_SRT_FIFO_FULL_2                (0x3UL << UART_SRT_Pos)     /*!< FIFO 2 less than full */
...
#define UART_STET_FIFO_EMPTY                (0x0UL << UART_STET_Pos)    /*!< FIFO empty */
#define UART_STET_FIFO_CHAR_2               (0x1UL << UART_STET_Pos)    /*!< 2 characters in FIFO */
#define UART_STET_FIFO_QUARTER_FULL         (0x2UL << UART_STET_Pos)    /*!< FIFO 1/4 full */
#define UART_STET_FIFO_HALF_FULL            (0x3UL << UART_STET_Pos)    /*!< FIFO 1/2 full */
...
#define USB_TYPE0_SPEED_UNUSED              (0x0UL << USB_TYPE0_SPEED_Pos)      /*!< The target will be assumed to be using the same connection speed as the core */
#define USB_TYPE0_SPEED_HIGH                (0x1UL << USB_TYPE0_SPEED_Pos)      /*!< High speed */
#define USB_TYPE0_SPEED_FULL                (0x2UL << USB_TYPE0_SPEED_Pos)      /*!< Full speed */
#define USB_TYPE0_SPEED_LOW                 (0x3UL << USB_TYPE0_SPEED_Pos)      /*!< Low speed */
...
#define USB_TXTYPE_PROTOCOL_CONTROL         (0x0UL << USB_TXTYPE_PROTOCOL_Pos)  /*!< Control */
#define USB_TXTYPE_PROTOCOL_ISOCHRONOUS     (0x1UL << USB_TXTYPE_PROTOCOL_Pos)  /*!< Isochronous */
#define USB_TXTYPE_PROTOCOL_BULK            (0x2UL << USB_TXTYPE_PROTOCOL_Pos)  /*!< Bulk */
#define USB_TXTYPE_PROTOCOL_INTERRUPT       (0x3UL << USB_TXTYPE_PROTOCOL_Pos)  /*!< Interrupt */
...
#define USB_TXTYPE_SPEED_UNUSED             (0x0UL << USB_TXTYPE_SPEED_Pos)     /*!< The target will be assumed to be using the same connection speed as the core */
#define USB_TXTYPE_SPEED_HIGH               (0x1UL << USB_TXTYPE_SPEED_Pos)     /*!< High speed */
#define USB_TXTYPE_SPEED_FULL               (0x2UL << USB_TXTYPE_SPEED_Pos)     /*!< Full speed */
#define USB_TXTYPE_SPEED_LOW                (0x3UL << USB_TXTYPE_SPEED_Pos)     /*!< Low speed */
...
#define USB_RXTYPE_PROTOCOL_CONTROL         (0x0UL << USB_RXTYPE_PROTOCOL_Pos)  /*!< Control */
#define USB_RXTYPE_PROTOCOL_ISOCHRONOUS     (0x1UL << USB_RXTYPE_PROTOCOL_Pos)  /*!< Isochronous */
#define USB_RXTYPE_PROTOCOL_BULK            (0x2UL << USB_RXTYPE_PROTOCOL_Pos)  /*!< Bulk */
#define USB_RXTYPE_PROTOCOL_INTERRUPT       (0x3UL << USB_RXTYPE_PROTOCOL_Pos)  /*!< Interrupt */
...
#define USB_RXTYPE_SPEED_UNUSED             (0x0UL << USB_RXTYPE_SPEED_Pos)     /*!< The target will be assumed to be using the same connection speed as the core */
#define USB_RXTYPE_SPEED_HIGH               (0x1UL << USB_RXTYPE_SPEED_Pos)     /*!< High speed */
#define USB_RXTYPE_SPEED_FULL               (0x2UL << USB_RXTYPE_SPEED_Pos)     /*!< Full speed */
#define USB_RXTYPE_SPEED_LOW                (0x3UL << USB_RXTYPE_SPEED_Pos)     /*!< Low speed */
...
/************** Bit definition for CORE2_DEBUG_JTAG_EM register ***************/

/** @brief JTAG_EM[0]: TCK signal propagated to PA0 */
...
/** @brief JTAG_EM[1]: TMS signal propagated to PA1 */
...
/** @brief JTAG_EM[2]: TDO signal on PA2 */
...
/** @brief JTAG_EM[3]: TDI signal propagated to PA3 */
...
/** @brief JTAG_EM[4]: NTRST signal propagated to PA4 */
...
/************ Bit definition for CORE2_TRACE_TRACE_SEL register ************/

/** @brief TRACE_SEL[0]: Alternative trace source select */
...
#define CORE2_TRACE_TRACE_SEL_SEL_CORE0  (0x0UL << CORE2_TRACE_TRACE_SEL_SEL_Pos)     /*!< Core 0 */
#define CORE2_TRACE_TRACE_SEL_SEL_CORE1  (0x1UL << CORE2_TRACE_TRACE_SEL_SEL_Pos)     /*!< Core 1 */
...
/******************************** MB Instances ********************************/
#define IS_MB_ALL_INSTANCE(INSTANCE)        (((INSTANCE) == MB0) || \
                                             ((INSTANCE) == MB1))

#define IS_CORE2_MB_ALL_INSTANCE(INSTANCE)  (((INSTANCE) == CORE2_MB0) || \
                                             ((INSTANCE) == CORE2_MB1))
