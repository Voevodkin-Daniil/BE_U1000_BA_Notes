...
/** @brief SYSCR0[17]: Reset WDTx */
#define CRU_SYSCR0_WDTCLR_Pos             (17U)
#define CRU_SYSCR0_WDTCLR_Msk             (0x1UL << CRU_SYSCR0_WDTCLR_Pos)
#define CRU_SYSCR0_WDTCLR                 CRU_SYSCR0_WDTCLR_Msk
...
/** @brief SYSCR0[30]: USB PHY reset */
#define CRU_SYSCR0_USBPHYRESET_Pos        (30U)
#define CRU_SYSCR0_USBPHYRESET_Msk        (0x1UL << CRU_SYSCR0_USBPHYRESET_Pos)
#define CRU_SYSCR0_USBPHYRESET            CRU_SYSCR0_USBPHYRESET_Msk

/** @brief SYSCR0[31]: USB PHY PLL enable */
#define CRU_SYSCR0_USBPHYPLLEN_Pos        (31U)
#define CRU_SYSCR0_USBPHYPLLEN_Msk        (0x1UL << CRU_SYSCR0_USBPHYPLLEN_Pos)
#define CRU_SYSCR0_USBPHYPLLEN            CRU_SYSCR0_USBPHYPLLEN_Msk
...
#define CRU_SYSSR0_STRAP_MODE_JTAG_TEST   (0x7UL << CRU_SYSSR0_STRAP_MODE_Pos)  /*!< JTAG test */
...
/** @brief SYSSR0[4]: Secure boot disable flag */
#define CRU_SYSSR0_SECUREDIS_Pos          (4U)
#define CRU_SYSSR0_SECUREDIS_Msk          (0x1UL << CRU_SYSSR0_SECUREDIS_Pos)
#define CRU_SYSSR0_SECUREDIS              CRU_SYSSR0_SECUREDIS_Msk

/** @brief SYSSR0[5]: EFLASH good flag */
#define CRU_SYSSR0_EFLASH_OK_Pos          (5U)
#define CRU_SYSSR0_EFLASH_OK_Msk          (0x1UL << CRU_SYSSR0_EFLASH_OK_Pos)
#define CRU_SYSSR0_EFLASH_OK              CRU_SYSSR0_EFLASH_OK_Msk

/** @brief SYSSR0[6]: MCU pin count */
#define CRU_SYSSR0_PACK_Pos               (6U)
#define CRU_SYSSR0_PACK_Msk               (0x1UL << CRU_SYSSR0_PACK_Pos)
#define CRU_SYSSR0_PACK                   CRU_SYSSR0_PACK_Msk

#define CRU_SYSSR0_PACK_32PIN             (0x0UL << CRU_SYSSR0_PACK_Pos)    /*!< 32-pin footprint */
#define CRU_SYSSR0_PACK_48PIN             (0x1UL << CRU_SYSSR0_PACK_Pos)    /*!< 48-pin footprint */

/** @brief SYSSR0[7]: Watchdog reset flag */
#define CRU_SYSSR0_WDTHIT_Pos             (7U)
...
/** @brief INTCR0[7:4]: PA external interrupt source */
#define CRU_INTCR0_PADAINTSEL_Pos         (4U)
#define CRU_INTCR0_PADAINTSEL_Msk         (0xFUL << CRU_INTCR0_PADAINTSEL_Pos)
#define CRU_INTCR0_PADAINTSEL             CRU_INTCR0_PADAINTSEL_Msk

/** @brief INTCR0[11:8]: PB external interrupt source */
#define CRU_INTCR0_PADBINTSEL_Pos         (8U)
#define CRU_INTCR0_PADBINTSEL_Msk         (0xFUL << CRU_INTCR0_PADBINTSEL_Pos)
#define CRU_INTCR0_PADBINTSEL             CRU_INTCR0_PADBINTSEL_Msk

/** @brief INTCR0[15:12]: PC external interrupt source */
#define CRU_INTCR0_PADCINTSEL_Pos         (12U)
#define CRU_INTCR0_PADCINTSEL_Msk         (0xFUL << CRU_INTCR0_PADCINTSEL_Pos)
#define CRU_INTCR0_PADCINTSEL             CRU_INTCR0_PADCINTSEL_Msk
