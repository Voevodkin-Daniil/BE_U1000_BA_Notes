...
#define CSR_MVENDORID                       0xF11U  /*!< Vendor ID */
#define CSR_MARCHID                         0xF12U  /*!< Architecture ID */
#define CSR_MIMPID                          0xF13U  /*!< Implementation ID */
#define CSR_MHARTID                         0xF14U  /*!< Hardware thread ID */
#define CSR_MCONFIGPTR                      0xF15U  /*!< Pointer to configuration data structure */
